        ...
        if (tileEntity instanceof TEBloomery bloomery) {
            if (state.getValue(LIT)) {
                ...
                if (recipe != null) {
                    ...
                    if (cap instanceof IForgeableMeasurableMetal forgeCap) {
                        currentTooltip.add(new TextComponentTranslation("waila.tfc.bloomery.output", forgeCap.getMetalAmount(),
            ...
            if (cap != null) {
                ...
                if (forgeCap instanceof IForgeableMeasurableMetal bloomCap) {
                    currentTooltip.add(new TextComponentTranslation("waila.tfc.metal.output", bloomCap.getMetalAmount(),
