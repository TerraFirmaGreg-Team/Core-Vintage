...
public class RenderAnimalCamel extends RenderAnimal<EntityAnimalCamel> {
    private static final ResourceLocation OLD = TerraFirmaGreg.getID("textures/entity/animal/livestock/camel_old.png");
    private static final ResourceLocation YOUNG = TerraFirmaGreg.getID("textures/entity/animal/livestock/camel_young.png");
