...
public class GenLayerZoom extends GenLayerBase {

  public GenLayerZoom(long seed, GenLayerBase par3GenLayer) {
    super(seed);
    super.parent = par3GenLayer;
  }

  public static GenLayerBase magnify(long par0, GenLayerBase par2GenLayer, int par3) {
    Object var4 = par2GenLayer;
    for (int var5 = 0; var5 < par3; ++var5) {
      var4 = new GenLayerZoom(par0 + var5, (GenLayerBase) var4);
    }
    return (GenLayerBase) var4;
  }
