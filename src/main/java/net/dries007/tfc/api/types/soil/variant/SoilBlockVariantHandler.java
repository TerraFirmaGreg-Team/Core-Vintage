...
public class SoilBlockVariantHandler {
    public static void init() {
        ...
        SoilBlockVariants.GRASS = new SoilBlockVariant("grass", BlockSoilDirtGrass::new, VERTICAL_AND_HORIZONTAL);
        SoilBlockVariants.DRY_GRASS = new SoilBlockVariant("dry_grass", BlockSoilGrass::new, VERTICAL_AND_HORIZONTAL);
        SoilBlockVariants.PATH = new SoilBlockVariant("path", BlockSoilPath::new, VERTICAL_ONLY_SOIL);
