...
public class FallingBlockManager {
    ...
    @Nullable public static Specification getSpecification(IBlockState state) {
    ...
    @Nullable public static BlockPos getFallablePos(World world, BlockPos pos, IBlockState state, boolean ignoreSupportChecks) {
    ...
    @Nullable public static BlockPos checkAreaClear(World world, IBlockState state, BlockPos pos) {
    ...
    public static class Specification {
        ...
        @Nullable public IBlockState getResultingState() {
