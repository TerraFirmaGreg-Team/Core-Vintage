...
public final class CapabilityDamageResistance {
    ...
    public static void postInit() {
        ModuleCoreOld.LOGGER.info("Entity resistance data initialized, loaded a total of {} resistance configurations", ENTITY_RESISTANCE.size());
    }
    ...
    public static void readFile(Set<Map.Entry<String, JsonElement>> jsonElements) {
        for (Map.Entry<String, JsonElement> entry : jsonElements) {
            try {
                ...
                ModuleCoreOld.LOGGER.error("An entity resistance is specified incorrectly! Skipping.");
