...
import static net.dries007.tfc.module.core.ModuleCoreOld.MISC_TAB;

public class ModuleAnimal extends ModuleBase {

    public static final String MODULE_ID = "module.animal";
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleAnimal.class.getSimpleName());
