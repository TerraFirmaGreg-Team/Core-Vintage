...
public final class CalendarTFC implements INBTSerializable<NBTTagCompound> {
    ...
    public void onOverworldTick(World world) {
        ...
        if (deltaWorldTime > 1 || deltaWorldTime < -1) {
            ...
            ModuleCore.LOGGER.debug("Calendar Time = {} ({}), Player Time = {}, World Time = {}, doDaylightCycle = {}, ArePlayersLoggedOn = {}", calendarTime, CALENDAR_TIME.getWorldTime(), playerTime, world.getWorldTime() % ICalendar.TICKS_IN_DAY, doDaylightCycle, arePlayersLoggedOn);
            ...
            if (arePlayersLoggedOn != checkArePlayersLoggedOn) {
                ...
                ModuleCore.LOGGER.debug("Setting ArePlayersLoggedOn = {}", checkArePlayersLoggedOn);
            ...
            if (deltaWorldTime < 0) {
                ...
                ModuleCore.LOGGER.debug("Calendar is ahead by {} ticks, jumping world time to catch up", -deltaWorldTime);
            } else {
