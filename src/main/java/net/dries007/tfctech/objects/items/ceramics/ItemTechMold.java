package net.dries007.tfctech.objects.items.ceramics;
  ...
  public String getItemStackDisplayName(@Nonnull ItemStack stack) {
    ...
    if (capFluidHandler instanceof IMoldHandler) {
      ...
      if (metal != null) {
        ...
        return (new TextComponentTranslation("item.tfctech.ceramics.mold." + type.name().toLowerCase() + ".filled", metalName)).getFormattedText();
      }
    }
