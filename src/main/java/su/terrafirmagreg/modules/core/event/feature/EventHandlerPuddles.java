...
public class EventHandlerPuddles {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (canSpawnPuddle(world, puddlePos)) {
                            if (random.nextInt(100) < ConfigCore.BLOCK.PUDDLE.puddleRate) {
                                world.setBlockState(puddlePos.up(), BlocksCore.PUDDLE.get().getDefaultState(), 2);
                            }
                        }
                    }
                }
    ...
    public static void puddleInteract(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (state.getBlock() == BlocksCore.PUDDLE.get()) {
            ...
            if (state.getBlock() == BlocksCore.PUDDLE.get()) {
                ...
                if (distance < 3.0F) {
                    ((WorldServer) world).spawnParticle(
                            ...
                            0.0D, 0.13D,
                            Block.getStateId(BlocksCore.PUDDLE.get().getDefaultState()));
                    ((WorldServer) world).spawnParticle(
                    ...
                    ((WorldServer) world).spawnParticle(
                            ...
                            0.0D, 0.0D, 0.0D, 0.4D, Block.getStateId(BlocksCore.PUDDLE.get().getDefaultState()));
