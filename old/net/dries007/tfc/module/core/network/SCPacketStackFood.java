...
public class SCPacketStackFood implements IMessage, IMessageHandler<SCPacketStackFood, IMessage> {
    private int slotNumber;

    @SuppressWarnings("unused")
    public SCPacketStackFood() {
    }

    public SCPacketStackFood(int slotNumber) {
    ...
    @Override
    public IMessage onMessage(SCPacketStackFood message, MessageContext ctx) {
