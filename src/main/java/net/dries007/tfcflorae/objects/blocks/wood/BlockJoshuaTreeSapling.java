...
public class BlockJoshuaTreeSapling extends BlockBush implements IGrowable {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    ...
    return (super.canPlaceBlockAt(worldIn, pos) || BlocksTFC.isSand(worldIn.getBlockState(pos.down()))
  ...
  public void grow(World world, Random rand, BlockPos pos, IBlockState blockState) {
    ...
    for (int k = 0; k < j; ++k) {
      ...
      if (j1 > 0) {
        ...
        if (world.isAirBlock(pos.add(l, k1 + 1, i1)) && (BlocksTFC.isSand(world.getBlockState(pos.add(l, k1, i1)))
                                                         || BlocksTFC.isSoilOrGravel(world.getBlockState(pos.add(l, k1, i1)))
                                                         || BlocksTFCF.isSand(world.getBlockState(pos.add(l, k1, i1)))
                                                         || BlocksTFCF.isSoilOrGravel(world.getBlockState(pos.add(l, k1, i1))) || block == Blocks.HARDENED_CLAY
