...
public class VeinType {
    ...
    public VeinType(@Nullable Ore ore, ItemStack looseRock, Collection<Rock> baseRocks, Shape shape, int width, int height, int rarity, int minY,
    ...
    public String toString() {
        ...
        return String.format("%s: {ore=%s, shape=%s, size=%s, rarity=%d, baseRocks=%s, minY=%d, maxY=%d, density=%.2f}", name, ore, shape, getWidth(),
    ...
    public static class CustomVeinType extends VeinType {
        ...
        public CustomVeinType(@NotNull IBlockState oreState, ItemStack looseRock, @NotNull Collection<Rock> rocks, Shape shape, int width, int height,
