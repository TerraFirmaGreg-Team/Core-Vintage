package su.terrafirmagreg.modules.device.objects.storage;
...
public class MachineEnergyStorage
  ...
  public MachineEnergyStorage(@Nullable NBTTagCompound nbt) {
    this(10000, 10000, 0);
    deserializeNBT(nbt);
  }
  ...
  public static class GTCEHandler implements IEnergyContainer {
    ...
    private final MachineEnergyStorage container;

    public GTCEHandler(MachineEnergyStorage mainContainer) {
