...
import net.dries007.sharkbark.cellars.util.handlers.FDPacket;
...
public class GuiFreezeDryer extends GuiContainerTE<TileFreezeDryer> {
  ...
  public GuiFreezeDryer(Container container, InventoryPlayer playerInv, TileFreezeDryer tile, String translationKey) {
