...
/**
 * Much thanks to TFC for making this possible. This code mostly borrowed from su.terrafirmagreg.modules.core.api.loot.ApplySimpleSkill
 */
...
public class ApplyRequiredSkill extends LootFunction {
	...
	public static class Serializer extends LootFunction.Serializer<ApplyRequiredSkill> {
		...
		public Serializer() {
			super(ModUtils.getID("apply_req_skill"), ApplyRequiredSkill.class);
		}
		...
		@Override
		@NotNull
		public ApplyRequiredSkill deserialize(@NotNull JsonObject object, @NotNull JsonDeserializationContext deserializationContext, LootCondition @NotNull [] conditionsIn) {
