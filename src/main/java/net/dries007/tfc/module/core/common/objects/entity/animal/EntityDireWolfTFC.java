package net.dries007.tfc.module.core.common.objects.entity.animal;
...
import net.dries007.tfc.module.core.common.objects.entity.ai.EntityAIAttackMeleeTFC;
import net.dries007.tfc.module.core.common.objects.entity.ai.EntityAIWanderHuntArea;
...
public class EntityDireWolfTFC extends EntityAnimalMammal implements IPredator {
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return TFCSounds.ANIMAL_DIREWOLF_HURT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return TFCSounds.ANIMAL_DIREWOLF_DEATH;
    }
