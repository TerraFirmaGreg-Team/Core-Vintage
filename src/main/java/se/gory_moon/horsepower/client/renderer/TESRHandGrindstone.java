...
public class TESRHandGrindstone extends TESRHPBase<TileHandGrindstone> {

  @Override
  public void render(TileHandGrindstone tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
