...
public class RenderDeerTFC extends RenderLiving<EntityDeerTFC> {
  ...
  private static final ResourceLocation DEER_TEXTURE = new ResourceLocation(TFC, "textures/entity/animal/huntable/deer.png");

  private static final ResourceLocation FAWN_TEXTURE = new ResourceLocation(TFC, "textures/entity/animal/huntable/deer_fawn.png");
