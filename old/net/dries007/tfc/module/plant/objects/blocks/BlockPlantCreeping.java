...
public class BlockPlantCreeping extends BlockPlant {
    ...
    public BlockPlantCreeping(PlantEnumVariant plantBlockVariant, PlantType plant) {
        ...
        for (PropertyBool propertybool : ALL_FACES) {
            if ((state.getValue(propertybool))) {
                switch (propertybool.getName()) {
                    ...
                    default -> axisalignedbb = Block.FULL_BLOCK_AABB;
                }
            }
        }

        return i == 1 ? axisalignedbb : Block.FULL_BLOCK_AABB;
    }
    ...
    protected BlockStateContainer createPlantBlockState() {
        return new BlockStateContainer(this, DOWN, UP, NORTH, EAST, WEST, SOUTH, growthStageProperty, BlockPlant.DAYPERIOD, BlockPlant.AGE);
    }
