package net.dries007.tfctech.client.render.tesr;
...
import static net.dries007.tfctech.objects.blocks.devices.BlockLatexExtractor.BASE;
import static net.dries007.tfctech.objects.blocks.devices.BlockLatexExtractor.CUT;
import static net.dries007.tfctech.objects.blocks.devices.BlockLatexExtractor.POT;
import static net.dries007.tfctech.objects.tileentities.TELatexExtractor.MAX_FLUID;
