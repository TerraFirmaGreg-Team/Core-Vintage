...
public class Config {
  ...
  public static void load(File configDirectory) {
    ...
    String[] fertilizerData = config.getStringList("fertilizers", "general", new String[]{"tfc:powder/saltpeter~N~128", "tfcfarming:fertilizer_p~P~128",
                                                                                          "tfc:powder/fertilizer~K~128"}, "Fertilizer list: <item name>~<N/P/K>~<fertilizer value between 0~255>");
