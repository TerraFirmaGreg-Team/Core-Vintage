	...
	private void generateRock(World world, BlockPos pos) {
		...
		if (pos.getY() > 146 && pos.getY() < 170 && data.getRainfall() >= 75) {
			if (world.isAirBlock(pos) && world.getBlockState(pos.down())
				...
				if (BlocksTFC.isSoil(world.getBlockState(pos.down())) || BlocksTFCF.isSoil(world.getBlockState(pos.down())) || BlocksTFC.isGround(world.getBlockState(pos.down())) || BlocksTFCF.isGround(world.getBlockState(pos.down()))) {
