...
import net.dries007.eerussianguy.firmalife.compat.ModuleManager;
import net.dries007.eerussianguy.firmalife.network.PacketDrawBoundingBox;
import net.dries007.eerussianguy.firmalife.network.PacketSpawnVanillaParticle;
import net.dries007.eerussianguy.firmalife.proxy.CommonProxy;
import net.dries007.eerussianguy.firmalife.registry.LootTablesFL;
import net.dries007.eerussianguy.firmalife.util.OreDictsFL;
...
public class FirmaLife {
  ...
  @SidedProxy(clientSide = "net.dries007.eerussianguy.firmalife.proxy.ClientProxy", serverSide = "net.dries007.eerussianguy.firmalife.proxy.ServerProxy")
