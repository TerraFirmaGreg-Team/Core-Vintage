...
import net.dries007.tfc.client.audio.IMachineSoundEffect;
...
import static su.terrafirmagreg.modules.device.content.block.BlockElectricForge.LIT;

@SuppressWarnings("WeakerAccess")
@ParametersAreNonnullByDefault
@Optional.Interface(iface = "ic2.api.energy.tile.IEnergySink", modid = "ic2")
public class TileElectricForge extends TEInventory implements ITickable, ITileFields, IMachineSoundEffect, IEnergySink {
