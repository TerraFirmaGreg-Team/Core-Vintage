...
public class BlockPlacedHideMixin extends Block {
	 ...
	 */
	@Overwrite
	public boolean onBlockActivated(@NotNull World worldIn, @NotNull BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
