...
public class RenderGoatTFC extends RenderAnimalTFC<EntityGoatTFC> {
  ...
  private static final ResourceLocation GOAT_OLD = new ResourceLocation(TFC, "textures/entity/animal/livestock/goat_old.png");
  private static final ResourceLocation GOAT_YOUNG = new ResourceLocation(TFC, "textures/entity/animal/livestock/goat_young.png");
