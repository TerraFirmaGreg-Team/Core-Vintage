...
//      }
  ...
  private static ICapabilityProvider getMetalItemFromOre(ItemStack stack) {
    ...
    return Handler.ORE_DICT_METAL_ITEMS.entrySet().stream()
  ...
  public static class Handler {
    ...
    public static void init() {
      ...
      CUSTOM_ITEMS.put(IIngredient.of(Items.COAL), () -> CapabilityProviderSize.of(Size.SMALL, Weight.LIGHT)); // Store anywhere stacksize = 32

      CUSTOM_ITEMS.put(IIngredient.of(Items.STICK), () -> CapabilityProviderSize.of(Size.SMALL, Weight.VERY_LIGHT)); // Store anywhere stacksize = 64

      CUSTOM_ITEMS.put(IIngredient.of(Items.CLAY_BALL), () -> CapabilityProviderSize.of(Size.SMALL, Weight.VERY_LIGHT)); // Store anywhere stacksize = 64

      CUSTOM_ITEMS.put(IIngredient.of(Items.BED), () -> CapabilityProviderSize.of(Size.LARGE, Weight.VERY_HEAVY, false)); // Store only in chests stacksize = 1

      CUSTOM_ITEMS.put(IIngredient.of(Items.MINECART), () -> CapabilityProviderSize.of(Size.LARGE, Weight.VERY_HEAVY, false)); // Store only in chests stacksize = 1

      CUSTOM_ITEMS.put(IIngredient.of(Items.ARMOR_STAND), () -> CapabilityProviderSize.of(Size.LARGE, Weight.HEAVY)); // Store only in chests stacksize = 4

      CUSTOM_ITEMS.put(IIngredient.of(Items.CAULDRON), () -> CapabilityProviderSize.of(Size.LARGE, Weight.LIGHT)); // Store only in chests stacksize = 32

      CUSTOM_ITEMS.put(IIngredient.of(Blocks.TRIPWIRE_HOOK), () -> CapabilityProviderSize.of(Size.SMALL, Weight.VERY_LIGHT)); // Store anywhere stacksize = 64
