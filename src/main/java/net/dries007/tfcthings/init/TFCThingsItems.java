...
import net.dries007.tfcthings.items.ItemBearTrapHalf;
import net.dries007.tfcthings.items.ItemCrown;
import net.dries007.tfcthings.items.ItemDiamondGrit;
import net.dries007.tfcthings.items.ItemGrindstone;
import net.dries007.tfcthings.items.ItemHikingBoots;
import net.dries007.tfcthings.items.ItemHookJavelin;
import net.dries007.tfcthings.items.ItemMetalBracing;
import net.dries007.tfcthings.items.ItemMetalSlingAmmo;
import net.dries007.tfcthings.items.ItemPigIronCarrot;
import net.dries007.tfcthings.items.ItemProspectorsHammer;
import net.dries007.tfcthings.items.ItemRopeBridge;
import net.dries007.tfcthings.items.ItemRopeJavelin;
import net.dries007.tfcthings.items.ItemSling;
import net.dries007.tfcthings.items.ItemSnowShoes;
import net.dries007.tfcthings.items.ItemTFCThingsMold;
import net.dries007.tfcthings.items.ItemTFCThingsToolHead;
import net.dries007.tfcthings.items.ItemWhetstone;
...
public class TFCThingsItems {
  ...
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_BISMUTH_BRONZE = new ItemTFCThingsToolHead(Metal.BISMUTH_BRONZE, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "bismuth_bronze");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_BLACK_BRONZE = new ItemTFCThingsToolHead(Metal.BLACK_BRONZE, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "black_bronze");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_BLACK_STEEL = new ItemTFCThingsToolHead(TFCRegistries.METALS.getValue(DefaultMetals.BLACK_STEEL), 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "black_steel");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_BLUE_STEEL = new ItemTFCThingsToolHead(Metal.BLUE_STEEL, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "blue_steel");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_BRONZE = new ItemTFCThingsToolHead(Metal.BRONZE, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "bronze");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_COPPER = new ItemTFCThingsToolHead(TFCRegistries.METALS.getValue(DefaultMetals.COPPER), 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "copper");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_RED_STEEL = new ItemTFCThingsToolHead(Metal.RED_STEEL, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "red_steel");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_STEEL = new ItemTFCThingsToolHead(Metal.STEEL, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "steel");
  public static final Item ITEM_PROSPECTORS_HAMMER_HEAD_WROUGHT_IRON = new ItemTFCThingsToolHead(Metal.WROUGHT_IRON, 144, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableProspectorsHammer, "prospectors_hammer_head", "wrought_iron");
  ...
  public static final Item ITEM_HOOK_JAVELIN_HEAD_BLACK_STEEL = new ItemTFCThingsToolHead(Metal.BLACK_STEEL, 288, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableHookJavelins, "hook_javelin_head", "black_steel");
  public static final Item ITEM_HOOK_JAVELIN_HEAD_BLUE_STEEL = new ItemTFCThingsToolHead(Metal.BLUE_STEEL, 288, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableHookJavelins, "hook_javelin_head", "blue_steel");
  public static final Item ITEM_HOOK_JAVELIN_HEAD_RED_STEEL = new ItemTFCThingsToolHead(Metal.RED_STEEL, 288, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableHookJavelins, "hook_javelin_head", "red_steel");
  public static final Item ITEM_HOOK_JAVELIN_HEAD_STEEL = new ItemTFCThingsToolHead(Metal.STEEL, 288, ConfigTFCThings.Items.MASTER_ITEM_LIST.enableHookJavelins, "hook_javelin_head", "steel");
