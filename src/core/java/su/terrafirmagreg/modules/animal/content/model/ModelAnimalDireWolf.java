...
import su.terrafirmagreg.modules.animal.content.entity.predator.EntityAnimalDireWolf;
...
/**
 * ModelDireWolfTFC Created using Tabula 7.1.0
 */
...
public class ModelAnimalDireWolf extends ModelBase {
  ...
  public ModelAnimalDireWolf() {
    ...
    setRotateAngle(neckManeLower1, ((float) Math.PI / 10F), 0.0F, 0.0F);
