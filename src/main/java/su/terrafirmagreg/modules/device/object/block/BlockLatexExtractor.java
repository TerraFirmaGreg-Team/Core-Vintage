...
public class BlockLatexExtractor extends BaseBlock implements IProviderTile {
  ...
  private static final AxisAlignedBB AABB_N = new AxisAlignedBB(0.1875D, 0.125D, 0.3125D, 0.8125D,
                                                                0.875D, 1.0D);
  private static final AxisAlignedBB AABB_S = new AxisAlignedBB(0.1875D, 0.125D, 0.0D, 0.8125D,
                                                                0.875D, 0.6875D);
  private static final AxisAlignedBB AABB_E = new AxisAlignedBB(0.0D, 0.125D, 0.1875D, 0.6875D,
                                                                0.875D, 0.8125D);
  private static final AxisAlignedBB AABB_W = new AxisAlignedBB(0.3125D, 0.125D, 0.1875D, 1.0D,
                                                                0.875D, 0.8125D);
