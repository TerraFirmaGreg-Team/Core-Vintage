...
public class RenderAnimalMuskOx extends RenderAnimal<EntityAnimalMuskOx> {
    ...
    private static final ResourceLocation TEXTURE_YOUNG = ModUtils.resource("textures/entity/animal/livestock/muskox_young.png");
    private static final ResourceLocation TEXTURE_OLD = ModUtils.resource("textures/entity/animal/livestock/muskox_old.png");
