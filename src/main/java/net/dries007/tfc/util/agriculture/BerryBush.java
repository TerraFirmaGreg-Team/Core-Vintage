...
import static net.dries007.tfc.api.types.IBerryBush.Size.MEDIUM;
import static net.dries007.tfc.api.types.IBerryBush.Size.SMALL;
...
public enum BerryBush implements IBerryBush {
  ...
  BerryBush(Food fruit, Month harvestMonthStart, int harvestingMonths, float minTemp, float maxTemp, float minRain, float maxRain, float growthTime, Size size,
            boolean spiky) {
    this.fruit = fruit;
