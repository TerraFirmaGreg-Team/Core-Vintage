...
public class BlockRopeBridge extends Block implements TFCThingsConfigurableItem {
  ...
  public AxisAlignedBB getBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
    int i = blockState.getValue(OFFSET).intValue();
    return new AxisAlignedBB(0, (float) i * 0.125F, 0, 1, (float) i * 0.125F + (3 * 0.0625F), 1);
  }

  @Override
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, OFFSET, AXIS);
  }
