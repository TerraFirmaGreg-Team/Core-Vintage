...
public class BlockWoodLog extends BlockLog implements IWoodBlock {
  ...
  @SuppressWarnings("deprecation")
  @Override
  public float getBlockHardness(IBlockState blockState, @NotNull World worldIn,
      @NotNull BlockPos pos) {
    return (blockState.getValue(PLACED) ? 1.0f : 2.5f) * super.getBlockHardness(blockState, worldIn,
        pos);
  }
  ...
  @Override
  public void updateTick(@NotNull World world, @NotNull BlockPos pos, IBlockState state,
      @NotNull Random rand) {
  ...
  @Override
  public void onExplosionDestroy(World worldIn, @NotNull BlockPos pos,
      @NotNull Explosion explosionIn) {
    if (!worldIn.isRemote) {
