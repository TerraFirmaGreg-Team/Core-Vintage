...
public class TESRGrindstone extends TESRHPBase<TileGrindstone> {

  @Override
  public void render(TileGrindstone tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
