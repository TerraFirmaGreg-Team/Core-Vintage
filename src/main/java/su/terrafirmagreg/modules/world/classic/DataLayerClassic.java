...
public final class DataLayerClassic {
    ...
    public static final DataLayerClassic ERROR = new DataLayerClassic(-1, null, "ERROR", Integer.MIN_VALUE, Float.NaN);
    ...
    public static final DataLayerClassic PH_ALKALINE_HIGH = newIntDataLayer(134, "High Alkalinity", 4);
    ...
    private DataLayerClassic(int i, BlockRockVariant block, String name, int valueInt, float valueFloat) {
        this.layerID = i;
        this.block = block;
        this.name = name;
