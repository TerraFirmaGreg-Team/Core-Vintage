...
//        }
        ...
        for (var type : GroundcoverType.values()) {
            ...
            if (StorageCore.GROUNDCOVER_BLOCKS.put(type, groundcoverBlock) != null)
        ...
        registry.registerBlock(FRESH_WATER = new BlockFluidWater(FluidRegistry.getFluid("fresh_water"), Material.WATER, false));
        registry.registerBlock(SALT_WATER = new BlockFluidWater(FluidRegistry.getFluid("salt_water"), Material.WATER, true));
