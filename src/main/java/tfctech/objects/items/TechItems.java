...
public final class TechItems {
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		metalItems.add(register(r, "metal/steel_draw_plate", ItemTechMetal.ItemType.create(TFCRegistries.METALS.getValue(new ResourceLocation(Constants.MODID_TFC, "steel")), ItemTechMetal.ItemType.DRAW_PLATE)
		                                                                           .setMaxDamage(ToolMaterialsTFC.STEEL.getMaxUses())
		                                                                           .setMaxStackSize(1), CT_METAL));
		metalItems.add(register(r, "metal/black_steel_draw_plate", ItemTechMetal.ItemType.create(TFCRegistries.METALS.getValue(new ResourceLocation(Constants.MODID_TFC, "black_steel")), ItemTechMetal.ItemType.DRAW_PLATE)
		...
		metalItems.add(register(r, "metal/tin_sleeve", ItemTechMetal.ItemType.create(TFCRegistries.METALS.getValue(new ResourceLocation(Constants.MODID_TFC, "tin")), ItemTechMetal.ItemType.SLEEVE), CT_METAL));
		metalItems.add(register(r, "metal/brass_sleeve", ItemTechMetal.ItemType.create(TFCRegistries.METALS.getValue(new ResourceLocation(Constants.MODID_TFC, "brass")), ItemTechMetal.ItemType.SLEEVE), CT_METAL));
		metalItems.add(register(r, "metal/steel_sleeve", ItemTechMetal.ItemType.create(TFCRegistries.METALS.getValue(new ResourceLocation(Constants.MODID_TFC, "steel")), ItemTechMetal.ItemType.SLEEVE), CT_METAL));
