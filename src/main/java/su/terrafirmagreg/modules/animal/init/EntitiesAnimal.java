...
public final class EntitiesAnimal {
    ...
    public static void onRegister(RegistryManager registry) {
        ...
        registry.entity("chicken", EntityAnimalChicken.class, 0x557755, 0xFFF91F);
        registry.entity("pheasant", EntityAnimalPheasant.class, 0x5577FF, 0xFFFA90);
        registry.entity("deer", EntityAnimalDeer.class, 0x55FF55, 0x5FFAAF);
        registry.entity("pig", EntityAnimalPig.class, 0xAA7722, 0xFFEBCD);
        registry.entity("wolf", EntityAnimalWolf.class, 0xB0ACAC, 0x796555);
        registry.entity("rabbit", EntityAnimalRabbit.class, 0x885040, 0x462612);
        registry.entity("horse", EntityAnimalHorse.class, 0xA5886B, 0xABA400);
        registry.entity("donkey", EntityAnimalDonkey.class, 0x493C32, 0x756659);
        registry.entity("mule", EntityAnimalMule.class, 0x180200, 0x482D1A);
        registry.entity("polarbear", EntityAnimalPolarBear.class, 0xF1FFF1, 0xA0A0A0);
        registry.entity("parrot", EntityAnimalParrot.class, 0x885040, 0xB0ACAC);
        registry.entity("llama", EntityAnimalLlama.class, 0xA52A2A, 0xAA7722);
        registry.entity("ocelot", EntityAnimalOcelot.class, 0x3527FA, 0x7F23A0);
        registry.entity("panther", EntityAnimalPanther.class, 0x000066, 0x000000);
        registry.entity("duck", EntityAnimalDuck.class, 0xFFF91F, 0x462612);
        registry.entity("alpaca", EntityAnimalAlpaca.class, 0x00CC66, 0x006633);
        registry.entity("goat", EntityAnimalGoat.class, 0xA0A0A0, 0x404040);
        registry.entity("sabertooth", EntityAnimalSaberTooth.class, 0xFF8000, 0xFFD700);
        registry.entity("camel", EntityAnimalCamel.class, 0xA5886B, 0x006633);
        registry.entity("lion", EntityAnimalLion.class, 0xDAA520, 0xA0522D);
        registry.entity("hyena", EntityAnimalHyena.class, 0x666600, 0x331900);
        registry.entity("direwolf", EntityAnimalDireWolf.class, 0x343434, 0x978f7e);
        registry.entity("hare", EntityAnimalHare.class, 0x866724, 0xDADADA);
        registry.entity("boar", EntityAnimalBoar.class, 0x463c09, 0xe39ad8);
        registry.entity("zebu", EntityAnimalZebu.class, 0x2c2507, 0xbcb38e);
        registry.entity("gazelle", EntityAnimalGazelle.class, 0xa9a76f, 0xc0ab55);
        registry.entity("wildebeest", EntityAnimalWildebeest.class, 0x696142, 0x9c8115);
        registry.entity("quail", EntityAnimalQuail.class, 0x237ddc, 0xe3e36d);
        registry.entity("grouse", EntityAnimalGrouse.class, 0xf7a100, 0x71ffd0);
        registry.entity("mongoose", EntityAnimalMongoose.class, 0xf9f50f, 0x90ec7f);
        registry.entity("turkey", EntityAnimalTurkey.class, 0xad1d1d, 0xeaa659);
        registry.entity("jackal", EntityAnimalJackal.class, 0xb8762b, 0xffffff);
        registry.entity("muskox", EntityAnimalMuskOx.class, 0x620d55, 0xcdaf4f);
        registry.entity("yak", EntityAnimalYak.class, 0x837669, 0x3e3d7c);
        registry.entity("blackbear", EntityAnimalBlackBear.class, 0x000000, 0xa18f6c);
        registry.entity("cougar", EntityAnimalCougar.class, 0x817a00, 0xdcd889);
        registry.entity("coyote", EntityAnimalCoyote.class, 0xb7bc88, 0xdac213);
    }
