...
public class TELogPile extends TEInventory implements ITickable {
    ...
    private void createCharcoal() {
        ...
        if (j == 1) {
            ...
            world.setBlockState(pos, TFCBlocks.CHARCOAL_PILE.getDefaultState().withProperty(BlockCharcoalPile.LAYERS, charcoal));
            return;
        }
        for (int k = j - 1; k >= 0; k--) {
            ...
            if (state.getBlock() == Blocks.AIR) {
                ...
                world.setBlockState(pos.down(k), TFCBlocks.CHARCOAL_PILE.getDefaultState().withProperty(BlockCharcoalPile.LAYERS, charcoal));
                world.setBlockState(pos, Blocks.AIR.getDefaultState());
                return;
            }
            ...
            if (state.getBlock() instanceof BlockCharcoalPile) {
                ...
                world.setBlockState(pos.down(k), TFCBlocks.CHARCOAL_PILE.getDefaultState().withProperty(BlockCharcoalPile.LAYERS, toCreate));
                charcoal -= toCreate;
            }
