...
public class BlockAlloyCalculator extends BaseBlockContainer {
  ...
  private static final AxisAlignedBB BOUNDS_NS = new AxisAlignedBB(3 / 16d, 0, 5 / 16d, 13 / 16d,
                                                                   4 / 16d, 11 / 16d);
  private static final AxisAlignedBB BOUNDS_WE = new AxisAlignedBB(5 / 16d, 0, 3 / 16d, 11 / 16d,
                                                                   4 / 16d, 13 / 16d);
  ...
  public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state,
    ...
    worldIn.setBlockState(pos,
                          state.withProperty(HORIZONTAL, placer.getHorizontalFacing().getOpposite()), 2);
  }
