...
import static net.dries007.tfc.module.agriculture.api.types.bush.IBushBlock.Size;
...
public class BushType {
    ...
    public ItemStack getFoodDrop() {
        return new ItemStack(StorageFood.getFoodItem(FoodItemVariants.INGREDIENT, getFruit()));
    }
