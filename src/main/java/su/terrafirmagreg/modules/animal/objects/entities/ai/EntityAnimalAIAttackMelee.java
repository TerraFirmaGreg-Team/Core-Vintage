...
/**
 * Extends vanilla AI to add a bit more in-depth to predators Additions: - Day / Night hunting behaviors (Attack on one and only when provoked
 * otherwise) - Attack Reach - Hunting Area via {@link EntityCreature#setHomePosAndDistance}
 */
public class EntityAnimalAIAttackMelee<T extends EntityCreature & IAnimal> extends EntityAIAttackMelee {
    ...
    /**
     * Sets a wander AI to immediately move this AI to inside it's hunting area after it stops hunting a creature (This is to make it not weird- The
     * creature stopped in its tracks and is just looking at your face)
     *
