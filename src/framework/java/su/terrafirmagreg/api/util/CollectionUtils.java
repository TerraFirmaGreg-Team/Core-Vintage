...
public final class CollectionUtils {
  ...
  public static <K extends Enum<K>, V> Map<K, V> makeEnumMap(Class<K> aClass, Function<K, V> function) {
    EnumMap<K, V> enummap = new EnumMap<>(aClass);

    for (K k : aClass.getEnumConstants()) {
