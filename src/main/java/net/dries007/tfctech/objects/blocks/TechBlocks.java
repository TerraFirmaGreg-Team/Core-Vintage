package net.dries007.tfctech.objects.blocks;
...
import net.dries007.tfctech.objects.blocks.devices.BlockInductionCrucible;
import net.dries007.tfctech.objects.blocks.devices.BlockLatexExtractor;
import net.dries007.tfctech.objects.blocks.devices.BlockSmelteryCauldron;
import net.dries007.tfctech.objects.blocks.devices.BlockSmelteryFirebox;
import net.dries007.tfctech.objects.blocks.devices.BlockWireDrawBench;
import net.dries007.tfctech.objects.fluids.TechFluids;
import net.dries007.tfctech.objects.items.itemblocks.ItemBlockFridge;
import net.dries007.tfctech.objects.items.itemblocks.ItemBlockWireDrawBench;
