...
public class ModelManager {
	...
	public static void registerBlockItemModel(Block block) {
		...
		if (block instanceof IHasStateMapper model) {
			model.onStateMapperRegister();

		} else {
			ModelManager.registerBlockItemModel(block.getDefaultState());
		}
	}
	...
	public static <T extends Comparable<T>> void registerVariantBlockItemModels(
		...
		property.getAllowedValues()
				.forEach(value -> ModelManager.registerBlockItemModelForMeta(
	...
	public static void registerBlockItemModelForMeta(final IBlockState state, final int metadata) {
		...
		ModelManager.registerItemModel(item, metadata, PROPERTY_STRING_MAPPER.getPropertyString(state.getProperties())
		);
	}
	...
	public static void registerItemModel(Item item) {
		if (item instanceof IHasStateMapper model) {
			model.onStateMapperRegister();
	 ...
	 * @param items     the items
	 * @see ModelManager#registerItemModels(Item...)
	 */
