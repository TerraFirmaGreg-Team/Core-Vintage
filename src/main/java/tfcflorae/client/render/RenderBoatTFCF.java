...
public class RenderBoatTFCF extends Render<EntityBoatTFCF> {
	...
	protected ResourceLocation getEntityTexture(EntityBoatTFCF entity) {
		...
		if (wood != null) {
			...
			return new ResourceLocation(MODID_TFCF, "textures/entity/boat/" + wood.getName().toLowerCase() + ".png");
		}

		final Tree tree = entity.getTree();
		if (tree != null) {
			//noinspection ConstantConditions
			return new ResourceLocation(MODID_TFCF, "textures/entity/boat/" + tree.getRegistryName()
			                                                                      .getPath()
			                                                                      .toLowerCase() + ".png");
		}

		// Fallback
		return new ResourceLocation(MODID_TFCF, "textures/entity/boat/oak.png");
	}
