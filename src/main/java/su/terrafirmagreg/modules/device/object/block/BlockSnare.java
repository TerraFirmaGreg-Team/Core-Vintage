...
public class BlockSnare extends Block implements ICapabilitySize, TFCThingsConfigurableItem {
  ...
  public BlockSnare() {
    ...
    this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(BAITED, Boolean.valueOf(false))
  ...
  @Override
  public TileBearTrap createTileEntity(World world, IBlockState state) {
    return new TileBearTrap();
  }

  public TileBearTrap getTileEntity(IBlockAccess world, BlockPos pos) {
    return (TileBearTrap) world.getTileEntity(pos);
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    return this.getDefaultState().withProperty(FACING, EnumFacing.byHorizontalIndex(meta % 4)).withProperty(BAITED, meta / 4 % 2 != 0)
  ...
  public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
    TileBearTrap trap = (TileBearTrap) te;
    if (!trap.isOpen()) {
  ...
  public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
    if (isCapturable(entityIn)) {
      TileBearTrap trap = getTileEntity(worldIn, pos);
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
    ...
    TileBearTrap snare = getTileEntity(worldIn, pos);
