...
import static net.dries007.tfc.ConfigTFC.Animals.searchDistance;
...
public class EBEntityAI extends EntityAIBase {
  ...
  List<EntityItem> getItems() {
    return world.getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(
      animal.posX - searchDistance,
      animal.posY - searchDistance, animal.posZ - searchDistance, animal.posX + searchDistance, animal.posY + searchDistance, animal.posZ + searchDistance));
  }
}
