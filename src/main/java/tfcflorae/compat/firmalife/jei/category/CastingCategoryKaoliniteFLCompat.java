...
public class CastingCategoryKaoliniteFLCompat extends BaseRecipeCategory<CastingRecipeWrapperKaoliniteFL> {
    ...
    public CastingCategoryKaoliniteFLCompat(IGuiHelper helper, String Uid) {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, CastingRecipeWrapperKaoliniteFL recipeWrapper, IIngredients ingredients) {
