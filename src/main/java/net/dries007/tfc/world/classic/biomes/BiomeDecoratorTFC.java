    ...
    public BiomeDecoratorTFC(int lilyPadPerChunk, int waterPlantsPerChunk) {
        ...
        for (PlantType plant : PlantType.getPlantTypes()) {
            switch (plant.getPlantVariant()) {
                ...
                case FLOATING -> floatingCount++;
                case FLOATING_SEA -> floatingSeaCount++;
                case DESERT, DESERT_TALL_PLANT -> desertCount++;
                case DRY, DRY_TALL_PLANT -> dryCount++;
                case CACTUS -> cactusCount++;
                case SHORT_GRASS -> grassCount++;
                case TALL_GRASS -> tallGrassCount++;
                case EPIPHYTE -> epiphyteCount++;
                case REED, TALL_REED -> reedCount++;
                case REED_SEA, TALL_REED_SEA -> reedSeaCount++;
                case WATER, TALL_WATER, EMERGENT_TALL_WATER -> waterCount++;
                case WATER_SEA, TALL_WATER_SEA, EMERGENT_TALL_WATER_SEA -> waterSeaCount++;
                case MUSHROOM -> mushroomCount++;
