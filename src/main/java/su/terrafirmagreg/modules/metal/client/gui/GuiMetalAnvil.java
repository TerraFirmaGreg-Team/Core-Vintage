...
public class GuiMetalAnvil extends BaseGuiContainerTile<TileMetalAnvil> {

  public static final ResourceLocation BACKGROUND = ModUtils.resource("textures/gui/anvil.png");
