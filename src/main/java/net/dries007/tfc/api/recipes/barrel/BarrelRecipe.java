...
public class BarrelRecipe extends IForgeRegistryEntry.Impl<BarrelRecipe> {
     ...
     * @param duration    the duration, in ticks, for this recipe to complete. 0 = Instant while negative means this recipe is infinite (for custom
     *                    recipes that wait for unseal)
     */
    ...
    /**
     * Called by TEBarrel when a recipe finishes Used if you want to play a sound / cause an update of some sort
     *
    ...
    /**
     * Called by TEBarrel when the barrel just sealed Use this if you want to do something to the input (like add a food trait) when the recipe "just
     * started"
     * <p>
    ...
    /**
     * Called by TEBarrel when the barrel is unsealed mid operation (the recipe didn't finish) Use this if you want to do something to the input (like
     * remove a food trait, or consume part of it) when the recipe is "broken"
     *
