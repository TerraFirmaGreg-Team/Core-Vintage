    ...
    try {
      ...
      if (itemBlockCropWaterDead.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(ITEMBLOCKBLOCKCROPDEAD_FROM)), itemBlockCropWaterDead);
      }
      if (itemBlockCropWater.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(ITEMBLOCKBLOCKCROP_FROM)), itemBlockCropWater);
      }
      ...
      if (blockShortGrassTFC.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(BLOCKSHORTGRASSTFC_FROM)), blockShortGrassTFC);
      }
      if (blockTallGrassTFC.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(BLOCKTALLGRASSTFC_FROM)), blockTallGrassTFC);
      }
      ...
      if (biomeDecoratorTFC1.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(BIOMEDECORATOR1_FROM)), biomeDecoratorTFC1);
      }
      ...
      if (chunkDataTFCStorage.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(CHUNKDATATFC_STORAGE_FROM)), chunkDataTFCStorage);
      }
      ...
      if (genLayerBiomeEdge.createNewFile()) {
        FileUtils.copyInputStreamToFile(Objects.requireNonNull(ClassAdder.class.getClassLoader()
                                                                               .getResourceAsStream(GENLAYERBIOMEEDGE_FROM)), genLayerBiomeEdge);
      }
