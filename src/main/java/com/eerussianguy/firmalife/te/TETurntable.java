    ...
    if (clay > 0 && speed > 0) {
      if (world.isRemote && speed > 5) {
        world.spawnParticle(EnumParticleTypes.ITEM_CRACK,
                            ...
                            pos.getY() + 0.5D,
                            pos.getZ() + 0.5D,
                            (world.rand.nextDouble() - world.rand.nextDouble()) / 4.0D,
                            world.rand.nextDouble() / 4.0D, (world.rand.nextDouble() - world.rand.nextDouble()) / 4.0D, Item.getIdFromItem(Items.CLAY_BALL));
      }
