...
public class RenderAnimalSheep extends RenderAnimal<EntityAnimalSheep> {
    ...
    private static final ResourceLocation SHEEP_YOUNG = ModUtils.id("textures/entity/animal/livestock/sheep_young.png");
    private static final ResourceLocation SHEEP_OLD = ModUtils.id("textures/entity/animal/livestock/sheep_old.png");
