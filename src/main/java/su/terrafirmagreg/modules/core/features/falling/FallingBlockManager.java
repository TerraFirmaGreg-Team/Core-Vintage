...
public class FallingBlockManager {
  ...
  public static boolean canFallThrough(World world, BlockPos pos, Material fallableMaterial,
  ...
  public static boolean hasSupportingSideBlock(IBlockState state) {
    return state.isNormalCube() || SIDE_SUPPORTS.contains(state) ||
        state.getBlock() instanceof ISoilBlock soilBlock && BlockUtils.isVariant(
            soilBlock.getVariant(), FARMLAND, GRASS_PATH);
  }

  public static boolean shouldFall(World world, BlockPos posToFallFrom, BlockPos originalPos,
  ...
  public static boolean checkFalling(World world, BlockPos pos, IBlockState state,
    ...
    if (BlockFalling.fallInstantly) {
      ...
      if (fallablePos != null) {
        ...
        world.spawnEntity(new EntityFallingBlock(world, fallablePos, state));
        return true;
      }
    }
    return false;
  ...
  public static BlockPos checkAreaClear(World world, IBlockState state, BlockPos pos) {
    ...
    if (!world.getEntitiesWithinAABB(net.minecraft.entity.item.EntityFallingBlock.class,
  ...
  public static class Specification {
    ...
    public static final Specification VERTICAL_AND_HORIZONTAL = new Specification(true,
        () -> TFCSounds.DIRT_SLIDE_SHORT);
    public static final Specification VERTICAL_AND_HORIZONTAL_ROCK = new Specification(true,
        () -> TFCSounds.ROCK_SLIDE_SHORT);
    public static final Specification VERTICAL_ONLY = new Specification(false,
        () -> TFCSounds.DIRT_SLIDE_SHORT);
    public static final Specification VERTICAL_ONLY_SOIL = new Specification(false,
        () -> TFCSounds.DIRT_SLIDE_SHORT);
    public static final Specification COLLAPSABLE_ROCK = new Specification(false, true,
        () -> TFCSounds.ROCK_SLIDE_LONG);
