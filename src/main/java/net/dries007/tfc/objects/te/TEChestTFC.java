...
public class TEChestTFC extends TileEntityChest implements ISlotCallback {
    ...
    @Override
    @Nullable public <T> T getCapability(net.minecraftforge.common.capabilities.Capability<T> capability, @Nullable net.minecraft.util.EnumFacing facing) {
