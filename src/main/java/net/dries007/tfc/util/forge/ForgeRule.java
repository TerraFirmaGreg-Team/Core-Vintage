...
import static net.dries007.tfc.util.forge.ForgeStep.BEND;
import static net.dries007.tfc.util.forge.ForgeStep.DRAW;
import static net.dries007.tfc.util.forge.ForgeStep.HIT_HARD;
import static net.dries007.tfc.util.forge.ForgeStep.HIT_LIGHT;
import static net.dries007.tfc.util.forge.ForgeStep.HIT_MEDIUM;
import static net.dries007.tfc.util.forge.ForgeStep.PUNCH;
import static net.dries007.tfc.util.forge.ForgeStep.SHRINK;
import static net.dries007.tfc.util.forge.ForgeStep.UPSET;
