...
public final class HeatCapability {
    ...
    public static void init() {
        ...
        HeatCapability.CUSTOM_ITEMS.put(IIngredient.of(Blocks.IRON_BARS),
                () -> new HeatProvider(null, Metal.WROUGHT_IRON.getSpecificHeat(), Metal.WROUGHT_IRON.getMeltTemp()));
    }
