...
public class BlockSoilPodzol extends BlockSoil {
  ...
  public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
    ...
    return state
        .withProperty(NORTH,
            world.getBlockState(pos.offset(EnumFacing.NORTH)).getBlock() instanceof BlockSoilPodzol)
        .withProperty(EAST,
            world.getBlockState(pos.offset(EnumFacing.EAST)).getBlock() instanceof BlockSoilPodzol)
        .withProperty(SOUTH,
            world.getBlockState(pos.offset(EnumFacing.SOUTH)).getBlock() instanceof BlockSoilPodzol)
        .withProperty(WEST,
            world.getBlockState(pos.offset(EnumFacing.WEST)).getBlock() instanceof BlockSoilPodzol);
  }
