package su.terrafirmagreg.modules.animal.content.entity.livestock;
...
import su.terrafirmagreg.framework.manager.content.base.entity.spi.BaseEntity.BaseEntityType;
import su.terrafirmagreg.modules.animal.ConfigAnimal;
import su.terrafirmagreg.modules.animal.api.type.ILivestock;
import su.terrafirmagreg.modules.animal.api.util.AnimalGroupingRules;
import su.terrafirmagreg.modules.animal.content.render.RenderAnimalChicken;
...
import su.terrafirmagreg.modules.animal.content.entity.ai.EntityAnimalAIFindNest;
...
public class EntityAnimalChicken extends EntityAnimalBase implements ILivestock {
  ...
  public int getDaysToAdulthood() {
    return ConfigAnimal.ENTITY.CHICKEN.adulthood;
  }

  @Override
  public int getDaysToElderly() {
    return ConfigAnimal.ENTITY.CHICKEN.elder;
  }
  ...
  public TextComponentTranslation getTooltip() {
    if (this.getGender() == Gender.MALE) {
      return new TextComponentTranslation(ModUtils.localize(LocalizeKeys.TOOLTIP, "animal.product.male_egg"));
      ...
      return new TextComponentTranslation(ModUtils.localize(LocalizeKeys.TOOLTIP, "animal.product.no_egg"),
        getAnimalName());
    }
    return null;
  }
  ...
  public double getOldDeathChance() {
    return ConfigAnimal.ENTITY.CHICKEN.oldDeathChance;
  }
