...
public class RenderWoodSupplyCart extends Render<EntityWoodSupplyCart> {
	...
	@Override
	public void doRender(@NotNull EntityWoodSupplyCart entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	protected ResourceLocation getEntityTexture(@NotNull EntityWoodSupplyCart entity) {
		return ModUtils.getID("textures/entity/supply_cart.png");
	}
