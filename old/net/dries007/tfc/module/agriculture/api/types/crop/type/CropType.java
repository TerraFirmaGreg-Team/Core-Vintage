...
import net.dries007.tfc.module.agriculture.api.types.crop.category.CropCategory;
...
public class CropType {
    ...
    public static class Builder {
        ...
        public Builder setFoodDrop(FoodType type) {
            this.foodDrop = () -> new ItemStack(StorageFood.getFoodItem(FoodItemVariants.INGREDIENT, type));
            return this;
        }
