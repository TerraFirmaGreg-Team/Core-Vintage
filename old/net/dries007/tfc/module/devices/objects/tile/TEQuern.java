...
public class TEQuern extends TEInventory implements ITickable {
    ...
    public void update() {
        if (rotationTimer > 0) {
            ...
            if (rotationTimer == 0) {
                grindItem();
                world.playSound(null, pos, SoundEvents.ENTITY_ARMORSTAND_FALL, SoundCategory.BLOCKS, 1.0f, 0.8f);
                ...
                if (inventory.getStackInSlot(SLOT_HANDSTONE).isEmpty()) {
                    ...
                    world.playSound(null, pos, SoundEvents.ENTITY_ITEM_BREAK, SoundCategory.BLOCKS, 1.0f, 0.6f);
                }
