...
public final class TechRecipes
{
    ...
    public static void onRegisterHeatRecipeEvent(RegistryEvent.Register<HeatRecipe> event)
    {
        ...
        if (TechConfig.TWEAKS.removeGlassRecipes)
        {
            modRegistry.remove(new ResourceLocation(TerraFirmaCraft.MODID_TFC, "glass"));
            modRegistry.remove(new ResourceLocation(TerraFirmaCraft.MODID_TFC, "glass_shard"));
        }
    ...
    public static void onRegisterAnvilRecipeEvent(RegistryEvent.Register<AnvilRecipe> event)
    {
        ...
        r.register(new AnvilRecipe(new ResourceLocation(MODID, "steel_draw_plate"), IIngredient.of(ItemMetal.get(TFCRegistries.METALS.getValue(new ResourceLocation(TerraFirmaCraft.MODID_TFC, "steel")), Metal.ItemType.INGOT)), new ItemStack(TechItems.STEEL_DRAW_PLATE), Metal.Tier.TIER_IV, null, ForgeRule.PUNCH_LAST, ForgeRule.PUNCH_SECOND_LAST, ForgeRule.HIT_ANY));
        r.register(new AnvilRecipe(new ResourceLocation(MODID, "black_steel_draw_plate"), IIngredient.of(ItemMetal.get(TFCRegistries.METALS.getValue(new ResourceLocation(TerraFirmaCraft.MODID_TFC, "black_steel")), Metal.ItemType.INGOT)), new ItemStack(TechItems.BLACK_STEEL_DRAW_PLATE), Metal.Tier.TIER_V, null, ForgeRule.PUNCH_LAST, ForgeRule.PUNCH_SECOND_LAST, ForgeRule.HIT_ANY));
        ...
        for (Metal metal : TFCRegistries.METALS.getValuesCollection())
        {
            ...
            if (item != null)
            {
                ...
                {
                    //noinspection ConstantConditions
                    r.register(new AnvilRecipe(new ResourceLocation(MODID, (metal.getRegistryName().getPath()).toLowerCase() + "_blowpipe"), ingredient, output, metal.getTier(), null, ForgeRule.BEND_LAST, ForgeRule.BEND_SECOND_LAST));
                }
            }
        }
    }
    ...
    public static void onRegisterCraftingRecipeEvent(RegistryEvent.Register<IRecipe> event)
    {
        ...
        for (Metal metal : TFCRegistries.METALS.getValuesCollection())
        {
            ...
            if (!output.isEmpty())
            {
                ...
                list.add(ingredient);
                //noinspection ConstantConditions
                r.register(new ShapelessDamageRecipe(groupStrip, list, output, 1).setRegistryName(MODID, metal.getRegistryName().getPath().toLowerCase() + "_strip"));
            }
            ...
            if (!output.isEmpty())
            {
                ...
                list.add(ingredient);
                //noinspection ConstantConditions
                r.register(new ShapelessDamageRecipe(groupRod, list, output, 1).setRegistryName(MODID, metal.getRegistryName().getPath().toLowerCase() + "_rod"));
            }
            ...
            if (!output.isEmpty())
            {
                ...
                list.add(ingredient);
                //noinspection ConstantConditions
                r.register(new ShapelessDamageRecipe(groupBolt, list, output, 1).setRegistryName(MODID, metal.getRegistryName().getPath().toLowerCase() + "_bolt"));
            }
            ...
            if (!output.isEmpty())
            {
                ...
                list.add(ingredient);
                //noinspection ConstantConditions
                r.register(new ShapelessDamageRecipe(groupScrew, list, output, 1).setRegistryName(MODID, metal.getRegistryName().getPath().toLowerCase() + "_screw"));
            }
