...
public class ItemWoodBucket extends BaseItem {
...
//      for (String fluidName : ConfigWood.ITEM.BUCKET.whitelist) {
//        Fluid fluid = FluidRegistry.getFluid(fluidName);
//        if (fluid != null) {
//          ItemStack stack = new ItemStack(this);
//          IFluidHandlerItem cap = CapabilityFluidItem.get(stack);
//          if (cap != null) {
...
//      }
  ...
  public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable NBTTagCompound nbt) {
    return new WhitelistComplex(stack, CAPACITY, ConfigWood.ITEM.BUCKET.whitelist);
  }
}
