package net.dries007.tfcflorae.util.agriculture;
...
public enum SeasonalTrees {
  ...
  MACLURA(() -> ItemsTFCF.OSAGE_ORANGE, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                  0}, -1f, 17f, 140f, 400f, 0.33f, false, false, false, TreesTFCF.MACLURA_TREE),
  ...
  PINK_IVORY(() -> ItemsTFCF.PINK_IVORY_DRUPE, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                         0}, 18f, 31f, 210f, 500f, 0.33f, false, false, false, TreesTFCF.PINK_IVORY_TREE),
  ...
  JOSHUA_TREE(() -> ItemsTFCF.BARREL_CACTUS_FRUIT, new int[]{1, 2, 2, 2, 3, 3, 3, 1, 1, 1, 1,
                                                             1}, 13f, 35f, 140f, 360f, 0.33f, false, false, true, TreesTFCF.JOSHUA_TREE_TREE),
  PURPLE_JACARANDA(null, new int[]{0, 0, 1, 2, 2, 1, 1, 1, 4, 4, 0, 0}, 10f, 34f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.JACARANDA_TREE),
  YELLOW_JACARANDA(null, new int[]{0, 0, 1, 2, 2, 1, 1, 1, 4, 4, 0, 0}, 10f, 34f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.JACARANDA_TREE),
  ...
  WHITE_CEDAR(() -> ItemsTFCF.JUNIPER, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                 0}, -8f, 17f, 10f, 240f, 0.33f, false, false, false, TreesTFCF.WHITE_CEDAR_TREE),
  ...
  YELLOW_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                      0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, TreesTFCF.HAWTHORN_TREE),
  ORANGE_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                      0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, TreesTFCF.HAWTHORN_TREE),
  RED_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                   0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, TreesTFCF.HAWTHORN_TREE),
  YELLOW_ROWAN(() -> ItemsTFCF.ROWAN_BERRY, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                      0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, TreesTFCF.ROWAN_TREE),
  ORANGE_ROWAN(() -> ItemsTFCF.ROWAN_BERRY, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                      0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, TreesTFCF.ROWAN_TREE),
  ...
  YELLOW_PINK_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                   0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.PINK_CHERRY_TREE),
  ORANGE_PINK_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                   0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.PINK_CHERRY_TREE),
  RED_PINK_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.PINK_CHERRY_TREE),
  YELLOW_WHITE_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                    0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.WHITE_CHERRY_TREE),
  ORANGE_WHITE_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                    0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.WHITE_CHERRY_TREE),
  RED_WHITE_CHERRY(() -> ItemFoodTFC.get(Food.CHERRY), new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                                 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, TreesTFCF.WHITE_CHERRY_TREE),
  ...
  YELLOW_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                          0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, TreesTFCF.WHITEBEAM_TREE),
  ORANGE_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                          0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, TreesTFCF.WHITEBEAM_TREE),
  RED_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[]{0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0,
                                                       0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, TreesTFCF.WHITEBEAM_TREE),
