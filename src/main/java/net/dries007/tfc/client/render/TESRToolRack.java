  ...
  static {
    ...
    for (int dir = 0; dir < 4; dir++) {
      for (int slot = 0; slot < 4; slot++) {
        if (slot < 2) {ITEM_LOCATION[dir][slot][1] = heightHigh;} else {ITEM_LOCATION[dir][slot][1] = heightLow;}

        if (dir % 2 == 0) {
          if (slot % 2 == 0) {ITEM_LOCATION[dir][slot][0] = column1;} else {ITEM_LOCATION[dir][slot][0] = column2;}
        } else {
          if (slot % 2 == 0) {ITEM_LOCATION[dir][slot][2] = column1;} else {ITEM_LOCATION[dir][slot][2] = column2;}
        }
