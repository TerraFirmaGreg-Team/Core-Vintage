...
public class EntityMobCart extends AbstractDrawn {
  ...
  public void applyEntityCollision(Entity entity) {
    ...
    if (!entity.isPassenger(this)) {
      if (!this.world.isRemote && this.pulling != entity && !(this.getControllingPassenger() instanceof EntityPlayer) && this.getPassengers().size() < 2
          && !entity.isRiding() && entity.width < this.width && entity instanceof EntityLivingBase && !(entity instanceof EntityWaterMob)
