    ...
    public int[] getInts(int x, int z, int xSize, int zSize) {
        ...
        for (int zz = 0; zz < zSize; ++zz) {
            for (int xx = 0; xx < xSize; ++xx) {
                this.initChunkSeed((long) (xx + x), (long) (zz + z));
                ...
                if (thisID == this.highHillsID) {
                    ...
                    if (thisID != this.mesaPlateauMID && thisID != this.mesaPlateauID && thisID != this.mesaBryceID) {
                        outCache[xx + zz * xSize] = thisID;
                    } else if ((zn != this.mesaPlateauMID || xp != this.mesaPlateauMID || xn != this.mesaPlateauMID || zp != this.mesaPlateauMID) &&
                            (zn != this.mesaPlateauID || xp != this.mesaPlateauID || xn != this.mesaPlateauID || zp != this.mesaPlateauID) &&
                            (zn != this.mesaBryceID || xp != this.mesaBryceID || xn != this.mesaBryceID || zp != this.mesaBryceID)) {
                        outCache[xx + zz * xSize] = this.mesaID;
                    } else {
                        outCache[xx + zz * xSize] = thisID;
                    }
                } else if ((zn != this.flatlandsID || xp != this.flatlandsID || xn != this.flatlandsID || zp != this.flatlandsID) &&
                        (zn != this.fieldsID || xp != this.fieldsID || xn != this.fieldsID || zp != this.fieldsID)) {
