...
public abstract class TileEntityHPBase extends TileEntity {
  ...
  public TileEntityHPBase(int inventorySize) {
    ...
    inventory = new IHPInventory() {
      ...
      public boolean isUsableByPlayer(EntityPlayer player) {
        return getWorld().getTileEntity(getPos()) == TileEntityHPBase.this
  ...
  public static boolean canCombine(ItemStack stack1, ItemStack stack2) {
    return stack1.getItem() == stack2.getItem() && (stack1.getMetadata() == stack2.getMetadata() && (stack1.getCount() <= stack1.getMaxStackSize()
  ...
  public <T> T getCapability(Capability<T> capability, @javax.annotation.Nullable EnumFacing facing) {
    if (capability == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY) {
      if (facing == null) {return (T) handlerNull;} else if (facing == EnumFacing.DOWN) {return (T) handlerBottom;} else {return (T) handlerIn;}
    }
