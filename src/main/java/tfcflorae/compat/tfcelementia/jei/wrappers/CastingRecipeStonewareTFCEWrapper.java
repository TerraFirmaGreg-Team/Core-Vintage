...
public class CastingRecipeStonewareTFCEWrapper extends net.dries007.tfc.compat.jei.wrappers.CastingRecipeWrapper {
    private ItemStack mold;
    private FluidStack input;

    public CastingRecipeStonewareTFCEWrapper(Metal metal, ItemMetalTFCE.ItemType type) {
