package net.dries007.tfcflorae.objects.te;
...
public class TEFruitChest extends TileEntityChest implements ISlotCallback {
  ...
  protected boolean isChestAt(@Nonnull BlockPos posIn) {
    ...
    return block instanceof BlockFruitChestTFCF && (((BlockFruitChestTFCF) block).wood == getWood() || ((BlockFruitChestTFCF) block).tree == getTree())
           && ((BlockChest) block).chestType == getChestType();
  }
