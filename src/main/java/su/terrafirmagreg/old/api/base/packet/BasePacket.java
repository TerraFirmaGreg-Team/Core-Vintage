...
import su.terrafirmagreg.old.api.network.IPacket;
...
public abstract class BasePacket<REQ extends BasePacket<REQ>> implements Serializable, IPacket<REQ> {
  ...
  static {
    ...
    // Primitives
    addIOHandler(byte.class, BasePacket::readByte, BasePacket::writeByte);
    addIOHandler(short.class, BasePacket::readShort, BasePacket::writeShort);
    addIOHandler(int.class, BasePacket::readInt, BasePacket::writeInt);
    addIOHandler(long.class, BasePacket::readLong, BasePacket::writeLong);
    addIOHandler(float.class, BasePacket::readFloat, BasePacket::writeFloat);
    addIOHandler(double.class, BasePacket::readDouble, BasePacket::writeDouble);
    addIOHandler(boolean.class, BasePacket::readBoolean, BasePacket::writeBoolean);
    addIOHandler(char.class, BasePacket::readChar, BasePacket::writeChar);

    // Primitive Arrays
    addIOHandler(byte[].class, BasePacket::readByteArray, BasePacket::writeByteArray);
    addIOHandler(short[].class, BasePacket::readShortArray, BasePacket::writeShortArray);
    addIOHandler(int[].class, BasePacket::readIntArray, BasePacket::writeIntArray);
    addIOHandler(long[].class, BasePacket::readLongArray, BasePacket::writeLongArray);
    addIOHandler(float[].class, BasePacket::readFloatArray, BasePacket::writeFloatArray);
    addIOHandler(double[].class, BasePacket::readDoubleArray, BasePacket::writeDoubleArray);
    addIOHandler(boolean[].class, BasePacket::readBooleanArray, BasePacket::writeBooleanArray);
    addIOHandler(char[].class, BasePacket::readCharArray, BasePacket::writeCharArray);

    // Objects
    addIOHandler(String.class, BasePacket::readString, BasePacket::writeString);
    addIOHandler(NBTTagCompound.class, BasePacket::readNBT, BasePacket::writeNBT);
    addIOHandler(ItemStack.class, BasePacket::readItemStack, BasePacket::writeItemStack);
    addIOHandler(BlockPos.class, BasePacket::readBlockPos, BasePacket::writeBlockPos);
    addIOHandler(IBlockState.class, BasePacket::readState, BasePacket::writeState);
    addIOHandler(ResourceLocation.class, BasePacket::readResourceLocation, BasePacket::writeResourceLocation);
    addIOHandler(EnchantmentData.class, BasePacket::readEnchantmentData, BasePacket::writeEnchantmentData);

    // Object Arrays
    addIOHandler(String[].class, BasePacket::readStringArray, BasePacket::writeStringArray);
    addIOHandler(NBTTagCompound[].class, BasePacket::readNBTArray, BasePacket::writeNBTArray);
    addIOHandler(ItemStack[].class, BasePacket::readItemStackArray, BasePacket::writeItemStackArray);
    addIOHandler(BlockPos[].class, BasePacket::readBlockPosArray, BasePacket::writeBlockPosArray);
    addIOHandler(IBlockState[].class, BasePacket::readStateArray, BasePacket::writeStateArray);
    addIOHandler(ResourceLocation[].class, BasePacket::readResourceLocationArray, BasePacket::writeResourceLocationArray);
    addIOHandler(EnchantmentData[].class, BasePacket::readEnchantmentDataArray, BasePacket::writeEnchantmentDataArray);
  }
  ...
  // region ====== Writer & Reader Functions ======
