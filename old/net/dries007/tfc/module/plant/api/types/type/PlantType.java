...
public class PlantType {
    ...
    public IBlockState getWaterType() {
        if (plantBlockVariant == PlantEnumVariant.FLOATING_SEA || plantBlockVariant == PlantEnumVariant.WATER_SEA || plantBlockVariant == PlantEnumVariant.TALL_WATER_SEA || plantBlockVariant == PlantEnumVariant.EMERGENT_TALL_WATER_SEA) {
            return SALT_WATER;
        } else {
            return FRESH_WATER;
        }
    ...
    public boolean canBePotted() {
        return plantBlockVariant == PlantEnumVariant.STANDARD ||
                plantBlockVariant == PlantEnumVariant.CACTUS ||
                plantBlockVariant == PlantEnumVariant.CREEPING ||
                plantBlockVariant == PlantEnumVariant.TALL_PLANT ||
                plantBlockVariant == PlantEnumVariant.DRY ||
                plantBlockVariant == PlantEnumVariant.DESERT ||
                plantBlockVariant == PlantEnumVariant.MUSHROOM;
    }
