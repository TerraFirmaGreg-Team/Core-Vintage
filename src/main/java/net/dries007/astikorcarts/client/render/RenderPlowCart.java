...
import net.dries007.astikorcarts.client.model.ModelPlowCart;
    ...
    for (int i = 0; i < entity.inventory.getSizeInventory(); i++) {
      ...
      if (entity.getPlowing()) {
        GlStateManager.translate(
          x + (1.45D + offsetSides) * MathHelper.sin((-36.0F + entityYaw + i * 36.0F) * 0.017453292F),
          y + 0.10D, z - (1.45D + offsetSides) * MathHelper.cos((-36.0F + entityYaw + i * 36.0F) * 0.017453292F));
        GlStateManager.rotate(120.0F - entityYaw - 30.0F * i, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(181.0F, 0.0F, 0.0F, 1.0F);
      } else {
        GlStateManager.translate(
          x + (1.9D + offsetSides) * MathHelper.sin((-34.7F + entityYaw + i * 34.7F) * 0.017453292F),
          y + 0.90D, z - (1.9D + offsetSides) * MathHelper.cos((-34.7F + entityYaw + i * 34.7F) * 0.017453292F));
        GlStateManager.rotate(120.0F - entityYaw - 30.0F * i, 0.0F, 1.0F, 0.0F);
