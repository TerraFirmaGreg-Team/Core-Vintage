package su.terrafirmagreg.modules.wood.data.recipes;
...
public final class LoomRecipes {
    ...
    public static void onRegister(RegistryManager registry) {
        RegistryWood.LOOM.registerAll(
                ...
                //                .setStepCount(8)
                //                .setInProgressTexture("textures/blocks/pineapple.png")
                //                .build();
                //
        ...
        //                .setStepCount(12)
        //                .setInProgressTexture("textures/blocks/devices/loom/product/yucca.png")
        //                .build();
        //
        ...
        //                .setStepCount(12)
        //                .setInProgressTexture("textures/blocks/devices/loom/product/cotton.png")
        //                .build();
        //
        ...
        //                .setStepCount(12)
        //                .setInProgressTexture("textures/blocks/devices/loom/product/hemp.png")
        //                .build();
        //
        ...
        //                .setStepCount(12)
        //                .setInProgressTexture("textures/blocks/devices/loom/product/linen.png")
        //                .build();
        //
        ...
        //                .setStepCount(12)
        //                .setInProgressTexture("textures/blocks/devices/loom/product/sisal.png")
        //                .build();
        //
