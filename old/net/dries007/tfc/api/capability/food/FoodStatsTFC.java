...
public class FoodStatsTFC extends FoodStats implements IFoodStatsTFC {
    ...
    public static void replaceFoodStats(EntityPlayer player) {
        ...
        if (player instanceof EntityPlayerMP) {
            ModuleCoreOld.PACKET_SERVICE.sendTo(new SCPacketFoodStatsReplace(), (EntityPlayerMP) player);
        }
    }
    ...
    public void addStats(ItemFood foodItem, ItemStack stack) {
        ...
        if (foodCap != null) {
            ...
            ModuleCoreOld.LOGGER.info("Player ate a weird food: {} / {} that was not a food capability but was an ItemFood...", foodItem, stack);
        }
    }
    ...
    public void onUpdate(EntityPlayer player) {
        ...
        if (player instanceof EntityPlayerMP) {
            ModuleCoreOld.PACKET_SERVICE.sendTo(new SCPacketFoodStatsUpdate(nutritionStats.getNutrients(), thirst), (EntityPlayerMP) player);
        }
    }
