...
public class CastingCategoryEarthenwareFLCompat extends BaseRecipeCategory<CastingRecipeWrapperEarthenwareFL> {
    ...
    public CastingCategoryEarthenwareFLCompat(IGuiHelper helper, String Uid) {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, CastingRecipeWrapperEarthenwareFL recipeWrapper, IIngredients ingredients) {
