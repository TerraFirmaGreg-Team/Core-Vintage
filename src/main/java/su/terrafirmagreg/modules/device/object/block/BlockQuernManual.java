...
public class BlockQuernManual extends BaseBlock implements IHighlightHandler, IProviderTile {
  ...
  public BlockQuernManual() {
    ...
    getSettings()
      .registryKey("device/quern/manual")
  ...
  public @Nullable TileEntity createNewTileEntity(World worldIn, int meta) {
    return new TileQuernManual();
  }

  @Override
  public Class<TileQuernManual> getTileClass() {
    return TileQuernManual.class;
  }

  @Override
  public TileEntitySpecialRenderer<?> getTileRenderer() {
    return new TESRQuernManual();
  }
