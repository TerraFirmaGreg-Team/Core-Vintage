package net.dries007.tfc.module.core.submodule.rock.api.variant.block;
...
import static net.dries007.tfc.module.core.submodule.rock.common.RockStorage.ROCK_BLOCKS;
...
public class RockBlockVariant {
    ...
    public RockBlockVariant(@Nonnull String name, float baseHardness, @Nonnull BiFunction<RockBlockVariant, RockType, IRockBlock> factory) {
        ...
        for (var type : RockType.getRockTypes()) {
            ...
            if (ROCK_BLOCKS.put(new Pair<>(this, type), rockBlock) != null)
