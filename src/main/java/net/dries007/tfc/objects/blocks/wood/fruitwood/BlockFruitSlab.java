...
public abstract class BlockFruitSlab extends BlockSlab {
  ...
  public static class Half extends BlockFruitSlab {
    ...
    public Half(SeasonalTrees tree) {
      ...
      halfSlab = this;
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "slab");
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "slab", "wood");
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "slab", "wood", tree);
    }
