package su.terrafirmagreg.modules.worldgen.classic.objects.generator.soil;
...
public class GeneratorSoil implements IWorldGenerator {
  ...
  public void generate(Random random, int chunkX, int chunkZ, World world,
    ...
    /*private void generateSand(World world, Random rng, BlockPos start)
    {
        ...
        if (start.getY() <= WorldTypeClassic.SEALEVEL && floraDensity > 0.1f + Math.abs(0.05f * rng.nextGaussian()) && 
            (b == BiomesWorld.OCEAN || b == BiomesTFC.DEEP_OCEAN || b == BiomesTFC.BEACH || b == BiomesTFC.LAKE))
        {
            ...
            for (int z = 0; z < 16; ++z)
            {
                if (rng.nextInt(ConfigTFCF.General.WORLD.sandRarity) == 0)
                {
                    ...
                    for (int y = -depth; y <= 0; y++)
                    {
                        ...
                        if ((b == BiomesWorld.OCEAN || b == BiomesTFC.DEEP_OCEAN || b == BiomesTFC.BEACH || b == BiomesTFC.LAKE) &&
                            pos.getY() <= WorldTypeClassic.SEALEVEL &&
            ...
            for (int z = 0; z < 16; ++z)
            {
                if (rng.nextInt(ConfigTFCF.General.WORLD.podzolRarity) == 0)
                {
                    ...
                    for (int y = -depth; y <= 0; y++)
                    {
                        ...
                        if (pos.getY() >= WorldTypeClassic.SEALEVEL + 2 && pos.getY() <= 175 &&
