package su.terrafirmagreg.api.registry.builder;
...
public class LootBuilder {
    ...
    public LootEntryItem build() {
        ...
        return new LootEntryItem(this.item, this.weight, this.quality, this.functions.toArray(new LootFunction[0]),
    ...
    public String toString() {
        ...
        return String.format("Name: %s - Pool: %s - Weight: %d - Quality: %d Item: %s", this.name, this.pool, this.weight, this.quality,
