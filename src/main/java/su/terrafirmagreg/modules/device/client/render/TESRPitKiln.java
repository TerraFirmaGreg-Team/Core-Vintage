...
public class TESRPitKiln extends TileEntitySpecialRenderer<TEPitKiln> {
	private static final ResourceLocation THATCH = ModUtils.getID("textures/blocks/thatch.png");
	private static final ResourceLocation BARK = ModUtils.getID("textures/blocks/wood/log/oak.png");
