...
public class RenderBoatTFC extends Render<EntityBoatTFC> {
  ...
  protected ResourceLocation getEntityTexture(EntityBoatTFC entity) {
    ...
    if (wood != null) {
      ...
      return new ResourceLocation(TFC, "textures/entity/boat/" + wood.getRegistryName().getPath().toLowerCase() + ".png");
    }
    // Fallback
    return new ResourceLocation(TFC, "textures/entity/boat/oak.png");
  }
