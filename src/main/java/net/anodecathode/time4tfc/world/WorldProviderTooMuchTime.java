...
import static net.anodecathode.time4tfc.network.packet.PacketServerSettings.dayDuration;
import static net.anodecathode.time4tfc.network.packet.PacketServerSettings.nightDuration;
