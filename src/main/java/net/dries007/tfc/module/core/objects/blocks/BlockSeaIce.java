...
public class BlockSeaIce extends BlockIce implements ITemperatureBlock, IItemProvider {
    public static final String NAME = "placed_item";
    private final Fluid waterFluid;
    private final float meltThreshold;

    public BlockSeaIce(Fluid waterFluid) {
        this.waterFluid = waterFluid;
        this.meltThreshold = IceMeltHandler.SALT_WATER_MELT_THRESHOLD;
