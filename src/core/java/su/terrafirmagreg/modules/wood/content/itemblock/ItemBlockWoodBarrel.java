package su.terrafirmagreg.modules.wood.content.itemblock;
...
import su.terrafirmagreg.modules.core.capabilities.fluid.CapabilityProviderFluid.WhitelistComplex;
...
public class ItemBlockWoodBarrel extends BaseItemBlock implements IProviderItemMesh {
  ...
  public ModelResourceLocation[] getModelLocations() {
    final var name = block.getSettings().getResource();
    return new ModelResourceLocation[]{
      new ModelResourceLocation(name, "sealed=true"),
      new ModelResourceLocation(name, "sealed=false")
    };
  }

  // This is not an item handler, but still saves items from a sealed barrel
  public static class ItemBarrelFluidHandler extends WhitelistComplex {
