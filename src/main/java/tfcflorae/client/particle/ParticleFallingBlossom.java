...
public class ParticleFallingBlossom extends Particle {
    ...
    public ParticleFallingBlossom(World worldIn, double x, double y, double z, double speedX, double speedY, double speedZ, int duration) {
