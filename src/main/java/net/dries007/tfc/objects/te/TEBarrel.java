...
public class TEBarrel extends TETickableInventory
    ...
    public void saveToItemStack(ItemStack stack) {
        ...
        if (barrelCap instanceof ItemBlockBarrel.ItemBarrelFluidHandler) {
            ...
            if (storing != null || inventoryTag != null || surplusTag != null) {
                ((ItemBlockBarrel.ItemBarrelFluidHandler) barrelCap).setBarrelContents(storing, inventoryTag, surplusTag, sealedTick,
                        sealedCalendarTick);
            }
        }
    }
        ...
        if (!world.isRemote) {
            ...
            if (tickCounter == 10) {
                ...
                FluidActionResult result = FluidTransferHelper.emptyContainerIntoTank(fluidContainerIn, tank, inventory, SLOT_FLUID_CONTAINER_OUT,
                        ConfigTFC.Devices.BARREL.tank, world, pos);
