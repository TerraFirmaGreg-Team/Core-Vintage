...
public class BlockFruitChestTFCF extends BlockChest implements ICapabilitySize {
  ...
  public BlockFruitChestTFCF(Type type, IFruitTree tree) {
    ...
    if (type == TFCBASIC) {
      ...
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest");
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest", "wood");
      //noinspection ConstantConditions
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest", tree);
    } else if (type == TFCTRAP) {
      if (MAP_TRAP.put(tree, this) != null) {throw new IllegalStateException("There can only be one.");}
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest", "trapped");
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest", "wood");
      //noinspection ConstantConditions
      net.dries007.tfc.util.OreDictionaryHelper.register(this, "chest", "trapped", tree);
    } else {
