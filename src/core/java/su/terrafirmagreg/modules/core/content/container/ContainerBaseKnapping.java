package su.terrafirmagreg.modules.core.content.container;

import su.terrafirmagreg.api.util.StackUtils;
import su.terrafirmagreg.framework.manager.content.base.gui.button.api.IButtonHandler;
import su.terrafirmagreg.framework.manager.content.base.inventory.spi.container.BaseContainerItemStack;
import su.terrafirmagreg.modules.core.content.slot.SlotKnappingOutput;
...
public abstract class ContainerBaseKnapping extends BaseContainerItemStack implements IButtonHandler {
  ...
  public ContainerBaseKnapping(KnappingType type, InventoryPlayer playerInv, ItemStack stack) {
  ...
  protected void addContainerSlots() {
    addSlotToContainer(
      new SlotKnappingOutput(new ItemStackHandler(1), 0, 128, 44, this::resetMatrix));
  }
