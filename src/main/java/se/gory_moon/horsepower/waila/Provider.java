...
public class Provider implements IWailaDataProvider {
	...
	public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
		...
		if (config.getConfig("horsepower:showItems") && (accessor.getTileEntity() instanceof TileEntityHPBase || accessor.getTileEntity() instanceof TileEntityFiller) && accessor.getPlayer()
		                                                                                                                                                                          .isSneaking()) {
				...
				if (itemHandler != null) {
					{
						...
						if (!stack.isEmpty())
							currenttip.add(SpecialChars.getRenderString("waila.stack", "1", name, String.valueOf(stack.getCount()), String.valueOf(stack.getItemDamage()), stack.serializeNBT()
