...
public enum Heat {
    ...
    @Nullable public static Heat getHeat(float temperature) {
    ...
    @Nullable public static String getTooltipColorless(float temperature) {
    ...
    @Nullable public static String getTooltip(float temperature) {
        Heat heat = Heat.getHeat(temperature);
    ...
    @Nullable public static String getTooltipAlternate(float temperature) {
        Heat heat = Heat.getHeat(temperature);
        String tooltip = getTooltipColorless(temperature);
        if (tooltip != null && heat != null) {
