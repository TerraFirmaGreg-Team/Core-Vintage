...
public enum JsonConfigRegistry {
    ...
    public void preInit(File dir) {
        ...
        ModuleCoreOld.LOGGER.info("Loading or creating TFC config directory");
    ...
    public void postInit() {
        ...
        try {
            ...
            ModuleCoreOld.LOGGER.error("Unable to read files in the config directory! TFC will not generate any ore veins or load any damage resitances!");
            ModuleCoreOld.LOGGER.error("Error: ", e);
            return;
        }
        for (Path path : recursivePathList) {
            try {
                ...
                ModuleCoreOld.LOGGER.error("There was an error reading a json file at: " + path);
                ModuleCoreOld.LOGGER.error("Error: ", e);
            }
        }
