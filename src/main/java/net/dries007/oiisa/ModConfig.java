...
import static net.dries007.oiisa.OversizedItemInStorageArea.INSTANCE;
...
public class ModConfig {
  ...
  public static class SyncConfig {
    ...
    public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
      if (event.getModID().equals(MODID_OSA)) {
        ConfigManager.sync(MODID_OSA, Config.Type.INSTANCE);
