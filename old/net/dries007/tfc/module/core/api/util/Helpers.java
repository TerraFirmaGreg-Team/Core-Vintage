...
import net.dries007.tfc.module.animal.objects.entities.predator.EntityAnimalPolarBear;
...
public final class Helpers {
    ...
    public static double getTPS(World world, int dimId) {
        ...
        double worldTickTime = DoubleMath.mean(world.getMinecraftServer().worldTickTimes.get(dimId)) * 1.0E-6D;
    ...
    public static boolean isRawStone(IBlockState current) {
        if (current.getBlock() instanceof IRockBlock rockTypeBlock)
            return rockTypeBlock.getBlockVariant() == RockBlockVariants.RAW;
        return false;
    }
    ...
    public static boolean isClay(IBlockState current) {
        if (current.getBlock() instanceof ISoilBlock soilTypeBlock) {
            ...
            return variant == SoilBlockVariants.CLAY || variant == SoilBlockVariants.CLAY_GRASS;
        }
        return false;
    }
    ...
    public static boolean isSand(IBlockState current) {
        if (current.getBlock() instanceof IRockBlock rockTypeBlock) {
            return rockTypeBlock.getBlockVariant() == RockBlockVariants.SAND;
        }
        return false;
    }
    ...
    public static boolean isGravel(IBlockState current) {
        if (current.getBlock() instanceof IRockBlock rockTypeBlock) {
            return rockTypeBlock.getBlockVariant() == RockBlockVariants.GRAVEL;
        }
        return false;
    }
    ...
    public static boolean isSoil(IBlockState current) {
        ...
        if (current.getBlock() instanceof ISoilBlock soilTypeBlock) {
            var variant = soilTypeBlock.getBlockVariant();
            return variant == SoilBlockVariants.GRASS || variant == SoilBlockVariants.DRY_GRASS ||
                    variant == SoilBlockVariants.DIRT || variant == SoilBlockVariants.CLAY || variant == SoilBlockVariants.CLAY_GRASS;
        }
        return false;
    }
    ...
    public static boolean isSoilOrGravel(IBlockState current) {
        ...
        if (current.getBlock() instanceof ISoilBlock soilTypeBlock) {
            var variant = soilTypeBlock.getBlockVariant();
            return variant == SoilBlockVariants.GRASS || variant == SoilBlockVariants.DRY_GRASS || variant == SoilBlockVariants.DIRT;
        }
        if (current.getBlock() instanceof IRockBlock rockTypeBlock)
            return rockTypeBlock.getBlockVariant() == RockBlockVariants.GRAVEL;
        return false;
    ...
    public static boolean isGrass(IBlockState current) {
        ...
        if (current.getBlock() instanceof ISoilBlock soilTypeBlock) {
            var variant = soilTypeBlock.getBlockVariant();
            return variant == SoilBlockVariants.GRASS || variant == SoilBlockVariants.DRY_GRASS || variant == SoilBlockVariants.CLAY_GRASS;
        }
        return false;
    }
    ...
    public static boolean isGround(IBlockState current) {
        if (current.getBlock() instanceof IRockBlock rockTypeBlock) {
            ...
            return variant == RockBlockVariants.GRAVEL || variant == RockBlockVariants.SAND || variant == RockBlockVariants.RAW;
        }
        if (current.getBlock() instanceof ISoilBlock soilTypeBlock) {
            var variant = soilTypeBlock.getBlockVariant();
            return variant == SoilBlockVariants.GRASS || variant == SoilBlockVariants.DRY_GRASS || variant == SoilBlockVariants.DIRT;
