...
public class ModuleAgriculture extends ModuleBase {
    ...
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleAgriculture.class.getSimpleName());

    public ModuleAgriculture() {
        super(0, Tags.MOD_ID);

        this.setRegistry(new Registry(Tags.MOD_ID, AGRICULTURE_TAB));
