...
import net.dries007.tfc.module.animal.objects.entities.predator.EntityAnimalDireWolf;
...
public class RenderAnimalDireWolf extends RenderLiving<EntityAnimalDireWolf> {
    private static final ResourceLocation TEXTURE = Helpers.getID("textures/entity/animal/predators/direwolf.png");
