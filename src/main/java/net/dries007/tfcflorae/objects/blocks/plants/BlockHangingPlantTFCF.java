...
public class BlockHangingPlantTFCF extends BlockPlantDummy1 implements IGrowable, ITallPlant {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    ...
    return (up.getBlock().canSustainPlant(up, worldIn, pos.up(), net.minecraft.util.EnumFacing.DOWN, this)
            || isValidBlock(worldIn, pos.up(), worldIn.getBlockState(pos.up())) || worldIn.getBlockState(pos.up()).getBlock() == this)
  ...
  protected boolean isValidBlock(World world, BlockPos pos, IBlockState blockState) {
    ...
    return blockState.isSideSolid(world, pos, EnumFacing.DOWN) || material == Material.LEAVES || material == Material.GROUND || material == Material.ROCK
           || material == Material.WOOD || BlocksTFC.isGround(iblockstate) || blockState.getBlock() == this;
  }
