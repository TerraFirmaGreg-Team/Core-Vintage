package net.dries007.tfc.api.types2.wood;
...
public enum Wood implements IStringSerializable {
		...
		public boolean makeTree(TemplateManager manager, World world, BlockPos pos, Random rand, boolean isWorldGen) {
				if (this.tree.getGenerator().canGenerateTree(world, pos, this)) {
						this.tree.getGenerator().generateTree(manager, world, pos, this, rand, isWorldGen);
						return true;
				}
				return false;
		}
