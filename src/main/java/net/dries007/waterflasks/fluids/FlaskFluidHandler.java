...
package net.dries007.waterflasks.fluids;
...
/**
 * Lavishly copied from tfc FluidWhitelistHandler. This Handler just inherits from FluidHandlerItemStack instead of FluidHandlerItemStackSimple, which allows it
 * to be partially full.
 */
