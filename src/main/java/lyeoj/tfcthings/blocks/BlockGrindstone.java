...
public class BlockGrindstone extends Block implements ICapabilitySize, TFCThingsConfigurableItem {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    if (hand.equals(EnumHand.MAIN_HAND)) {
      TileEntityGrindstone teGrindstone = Helpers.getTE(world, pos, TileEntityGrindstone.class);
      if (teGrindstone != null) {
        ...
        if (inventory != null) {
          ...
          int slot =
            inventory.getStackInSlot(TileEntityGrindstone.SLOT_GRINDSTONE).isEmpty() && inventory.getStackInSlot(TileEntityGrindstone.SLOT_INPUT).isEmpty()
            ? TileEntityGrindstone.SLOT_GRINDSTONE : TileEntityGrindstone.SLOT_INPUT;
  ...
  public void breakBlock(World world, BlockPos pos, IBlockState state) {
    TileEntityGrindstone grindstone = Helpers.getTE(world, pos, TileEntityGrindstone.class);
    if (grindstone != null) {
