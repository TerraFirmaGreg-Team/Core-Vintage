...
public class BarrelRecipes {
    ...
    public static void registerBarrelRecipes() {
        ...
        registry.registerAll(
                ...
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 600), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.SUGARCANE), 5)), null, new ItemStack(Items.SUGAR), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("sugar"),
                ...
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.BARLEY_FLOUR))), new FluidStack(FluidRegistry.getFluid("beer"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("beer"),
                ...
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.RICE_FLOUR))), new FluidStack(FluidRegistry.getFluid("sake"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("sake"),
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.POTATO))), new FluidStack(FluidRegistry.getFluid("vodka"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("vodka"),
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.WHEAT_FLOUR))), new FluidStack(FluidRegistry.getFluid("whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("whiskey"),
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.CORNMEAL_FLOUR))), new FluidStack(FluidRegistry.getFluid("corn_whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("corn_whiskey"),
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.RYE_FLOUR))), new FluidStack(FluidRegistry.getFluid("rye_whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("rye_whiskey"),
                ...
                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("curdled_milk"), 625), IIngredient.of(ItemStack.EMPTY), null, new ItemStack(ItemFoodTFC.get(Food.CHEESE), 2), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("cheese"),
        ...
        for (Food food : new Food[]{Food.SALAD_DAIRY, Food.SALAD_FRUIT, Food.SALAD_GRAIN, Food.SALAD_MEAT, Food.SALAD_VEGETABLE, Food.SOUP_DAIRY, Food.SOUP_FRUIT, Food.SOUP_GRAIN, Food.SOUP_MEAT, Food.SOUP_VEGETABLE}) {
            registry.register(new BarrelRecipeDynamicBowlFood(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 200), IIngredient.of(ItemFoodTFC.get(food)), 0).setRegistryName(food.name().toLowerCase() + "_cleaning"));
        }
