package su.terrafirmagreg.modules.worldgen.classic.objects.generator.groundcover;
...
public class GeneratorSurfaceFlint implements IWorldGenerator {

  private double factor;

  public GeneratorSurfaceFlint() {
    factor = 1;
  }
    ...
    if (pos.getY() > 146 && pos.getY() < 170) {
      if (world.isAirBlock(pos) && world.getBlockState(pos.down())
        ...
        if (BlockHelper.isSoil(world.getBlockState(pos.down()))) {
          world.setBlockState(pos, BlocksCore.FLINT.getDefaultState());
        }
      }
    }
  }
