...
public class TESRBellows extends TESRBase<TEBellows> {
    ...
    @Override
    public boolean isGlobalRenderer(@Nonnull TEBellows te) {
        return false;
    }

    private void drawMiddle(BufferBuilder b, double y) {
        double[][] sides = TESRBase.getVerticesBySide(0.125, 0.875, y, 0.875, 0.125, 0.125, "xy");
    ...
    private void drawTop(BufferBuilder b, double y) {
        double[][] sides = TESRBase.getVerticesBySide(0, 1, 0.125 + y, 1, 0, y, "xy");
        double[][] tops = TESRBase.getVerticesBySide(0, 1, 0.125 + y, 1, 0, y, "z");
