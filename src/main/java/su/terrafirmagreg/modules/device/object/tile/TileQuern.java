...
public class TileQuern extends TEInventory implements ITickable {
  ...
  public ItemStack insertOrSwapItem(int slot, ItemStack playerStack) {
    ...
    if (quernStack.isEmpty() || (playerStack.isStackable() && quernStack.isStackable() && quernStack.getItem() == playerStack.getItem() && (
      !playerStack.getHasSubtypes() || playerStack.getMetadata() == quernStack.getMetadata()) && ItemStack.areItemStackTagsEqual(playerStack, quernStack))) {
