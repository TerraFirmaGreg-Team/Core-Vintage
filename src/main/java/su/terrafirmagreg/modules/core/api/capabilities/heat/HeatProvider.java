 ...
 */
public class HeatProvider implements ICapabilitySerializable<NBTTagCompound>, IHeatCapability {
	 ...
	 */
	public HeatProvider(@Nullable NBTTagCompound nbt, float heatCapacity, float meltTemp) {
	...
	public HeatProvider() {} // This is here so you can do a custom implementation
	...
	public float getTemperature() {
		return HeatCapability.adjustTemp(temperature, heatCapacity, CalendarTFC.PLAYER_TIME.getTicks() - lastUpdateTick);
	}
	...
	public boolean hasCapability(@NotNull Capability<?> capability, @Nullable EnumFacing facing) {
		return capability == HeatCapability.HEAT_CAPABILITY;
	}
