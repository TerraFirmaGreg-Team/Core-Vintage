...
public class TESRPitKiln extends TileEntitySpecialRenderer<TEPitKiln> {
    private static final ResourceLocation THATCH = TerraFirmaGreg.getID("textures/blocks/thatch.png");
    private static final ResourceLocation BARK = TerraFirmaGreg.getID("textures/blocks/wood/log/oak.png");
