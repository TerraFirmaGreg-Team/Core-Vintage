...
public class SCPacketSimpleMessage implements IMessage, IMessageHandler<SCPacketSimpleMessage, IMessage> {
	 ...
	 */
	public static SCPacketSimpleMessage translateMessage(MessageCategory category, String unlocalized, Object... args) {
