...
import net.dries007.tfcflorae.objects.items.ceramics.ItemUnfiredUrn;
import net.dries007.tfcflorae.objects.items.food.ItemFoodTFCF;
import net.dries007.tfcflorae.objects.items.food.ItemSandwichTFCF;
import net.dries007.tfcflorae.objects.items.food.PotionEffectToHave;
import net.dries007.tfcflorae.objects.items.rock.ItemFiredMudBrick;
import net.dries007.tfcflorae.objects.items.rock.ItemMud;
import net.dries007.tfcflorae.objects.items.rock.ItemUnfiredMudBrick;
import net.dries007.tfcflorae.objects.items.tools.ItemAxeTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemBowTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemHammerTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemHoeTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemJavelinTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemKnifeTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemShovelTFCF;
import net.dries007.tfcflorae.objects.items.tools.ItemWalkingStick;
...
import net.dries007.tfcflorae.util.agriculture.FruitsTFCF;
...
public final class ItemsTFCF {
  ...
  public static void registerItems(RegistryEvent.Register<Item> event) {
    ...
    for (BlockLogTFCF log : BlocksTFCF.getAllNormalTreeLog()) {simpleItems.add(register(r, log.getRegistryName().getPath(), new ItemBlockTFC(log), CT_WOOD));}
    ...
    simpleItems.add(register(r, "tools/flint/hammer_head/flint", new ItemMiscTFCF(Size.SMALL, Weight.LIGHT, "flint_head", "flint_head_hammer"), CT_ROCK));
    simpleItems.add(register(r, "tools/flint/hoe_head/flint", new ItemMiscTFCF(Size.SMALL, Weight.LIGHT, "flint_head", "flint_head_hoe"), CT_ROCK));
    simpleItems.add(register(r, "tools/flint/javelin_head/flint", new ItemMiscTFCF(Size.SMALL, Weight.LIGHT, "flint_head", "flint_head_javelin"), CT_ROCK));
    simpleItems.add(register(r, "tools/flint/knife_head/flint", new ItemMiscTFCF(Size.SMALL, Weight.LIGHT, "flint_head", "flint_head_knife"), CT_ROCK));
    simpleItems.add(register(r, "tools/flint/shovel_head/flint", new ItemMiscTFCF(Size.SMALL, Weight.LIGHT, "flint_head", "flint_head_shovel"), CT_ROCK));
  ...
  private static <T extends Item> T register(IForgeRegistry<Item> r, String name, T item, CreativeTabs ct) {
    item.setRegistryName(TFCF, name);
    item.setTranslationKey(TFCF + "." + name.replace('/', '.'));
