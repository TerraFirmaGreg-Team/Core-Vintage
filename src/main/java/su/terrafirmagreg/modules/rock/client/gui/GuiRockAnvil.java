...
public class GuiRockAnvil
    ...
    public GuiRockAnvil(Container container, InventoryPlayer playerInv, TileRockAnvil tile) {
        ...
        this.inputStack = cap == null ? ItemStack.EMPTY : cap.getStackInSlot(TileRockAnvil.SLOT_INPUT_1);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button instanceof GuiButtonAnvilPlanIcon) {
            ...
            ModuleMetal.getPacketService().sendToServer(new CSPacketGuiButton(button.id, new NBTBuilder().setString("recipe", recipeName.toString())
                    .build()));
