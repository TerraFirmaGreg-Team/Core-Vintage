...
public class TileEntityGrindstone extends TileEntityHPHorseBase {
  ...
  public void setInventorySlotContents(int index, ItemStack stack) {
    ...
    if ((index == 1 || index == 2) && getStackInSlot(1).isEmpty() && getStackInSlot(2).isEmpty()) {BlockGrindstone.setState(false, world, pos);}
  ...
  public void markDirty() {
    if (getStackInSlot(1).isEmpty() && getStackInSlot(2).isEmpty()) {BlockGrindstone.setState(false, world, pos);}
