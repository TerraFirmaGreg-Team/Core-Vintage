...
public class BlockWoodLoom extends BlockContainer implements IItemSizeAndWeight, IWoodBlock {
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return switch (state.getValue(BlockHorizontal.FACING)) {
            ...
            case EnumFacing.SOUTH -> LOOM_SOUTH_AABB;
            case EnumFacing.WEST -> LOOM_WEST_AABB;
            case EnumFacing.EAST -> LOOM_EAST_AABB;
        };
    }
