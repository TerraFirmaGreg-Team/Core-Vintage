...
/**
 * Extends vanilla AI to add a bit more in-depth to predators Additions: - Day / Night hunting behaviors (Attack on one and only when provoked otherwise) - Attack Reach - Hunting Area via {@link EntityCreature#setHomePosAndDistance}
 */
public class EntityAnimalAIAttackMelee<T extends EntityCreature & IAnimal> extends EntityAIAttackMelee {
  ...
  public EntityAnimalAIAttackMelee(T creature, double speed, double attackReach, AttackBehavior attackBehavior) {
  ...
  /**
   * Sets a wander AI to immediately move this AI to inside it's hunting area after it stops hunting a creature (This is to make it not weird- The creature stopped in its tracks and is just looking at your face)
   *
   * @param wander the Wander AI
   * @return this object for convenience, to be used in the initialization process of creatures
   */
  public EntityAnimalAIAttackMelee<T> setWanderAI(EntityAIWander wander) {
    this.wander = wander;
    return this;
  }
