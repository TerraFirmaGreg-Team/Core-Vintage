...
public class Vein {
    ...
    /**
     * Create a dummy vein from chunk data. Note: this is NOT an exact copy - it should ONLY be used to check equality, as it will not actually
     * generate the vein
     *
    ...
    /**
     * Checks if a position is within the horizontal range of a vein spawning The full area is a circle of radius width, centered on the veins
     * position
     *
