...
public abstract class ItemFlask extends ItemFluidContainer implements IItemSize {
	...
	public ICapabilityProvider initCapabilities(@Nonnull ItemStack stack, @Nullable NBTTagCompound nbt) {
		return new FlaskFluidHandler(stack, CAPACITY, FluidsTFC.getAllWrappers()
		                                                       .stream()
	...
	public void initModel(Item item, int meta, String id) {
		ModelResourceLocation modelFull = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id, "inventory");
		ModelResourceLocation model4 = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id + "-4", "inventory");
		ModelResourceLocation model3 = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id + "-3", "inventory");
		ModelResourceLocation model2 = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id + "-2", "inventory");
		ModelResourceLocation model1 = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id + "-1", "inventory");
		ModelResourceLocation model0 = new ModelResourceLocation(MODID_WATERFLASKS + ":" + id + "-0", "inventory");
	...
	public String getItemStackDisplayName(@Nonnull ItemStack stack) {
		...
		if (bucketCap != null) {
			...
			if (fluidStack != null) {
				...
				return new TextComponentTranslation("item." + MODID_WATERFLASKS + ".filled_" + name + ".name", fluidname).getFormattedText();
			}
		}
