...
public class BlockWoodToolRack extends BlockWood implements IItemSizeAndWeight {
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return switch (state.getValue(BlockHorizontal.FACING)) {
            ...
            case EnumFacing.SOUTH -> RACK_SOUTH_AABB;
            case EnumFacing.WEST -> RACK_WEST_AABB;
            case EnumFacing.EAST -> RACK_EAST_AABB;
        };
    }
