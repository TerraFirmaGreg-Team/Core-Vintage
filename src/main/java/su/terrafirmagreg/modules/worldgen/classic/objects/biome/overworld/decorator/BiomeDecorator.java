package su.terrafirmagreg.modules.worldgen.classic.objects.biome.overworld.decorator;
...
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorSand;
...
public class BiomeDecorator extends BaseBiomeDecorator {
  ...
  public BiomeDecorator(int lilyPadPerChunk, int waterPlantsPerChunk) {
