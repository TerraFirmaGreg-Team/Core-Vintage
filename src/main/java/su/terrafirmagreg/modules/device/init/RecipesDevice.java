...
public final class RecipesDevice {
    ...
    private static void quernRecipes(IQuernRecipeManager manager) {
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.BUTTERFLY_MILKWEED))),
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.TULIP_ORANGE))),
                new ItemStack(Items.DYE, 1, EnumDyeColor.ORANGE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.WATER_CANNA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.ORANGE.getDyeDamage()));

        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.ATHYRIUM_FERN))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.MAGENTA.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.MORNING_GLORY))),
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.LABRADOR_TEA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.LIGHT_BLUE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.SAPPHIRE_TOWER))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.LIGHT_BLUE.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.MEADS_MILKWEED))),
                new ItemStack(Items.DYE, 1, EnumDyeColor.YELLOW.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.GOLDENROD))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.YELLOW.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.SNAPDRAGON_YELLOW))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.YELLOW.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.SACRED_DATURA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.SNAPDRAGON_PINK))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.BLACK_ORCHID))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PURPLE.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.BARREL_CACTUS))),
                new ItemStack(Items.DYE, 4, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.REINDEER_LICHEN))),
                new ItemStack(Items.DYE, 4, EnumDyeColor.GREEN.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.SNAPDRAGON_RED))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(DefaultPlants.TROPICAL_MILKWEED))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of("pearlBlack"), new ItemStack(ItemPowder.get(Powder.BLACK_PEARL)));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.DEVILS_TONGUE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.BROMELIA_HEMISPHERICA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.MAGENTA.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.BROMELIA_LACINIOSA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CORD_GRASS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.REED_MANNAGRASS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.PRAIRIE_JUNEGRASS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CINNAMON_FERN))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.JAPANESE_PIERIS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.UNDERGROWTH_SHRUB))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.UNDERGROWTH_SHRUB_SMALL))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MADEIRA_VINE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MYSORE_TRUMPETVINE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.SILVERVEIN_CREEPER))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.SWEDISH_IVY))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.VARIEGATED_PERSIAN_IVY))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CLIMBING_CACTUS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CRIMSON_CATTLEYA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PURPLE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CREEPING_MISTLETOE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.ORANGE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.CUTHBERTS_DENDROBIUM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.ORANGE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.FISH_BONE_CACTUS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.MAGENTA.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.FRAGRANT_FERN))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.HARLEQUIN_MISTLETOE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.ORANGE.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.LANTERN_OF_THE_FOREST))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.LARGE_FOOT_DENDROBIUM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.SULPHUR_SHELF))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.ORANGE.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.TAMPA_BUTTERFLY_ORCHID))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.YELLOW.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.WILDFIRE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.BELL_TREE_DAHLIA))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.BIG_LEAF_PALM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.DRAKENSBERG_CYCAD))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.DWARF_SUGAR_PALM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.GIANT_CANE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.GIANT_ELEPHANT_EAR))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.GIANT_FEATHER_GRASS))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MADAGASCAR_OCOTILLO))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MALAGASY_TREE_ALOE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MOUNTAIN_CABBAGE_TREE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.PYGMY_DATE_PALM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.QUEEN_SAGO))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.RED_SEALING_WAX_PALM))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.RED.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.SUMMER_ASPHODEL))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.PINK.getDyeDamage()));
        ...
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MARIGOLD))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.YELLOW.getDyeDamage()));
        manager.addRecipe(IIngredient.of(BlockPlantTFC.get(PLANTS.getValue(PlantsTFCF.MONSTERA_EPIPHYTE))),
                new ItemStack(Items.DYE, 2, EnumDyeColor.GREEN.getDyeDamage()));
