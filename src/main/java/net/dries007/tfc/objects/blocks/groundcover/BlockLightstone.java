...
public class BlockLightstone extends BlockBush implements ICapabilitySize {
  ...
  public BlockLightstone(float lightLevel) {
    ...
    net.dries007.tfc.util.OreDictionaryHelper.register(this, "ore", "yooperlite");
  ...
  private boolean canPlaceAt(World worldIn, BlockPos pos, EnumFacing facing) {
    ...
    return blockfaceshape == BlockFaceShape.SOLID || BlocksTFC.isGround(iblockstate) || BlocksTFCF.isGround(iblockstate) || worldIn.getBlockState(blockpos)
      .isFullBlock();
  }
