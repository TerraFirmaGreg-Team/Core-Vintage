...
import su.terrafirmagreg.api.base.network.packet.spi.BasePacketTile;
 ...
 */
public class SCPacketLatexExtractor extends BasePacketTile<TileLatexExtractor> implements INetworkPacket.Client {
