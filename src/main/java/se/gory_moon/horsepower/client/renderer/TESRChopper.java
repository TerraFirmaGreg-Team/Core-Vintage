...
public class TESRChopper extends TESRHPBase<TileChopper> {

  @Override
  public void render(TileChopper tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
