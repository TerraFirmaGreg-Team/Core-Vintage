...
public class BlockTypesTFCF extends IForgeRegistryEntry.Impl<BlockTypesTFCF> {
    ...
    public BlockTypesTFCF(@NotNull ResourceLocation name, @NotNull RockCategory rockCategory, boolean isFluxStone, boolean isNaturallyGenerating) {
        ...
        this.textureLocation = new ResourceLocation(MODID_TFCF, "textures/blocks/stonetypes/raw/" + name.getPath() + ".png");
        ...
        public boolean shouldRockify() {
            return switch (this) {
                case MOSSY_RAW, MUD_BRICKS, MUD, PODZOL, SPARSE_GRASS, COARSE_DIRT, CLAY_PODZOL, DRY_CLAY_GRASS, SPARSE_CLAY_GRASS, COARSE_CLAY,
                     ...
                     SPARSE_KAOLINITE_CLAY_GRASS, COARSE_KAOLINITE_CLAY, STONEWARE_CLAY, STONEWARE_CLAY_GRASS, STONEWARE_CLAY_PODZOL,
                     DRY_STONEWARE_CLAY_GRASS,
