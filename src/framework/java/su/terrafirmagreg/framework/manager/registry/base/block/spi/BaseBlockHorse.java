package su.terrafirmagreg.framework.manager.registry.base.block.spi;//package su.terrafirmagreg.api.base.object.block.spi;
//
//import su.terrafirmagreg.api.base.object.tile.spi.BaseTileHorse;
//import su.terrafirmagreg.api.helper.EntityHelper;
...
//    getSettings()
//      .nonFullCube()
/// /      .size(Size.LARGE) /      .weight(Weight.HEAVY)
//      .nonOpaque();
//  }
//
...
//    return EntityHelper.getCreatureClasses();
//  }
//
//  @Override
