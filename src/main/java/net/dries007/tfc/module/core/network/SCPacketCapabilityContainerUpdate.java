...
public class SCPacketCapabilityContainerUpdate implements IMessage, IMessageHandler<SCPacketCapabilityContainerUpdate, IMessage> {
    private final TIntObjectMap<NBTTagCompound> capabilityData = new TIntObjectHashMap<>();
    private int windowID;

    @SuppressWarnings("unused")
    public SCPacketCapabilityContainerUpdate() {
    }

    public SCPacketCapabilityContainerUpdate(int windowID, int slotID, ItemStack stack) {
    ...
    public SCPacketCapabilityContainerUpdate(int windowID, NonNullList<ItemStack> items) {
        this.windowID = windowID;
    ...
    @Override
    public IMessage onMessage(final SCPacketCapabilityContainerUpdate message, final MessageContext ctx) {
