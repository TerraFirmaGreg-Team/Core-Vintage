...
public class BlockVanillaIce extends BlockIce implements ITemperatureBlock, IItemProvider {
    private final Fluid waterFluid;
    private final float meltThreshold;

    public BlockVanillaIce(Fluid waterFluid) {
        this.waterFluid = waterFluid;
        this.meltThreshold = IceMeltHandler.ICE_MELT_THRESHOLD;
