...
public final class StackUtils {
    ...
    public static boolean areStacksSameMeta(@NotNull ItemStack first, @NotNull ItemStack second) {
        ...
        return first.getMetadata() == second.getMetadata() || first.getMetadata() == OreDictionary.WILDCARD_VALUE ||
    ...
    public static boolean areStacksEqual(ItemStack firstStack, ItemStack secondStack, boolean checkNBT) {
        ...
        if (firstItem == secondItem) {
            ...
            return firstStack.getItemDamage() == OreDictionary.WILDCARD_VALUE || secondStack.getItemDamage() == OreDictionary.WILDCARD_VALUE ||
