...
public final class PlayerDataOverlay {
    ...
    public void render(RenderGameOverlayEvent.Pre event) {
        ...
        GuiIngameForge.renderExperiance = ConfigTFC.Client.DISPLAY.useVanillaHealth &&
                ConfigTFC.Client.DISPLAY.hideThirstBar; // Since it's below both, makes sense needing both enabled
        ...
        if (mc.playerController.gameIsSurvivalOrAdventure()) {
            ...
            if (!ConfigTFC.Client.DISPLAY.useVanillaHealth) {
                ...
                fontrenderer.drawString(healthString, mid - 45 - (fontrenderer.getStringWidth(healthString) / 2), healthRowHeight + 2,
                        Color.white.getRGB());
            }
            ...
            if (player.getRidingEntity() instanceof EntityLivingBase mount && !ConfigTFC.Client.DISPLAY.useVanillaHealth) {
                ...
                fontrenderer.drawString(mountHealthString, mid + 47 - (fontrenderer.getStringWidth(mountHealthString) / 2), armorRowHeight + 2,
                        Color.white.getRGB());
            }
