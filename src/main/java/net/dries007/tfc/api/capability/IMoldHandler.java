 ...
 * {@link net.dries007.tfc.objects.items.ceramics.ItemMold} should implement this interface on the capability object, and return this instance when
 * queried. Currently provided by: {@link net.dries007.tfc.objects.items.ceramics.ItemMold}
