...
public class EntityPigvil extends EntityCreature {
    ...
    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ItemIngot.get(Metal.PIG_IRON, Metal.ItemType.INGOT),
            TFCThingsItems.ITEM_PIG_IRON_CARROT, TFCThingsItems.ITEM_BLACK_STEEL_CARROT, TFCThingsItems.ITEM_RED_STEEL_CARROT,
