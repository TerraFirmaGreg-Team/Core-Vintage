...
public class BlockRockVariantConnectedTFCF extends BlockRockVariantFallableTFCF {
    ...
    public static void spreadGrass(World world, BlockPos pos, IBlockState us, Random rand) {
        ...
        if ((world.getLightFromNeighbors(pos.up()) < 4 && stateUp.getLightOpacity(world, pos.up()) > 2) || stateUp.getMaterial()
                .isLiquid()) {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (current.getBlock() instanceof BlockRockVariant || current.getBlock() instanceof BlockRockVariantTFCF) {
                    if ((us.getBlock() instanceof BlockRockVariant) && ((BlockRockVariant) us.getBlock()).getType() == Rock.Type.DRY_GRASS) {
                        ...
                        world.setBlockState(target, block.getVariant(block.getType()
                                        .getGrassVersion(Rock.Type.DRY_GRASS))
                                .getDefaultState());
                    } else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_GRASS) {
                        BlockRockVariantTFCF block = ((BlockRockVariantTFCF) current.getBlock());
                        world.setBlockState(target, block.getVariant(block.getType()
                                        .getGrassVersion(RockTFCF.SPARSE_GRASS))
                                .getDefaultState());
                    } else {
                        BlockRockVariant block = ((BlockRockVariant) current.getBlock());
                ...
                if (current.getBlock() instanceof BlockRockVariant || current.getBlock() instanceof BlockRockVariantTFCF) {
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_CLAY_GRASS) {
                        BlockRockVariantTFCF block = ((BlockRockVariantTFCF) current.getBlock());
                        world.setBlockState(target, block.getVariant(block.getType()
                                        .getGrassVersion(RockTFCF.DRY_CLAY_GRASS))
                                .getDefaultState());
                    } else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_CLAY_GRASS) {
                        BlockRockVariantTFCF block = ((BlockRockVariantTFCF) current.getBlock());
                        world.setBlockState(target, block.getVariant(block.getType()
                                        .getGrassVersion(RockTFCF.SPARSE_CLAY_GRASS))
                                .getDefaultState());
                    } else {
                        BlockRockVariant block = ((BlockRockVariant) current.getBlock());
                        world.setBlockState(target, block.getVariant(block.getType()
                                        .getGrassVersion(Rock.Type.CLAY_GRASS))
                                .getDefaultState());
                    }
                }
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_BOG_IRON_GRASS)
                        spreader = RockTFCF.DRY_BOG_IRON_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_BOG_IRON_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_LOAMY_SAND_GRASS)
                        spreader = RockTFCF.DRY_LOAMY_SAND_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_LOAMY_SAND_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SANDY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILT_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SILT_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILT_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILT_GRASS)
                        spreader = RockTFCF.DRY_SILT_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILT_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_HUMUS_GRASS)
                        spreader = RockTFCF.DRY_HUMUS_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_HUMUS_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SANDY_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SILTY_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_CLAY_HUMUS_GRASS)
                        spreader = RockTFCF.DRY_CLAY_HUMUS_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_CLAY_HUMUS_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_EARTHENWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SANDY_EARTHENWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_EARTHENWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_EARTHENWARE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SANDY_EARTHENWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_EARTHENWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_EARTHENWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_EARTHENWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_EARTHENWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_EARTHENWARE_CLAY_GRASS)
                        spreader = RockTFCF.EARTHENWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_EARTHENWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_EARTHENWARE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SILTY_EARTHENWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_EARTHENWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_EARTHENWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SILTY_EARTHENWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_EARTHENWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_EARTHENWARE_CLAY_HUMUS_GRASS)
                        spreader = RockTFCF.DRY_EARTHENWARE_CLAY_HUMUS_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_EARTHENWARE_CLAY_HUMUS_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_KAOLINITE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SANDY_KAOLINITE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_KAOLINITE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_KAOLINITE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SANDY_KAOLINITE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_KAOLINITE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_KAOLINITE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_KAOLINITE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_KAOLINITE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_KAOLINITE_CLAY_GRASS)
                        spreader = RockTFCF.KAOLINITE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_KAOLINITE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_KAOLINITE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SILTY_KAOLINITE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_KAOLINITE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_KAOLINITE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SILTY_KAOLINITE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_KAOLINITE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_KAOLINITE_CLAY_HUMUS_GRASS)
                        spreader = RockTFCF.DRY_KAOLINITE_CLAY_HUMUS_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_KAOLINITE_CLAY_HUMUS_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_STONEWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SANDY_STONEWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_STONEWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SANDY_STONEWARE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SANDY_STONEWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SANDY_STONEWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_STONEWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_STONEWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_STONEWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_STONEWARE_CLAY_GRASS)
                        spreader = RockTFCF.STONEWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_STONEWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_STONEWARE_CLAY_GRASS)
                        spreader = RockTFCF.DRY_SILTY_STONEWARE_CLAY_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_STONEWARE_CLAY_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_SILTY_STONEWARE_CLAY_LOAM_GRASS)
                        spreader = RockTFCF.DRY_SILTY_STONEWARE_CLAY_LOAM_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_SILTY_STONEWARE_CLAY_LOAM_GRASS)
                ...
                if (current.getBlock() instanceof BlockRockVariantTFCF) {
                    ...
                    if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.DRY_STONEWARE_CLAY_HUMUS_GRASS)
                        spreader = RockTFCF.DRY_STONEWARE_CLAY_HUMUS_GRASS;
                    else if ((us.getBlock() instanceof BlockRockVariantTFCF) &&
                            ((BlockRockVariantTFCF) us.getBlock()).getType() == RockTFCF.SPARSE_STONEWARE_CLAY_HUMUS_GRASS)
            ...
            for (Plant plant : TFCRegistries.PLANTS.getValuesCollection()) {
                if (plant.getPlantType() == Plant.PlantType.SHORT_GRASS && rand.nextFloat() < 0.5f) {
                    ...
                    if (world.isAirBlock(pos.up()) &&
                            plant.isValidLocation(temp, ChunkDataTFC.getRainfall(world, pos.up()),
