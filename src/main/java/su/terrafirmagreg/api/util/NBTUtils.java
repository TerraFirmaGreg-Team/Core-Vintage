...
public final class NBTUtils {
    ...
    /**
     * Sets an unknown data type to an NBTTagCompound. If the type of the data can not be identified, and exception will be thrown. Current supported data types include String,
    ...
    /**
     * Retrieves an array of ItemStack from an NBTTagCompound. This method is intended to be used with the NBT version of an IInventory and can be used when parsing things like
     * TileEntity NBT data.
     *
    ...
    /**
     * Provides a way to access an NBTTagCompound that is very deep within another NBTTagCompound. This will allow you to use an array of strings which represent the different
     * steps to get to the deep NBTTagCompound.
     *
     ...
     * @return NBTTagCompound: This method will return the deepest possible NBTTagCompound. In some cases, this may be the tag you provide, or only a few steps deep, rather than
     * all of the way.
     */
