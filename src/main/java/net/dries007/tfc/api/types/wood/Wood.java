...
public enum Wood implements IStringSerializable {
    ...
    HICKORY(0x4E3418, new Tree.Builder(80f, 250f, 7f, 29f)
            ...
            .build()),
    MAPLE(0xC3782F, new Tree.Builder(140f, 360f, 3f, 20f)
            .setGenerator(GEN_MEDIUM)
            .setDominance(6.3f)
            .setRadius(1)
            .setTannin()
            ...
            .build()),
    OAK(0xC29D62, new Tree.Builder(180f, 430f, -8f, 12f)
            .setGenerator(GEN_TALL)
            .setHeight(16)
            .setGrowthTime(10)
            .setTannin()
            ...
            .build()),
    PALM(0xB56F38, new Tree.Builder(280f, 500f, 16f, 35f)
            .setGenerator(GEN_TROPICAL)
            .setDecayDist(6)
            .setBurnInfo(730f, 1250)
            .build()),
    PINE(0xD1BD9A, new Tree.Builder(60f, 250f, -15f, 7f)
            ...
            .build()),
    ROSEWOOD(0x912222, new Tree.Builder(10f, 190f, 8f, 18f)
            .setGenerator(GEN_MEDIUM)
            .setHeight(12)
            .setGrowthTime(8)
    ...
    SEQUOIA(0x965B3B, new Tree.Builder(250f, 420f, -5f, 12f)
            ...
            .build()),
    SPRUCE(0xBF806F, new Tree.Builder(120f, 380f, -11f, 6f)
            .setGenerator(GEN_CONIFER)
            .setRadius(1)
            .setConifer()
            .setDensity(0.1f, 0.8f)
            ...
            .build()),
    SYCAMORE(0xDCA448, new Tree.Builder(120f, 290f, 17f, 33f)
            .setGenerator(GEN_MEDIUM)
            .setGrowthTime(8)
            .setBushes()
            .setDensity(0.25f, 2f)
