...
public class TESRFruitLoomTFCF extends TESRBase<TEFruitLoom> {
	...
	static {
		...
		for (IFruitTree fruitTree : FruitTree.values()) {
			...
			//noinspection ConstantConditions
			PLANKS_TEXTURES.put(fruitTree, new ResourceLocation(MODID_TFCF, "textures/blocks/wood/planks/" + name + ".png"));
		}
		...
		PLANKS_TEXTURES_TREE.put(TreesTFCF.CASSIA_CINNAMON_TREE, new ResourceLocation(MODID_TFCF, "textures/blocks/wood/planks/cassia_cinnamon.png"));

		PLANKS_TEXTURES_TREE.put(TreesTFCF.CEYLON_CINNAMON_TREE, new ResourceLocation(MODID_TFCF, "textures/blocks/wood/planks/ceylon_cinnamon.png"));
	}
