...
public class EntityAnimalChicken extends EntityAnimalBase implements ILivestock {
    ...
    public TextComponentTranslation getTooltip() {
        if (this.getGender() == Gender.MALE) {
            return new TextComponentTranslation(ModUtils.name(".tooltip.animal.product.male_egg"));
            ...
            return new TextComponentTranslation(ModUtils.name(".tooltip.animal.product.no_egg"), getAnimalName());
        }
        return null;
    }
