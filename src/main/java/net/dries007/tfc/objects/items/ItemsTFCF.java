  ...
  public static void registerItems(RegistryEvent.Register<Item> event) {
    ...
    for (FruitsTFCF fruit : FruitsTFCF.values()) {
      if (TFCFlorae.FirmaLifeAdded) {
        if (!fruit.isVanillaFood && fruit.canDry()) {
          ...
          OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString("dried_" + fruit.name().toLowerCase()), dried);
    ...
    if (TFCFlorae.FirmaLifeAdded) {
      for (String grain : new String[]{"amaranth", "buckwheat", "fonio", "millet", "quinoa", "spelt"}) {
        ...
        OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString(grain + "_flatbread_dough"), flatbread_dough);
    ...
    for (int i = 0; i < BlocksTFCF.bamboo.length; i++) {
      ...
      OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString("pole_" + BlocksTFCF.bamboo[i]), bambooPole);
      ...
      OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString("lumber_" + BlocksTFCF.bamboo[i]), bambooLumber);
    ...
    for (IFruitTree fruitTree : FruitTree.values()) {
      ...
      if (!TFCFlorae.FirmaLifeAdded) {
        ItemMisc pole = new ItemMisc(Size.SMALL, Weight.MEDIUM);
        simpleItems.add(register(r, "wood/fruit_tree/pole/" + name, pole, CT_WOOD));
        OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString(
          "pole_" + name.substring(0, 1).toLowerCase() + name.substring(1).toLowerCase()), pole);
      }
      ...
      simpleItems.add(register(r, "wood/fruit_tree/lumber/" + name, lumber, CT_WOOD));
      OreDictionary.registerOre(net.dries007.tfc.util.OreDictionaryHelper.toString(
        "lumber_" + name.substring(0, 1).toLowerCase() + name.substring(1).toLowerCase()), lumber);
