package su.terrafirmagreg.framework.manager.content.base.sound.api;
...
public interface ISoundEntry extends IContentEntry<SoundSettings, SoundEvent> {

  @Getter
  @NoArgsConstructor(access = AccessLevel.PROTECTED)
  class SoundSettings extends ContentSettings<SoundSettings> {
