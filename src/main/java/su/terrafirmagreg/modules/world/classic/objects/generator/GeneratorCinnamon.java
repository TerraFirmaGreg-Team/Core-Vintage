...
public class GeneratorCinnamon extends WorldGenerator {
  ...
  private boolean generateCinnamonVariant(World world, Random rand, BlockPos pos, Tree tree,
                                          ITreeGenerator CinnamonToGen) {
