...
public class BlockWaterPlantTFCF extends BlockFluidTFC implements ICapabilitySize, IPlantable {
  ...
  public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
    ...
    if (state.getBlock() == this) {
      return (soil.getBlock().canSustainPlant(soil, worldIn, pos.down(), net.minecraft.util.EnumFacing.UP, this) || BlocksTFC.isGround(soil))
  ...
  public AxisAlignedBB getSelectedBoundingBox(IBlockState state, World worldIn, BlockPos pos) {
    if (state.getBlock() instanceof BlockWaterPlantTFCF) {return state.getBoundingBox(worldIn, pos).offset(pos);}
    return null;
  }
