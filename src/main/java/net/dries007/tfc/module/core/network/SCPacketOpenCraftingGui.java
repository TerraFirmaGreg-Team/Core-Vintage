...
public class SCPacketOpenCraftingGui implements IMessageEmpty, IMessageHandler<SCPacketOpenCraftingGui, IMessage> {
    @Override
    public IMessage onMessage(SCPacketOpenCraftingGui message, MessageContext ctx) {
