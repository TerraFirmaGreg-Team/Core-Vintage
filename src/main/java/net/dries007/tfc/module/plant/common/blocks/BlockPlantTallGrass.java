...
public class BlockPlantTallGrass extends BlockPlantShortGrass implements IGrowable, ITallPlant {
    private static final PropertyEnum<BlockPlantTallGrass.EnumBlockPart> PART = PropertyEnum.create("part", BlockPlantTallGrass.EnumBlockPart.class);

    private final PlantType plant;

    public BlockPlantTallGrass(PlantEnumVariant plantBlockVariant, PlantType plant) {
