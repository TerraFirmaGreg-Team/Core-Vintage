...
public class EntityFallingBlock
    ...
    public EntityFallingBlock(World world, BlockPos pos, IBlockState fallingBlockState) {
    ...
    public void onUpdate() {
        ...
        if (!world.isRemote) {
            if (!onGround) {
                ...
                if (!current.getBlock()
                        .isAir(current, world, pos) && FallingBlockManager.canFallThrough(world, pos, material, current)) {
                ...
                if (!downState.getBlock()
                        .isAir(downState, world, downPos) && FallingBlockManager.canFallThrough(world, downPos, material, downState)) {
