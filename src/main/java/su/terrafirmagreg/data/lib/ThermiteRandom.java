...
public class ThermiteRandom extends Random {
  ...
  /**
   * Implementation of George Marsaglia's elegant Xorshift random generator 30% faster and better quality than the built-in java.util.random see also see <a
   * href="http://www.javamex.com/tutorials/random_numbers/xorshift.shtml">...</a>
   */
