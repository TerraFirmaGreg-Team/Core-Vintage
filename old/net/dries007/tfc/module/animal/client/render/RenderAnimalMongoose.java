...
import net.dries007.tfc.module.animal.objects.entities.huntable.EntityAnimalMongoose;
...
public class RenderAnimalMongoose extends RenderLiving<EntityAnimalMongoose> {
    private static final ResourceLocation TEXTURE = Helpers.getID("textures/entity/animal/huntable/mongoose.png");
