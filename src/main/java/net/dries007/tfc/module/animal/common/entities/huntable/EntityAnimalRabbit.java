package net.dries007.tfc.module.animal.common.entities.huntable;
...
public class EntityAnimalRabbit extends EntityAnimalMammal implements IHuntable {
    ...
    public EntityAnimalRabbit(World worldIn, Gender gender, int birthDay) {
        ...
        this.moveHelper = new EntityAnimalRabbit.RabbitMoveHelper(this);
    ...
    public void updateAITasks() {
        ...
        if (this.onGround) {
            ...
            EntityAnimalRabbit.RabbitJumpHelper entityrabbit$rabbitjumphelper = (EntityAnimalRabbit.RabbitJumpHelper) this.jumpHelper;
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(1, new EntityAnimalRabbit.AIPanic(this, 1.4D * speedMult));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof EntityAnimalRabbit.RabbitTypeData) {
            i = ((EntityAnimalRabbit.RabbitTypeData) livingdata).typeData;
        } else {
            livingdata = new EntityAnimalRabbit.RabbitTypeData(i);
        }
    ...
    private void enableJumpControl() {
        ((EntityAnimalRabbit.RabbitJumpHelper) this.jumpHelper).setCanJump(true);
    }

    private void disableJumpControl() {
        ((EntityAnimalRabbit.RabbitJumpHelper) this.jumpHelper).setCanJump(false);
    }
    ...
    static class RabbitMoveHelper extends EntityMoveHelper {
        ...
        public void onUpdateMoveHelper() {
            if (this.rabbit.onGround && !this.rabbit.isJumping && !((EntityAnimalRabbit.RabbitJumpHelper) this.rabbit.jumpHelper).isJumping()) {
