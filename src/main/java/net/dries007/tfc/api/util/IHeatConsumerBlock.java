...
/**
 * Implement this on blocks that accept heat from outside sources Various blocks (i.e. fire pits, forges) will try and heat blocks in specific
 * locations if they implement this interface
 */
