...
/**
 * This is a tree generator only used for the willow tree shapes. Requires two structure blocks: both found in /assets/tfc/[TREE NAME]/, named base.nbt and overlay.nbt
 * respectively. See the examples for TFC willow tree for what the structure blocks should look like.
 */
