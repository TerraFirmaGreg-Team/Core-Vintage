...
import net.dries007.tfc.module.metal.api.types.variant.block.MetalBlockVariantHandler;
...
public class ModuleMetal extends ModuleBase {
    ...
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleMetal.class.getSimpleName());

    public ModuleMetal() {
        super(0, Tags.MOD_ID);

        this.setRegistry(new Registry(Tags.MOD_ID, METAL_TAB));
