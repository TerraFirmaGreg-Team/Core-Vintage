...
public class HorsePowerPlugin implements IModPlugin {
  ...
  public void registerCategories(IRecipeCategoryRegistration registry) {
    ...
    if (Configs.general.enableHandChoppingBlock) {registry.addRecipeCategories(new HPManualChoppingCategory(registry.getJeiHelpers().getGuiHelper()));}
  ...
  public void register(IModRegistry registry) {
    ...
    if (Configs.general.enableHandChoppingBlock) {
      ...
      } else {registry.addRecipes(ChoppingRecipeMaker.getChoppingRecipes(jeiHelpers, true, false), MANUAL_CHOPPING);}
    }
    ...
    if (Configs.recipes.useSeperateGrindstoneRecipes) {registry.addRecipeCatalyst(new ItemStack(ModBlocks.BLOCK_HAND_GRINDSTONE), HAND_GRINDING);} else {
