package su.terrafirmagreg.modules.animal.content.entity;

import su.terrafirmagreg.framework.manager.content.base.entity.spi.BaseEntityAnimal;
...
import su.terrafirmagreg.modules.animal.content.entity.ai.EntityAnimalAIEasyBreeding;
import su.terrafirmagreg.modules.animal.content.entity.ai.EntityAnimalAIPanic;
import su.terrafirmagreg.modules.animal.content.entity.ai.EntityAnimalAITamableAvoidPlayer;
...
public abstract class EntityAnimalBase extends BaseEntityAnimal implements IAnimal {
  ...
  /**
   * Eat food + raises familiarization If your animal would refuse to eat said stack (because rotten or anything), return false here This function is called after every other check is made (animal is hungry for the day + this is a valid
   * food)
   *
