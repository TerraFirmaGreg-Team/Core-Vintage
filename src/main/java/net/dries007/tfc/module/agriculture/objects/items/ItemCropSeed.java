package net.dries007.tfc.module.agriculture.objects.items;
...
public class ItemCropSeed extends Item implements IPlantable, ICropItem {
    ...
    private final CropItemVariant variant;
    ...
    @Nonnull
    @Override
    public CropItemVariant getItemVariant() {
        return variant;
    }
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        ...
        return StorageAgriculture.getCropBlock(GROWING, type).getDefaultState();
    }
