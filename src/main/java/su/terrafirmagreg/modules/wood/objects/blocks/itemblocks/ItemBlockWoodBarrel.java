package su.terrafirmagreg.modules.wood.objects.blocks.itemblocks;
...
/**
 * Item block for {@link BlockWoodBarrel}
        ...
        if (barrelCap instanceof ItemBarrelFluidHandler && ((ItemBarrelFluidHandler) barrelCap).getBarrelContents() != null) // Have either fluid or items stored
        {
            ...
            if (fluidStack == null || fluidStack.amount == 0) {
                if (inventory.isEmpty()) {
                    ...
                    tooltip.add(TextFormatting.BLUE + I18n.format(Tags.MOD_ID + ".tooltip.barrel_item", inventory.getCount(), inventory.getItem()
                ...
                if (!inventory.isEmpty()) {
                    tooltip.add(TextFormatting.BLUE + I18n.format(Tags.MOD_ID + ".tooltip.barrel_item_in_fluid", inventory.getCount(), inventory.getItem()
                            .getItemStackDisplayName(inventory)));
                }
            }
