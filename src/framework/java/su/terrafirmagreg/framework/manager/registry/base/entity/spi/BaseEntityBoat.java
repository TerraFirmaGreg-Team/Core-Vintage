...
public abstract class BaseEntityBoat extends EntityBoat {

  public BaseEntityBoat(World worldIn) {
    super(worldIn);
  }

  public BaseEntityBoat(World worldIn, double x, double y, double z) {
    super(worldIn, x, y, z);
  }
