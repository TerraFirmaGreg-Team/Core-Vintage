...
public class ModuleCoreOld extends ModuleBase {

    public static final CreativeTabs MISC_TAB = new CreativeTabBase("misc", "tfc:wand");
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleCoreOld.class.getSimpleName());

    public static IPacketService PACKET_SERVICE;
    public static ITileDataService TILE_DATA_SERVICE;

    public ModuleCoreOld() {
        super(0, Tags.MOD_ID);

        this.setRegistry(new Registry(Tags.MOD_ID, MISC_TAB));
        ...
        if (event.getSide().isServer()) {
            ...
            if (server instanceof DedicatedServer) {
                ...
                if (ConfigTFC.General.OVERRIDES.forceTFCWorldType) {
                    ...
                    ModuleCoreOld.LOGGER.info("Setting default level-type to `tfc_classic`");
