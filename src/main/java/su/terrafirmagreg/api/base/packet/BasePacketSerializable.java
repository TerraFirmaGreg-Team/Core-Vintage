...
public abstract class BasePacketSerializable<REQ extends BasePacketSerializable> implements Serializable, IMessage, IMessageHandler<REQ, IMessage> {
    ...
    static {
        ...
        addIOHandler(short.class, BasePacketSerializable::readShort, BasePacketSerializable::writeShort);
        ...
        addIOHandler(float.class, BasePacketSerializable::readFloat, BasePacketSerializable::writeFloat);
        addIOHandler(double.class, BasePacketSerializable::readDouble, BasePacketSerializable::writeDouble);
        addIOHandler(boolean.class, BasePacketSerializable::readBoolean, BasePacketSerializable::writeBoolean);
        addIOHandler(char.class, BasePacketSerializable::readChar, BasePacketSerializable::writeChar);

        // Primitive Arrays
        addIOHandler(byte[].class, BasePacketSerializable::readByteArray, BasePacketSerializable::writeByteArray);
        addIOHandler(short[].class, BasePacketSerializable::readShortArray, BasePacketSerializable::writeShortArray);
        addIOHandler(int[].class, BasePacketSerializable::readIntArray, BasePacketSerializable::writeIntArray);
        addIOHandler(long[].class, BasePacketSerializable::readLongArray, BasePacketSerializable::writeLongArray);
        addIOHandler(float[].class, BasePacketSerializable::readFloatArray, BasePacketSerializable::writeFloatArray);
        addIOHandler(double[].class, BasePacketSerializable::readDoubleArray, BasePacketSerializable::writeDoubleArray);
        addIOHandler(boolean[].class, BasePacketSerializable::readBooleanArray, BasePacketSerializable::writeBooleanArray);
        addIOHandler(char[].class, BasePacketSerializable::readCharArray, BasePacketSerializable::writeCharArray);

        // Objects
        addIOHandler(String.class, BasePacketSerializable::readString, BasePacketSerializable::writeString);
        addIOHandler(NBTTagCompound.class, BasePacketSerializable::readNBT, BasePacketSerializable::writeNBT);
        addIOHandler(ItemStack.class, BasePacketSerializable::readItemStack, BasePacketSerializable::writeItemStack);
        addIOHandler(BlockPos.class, BasePacketSerializable::readBlockPos, BasePacketSerializable::writeBlockPos);
        addIOHandler(IBlockState.class, BasePacketSerializable::readState, BasePacketSerializable::writeState);
        addIOHandler(ResourceLocation.class, BasePacketSerializable::readResourceLocation, BasePacketSerializable::writeResourceLocation);
        addIOHandler(EnchantmentData.class, BasePacketSerializable::readEnchantmentData, BasePacketSerializable::writeEnchantmentData);

        // Object Arrays
        addIOHandler(String[].class, BasePacketSerializable::readStringArray, BasePacketSerializable::writeStringArray);
        addIOHandler(NBTTagCompound[].class, BasePacketSerializable::readNBTArray, BasePacketSerializable::writeNBTArray);
        addIOHandler(ItemStack[].class, BasePacketSerializable::readItemStackArray, BasePacketSerializable::writeItemStackArray);
        addIOHandler(BlockPos[].class, BasePacketSerializable::readBlockPosArray, BasePacketSerializable::writeBlockPosArray);
        addIOHandler(IBlockState[].class, BasePacketSerializable::readStateArray, BasePacketSerializable::writeStateArray);
        addIOHandler(ResourceLocation[].class, BasePacketSerializable::readResourceLocationArray, BasePacketSerializable::writeResourceLocationArray);
        addIOHandler(EnchantmentData[].class, BasePacketSerializable::readEnchantmentDataArray, BasePacketSerializable::writeEnchantmentDataArray);
    }
