...
public final class ClientRegisterEvents {
  ...
  public static void registerModels(ModelRegistryEvent event) {
    ...
    ModelLoader.setCustomStateMapper(BlocksTFC.PLACED_HIDE, blockIn -> ImmutableMap.of(BlocksTFC.PLACED_HIDE.getDefaultState()
      .withProperty(SIZE, EnumHideSize.SMALL), empty, BlocksTFC.PLACED_HIDE.getDefaultState()
      .withProperty(SIZE, EnumHideSize.MEDIUM), empty, BlocksTFC.PLACED_HIDE.getDefaultState()
      .withProperty(SIZE, EnumHideSize.LARGE), empty));
