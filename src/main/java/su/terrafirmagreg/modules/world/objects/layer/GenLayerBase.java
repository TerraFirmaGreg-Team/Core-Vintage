...
import su.terrafirmagreg.modules.world.objects.layer.biome.GenLayerBiomeEdge;
import su.terrafirmagreg.modules.world.objects.layer.biome.GenLayerDeepOcean;
import su.terrafirmagreg.modules.world.objects.layer.biome.GenLayerIsland;
import su.terrafirmagreg.modules.world.objects.layer.biome.GenLayerLakes;
import su.terrafirmagreg.modules.world.objects.layer.biome.GenLayerShore;
import su.terrafirmagreg.modules.world.objects.layer.datalayers.rock.GenLayerRockInit;
import su.terrafirmagreg.modules.world.objects.layer.datalayers.stability.GenLayerStabilityInit;
import su.terrafirmagreg.modules.world.objects.layer.river.GenLayerRiver;
import su.terrafirmagreg.modules.world.objects.layer.river.GenLayerRiverInit;
import su.terrafirmagreg.modules.world.objects.layer.river.GenLayerRiverMix;
...
public abstract class GenLayerBase extends GenLayer {
    ...
    public static GenLayerBase initializeRock(long seed, RockCategory.Layer level, int rockLayerSize) {
    ...
    public static void drawImageBiomes(int size, GenLayerBase genlayer, String name) {
        Function<Biome, Color> colorize = (x) -> x instanceof BaseBiome baseBiome ? baseBiome.getSettings().getDebugColour() : Color.BLACK;
