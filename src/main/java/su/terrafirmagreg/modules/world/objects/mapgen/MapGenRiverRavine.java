...
import static su.terrafirmagreg.modules.world.classic.ChunkGenClassic.*;
...
public class MapGenRiverRavine extends MapGenBase {
    ...
    protected void generateRavine(long seed, int chunkX, int chunkZ, ChunkPrimer primer, double startX, double startY, double startZ, float angleX,
        ...
        for (int round = 0; round < rounds; round++) {
            ...
            if (!(startX >= worldX - 16.0D - min * 2.0D) || !(startZ >= worldZ - 16.0D - min * 2.0D) || !(startX <= worldX + 16.0D + min * 2.0D) ||
