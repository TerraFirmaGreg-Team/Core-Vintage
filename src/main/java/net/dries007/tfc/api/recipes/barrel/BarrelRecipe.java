...
public class BarrelRecipe extends IForgeRegistryEntry.Impl<BarrelRecipe> {
    ...
    @Nullable public static BarrelRecipe get(ItemStack stack, FluidStack fluidStack) {
    ...
    @Nullable public static BarrelRecipe getInstant(ItemStack stack, FluidStack fluidStack) {
        return TFCRegistries.BARREL.getValuesCollection().stream().filter(x -> x.isValidInput(fluidStack, stack) && x.getDuration() == 0).findFirst().orElse(null);
    }
     ...
     */
    @Nullable public FluidStack getOutputFluid() {
    ...
    @Nullable public FluidStack getOutputFluid(FluidStack inputFluid, ItemStack inputStack) {
     ...
     */
    @Nullable public FluidStack getOutputFluidOnUnseal(FluidStack inputFluid, ItemStack inputStack) {
        return inputFluid;
    }
