package su.terrafirmagreg.tfg.modules.core;
...
import su.terrafirmagreg.tfg.modules.core.api.util.BaseCreativeTab;
import su.terrafirmagreg.tfg.modules.core.init.BlocksCore;
import su.terrafirmagreg.tfg.modules.core.init.ItemsCore;

import static su.terrafirmagreg.tfg.Tags.MOD_ID;
import static su.terrafirmagreg.tfg.Tags.MOD_NAME;

public class ModuleCore extends ModuleBase {

    public static final BaseCreativeTab MISC_TAB = new BaseCreativeTab("misc", "tfg:wand");
