...
import net.dries007.tfc.module.core.common.objects.entity.animal.EntityBlackBearTFC;
...
public class ModelBlackBearTFC extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        float f1 = ((EntityBlackBearTFC) entityIn).getStandingAnimationScale(ageInTicks);
        f1 *= f1;
        float f2 = 1.0F - f1;
