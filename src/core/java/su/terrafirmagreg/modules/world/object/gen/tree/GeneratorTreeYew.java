...
public class GeneratorTreeYew extends BaseGeneratorTree {


  public GeneratorTreeYew() {
    super(Builder.builder()
      ...
      .cellKit("deciduous")
      .log(() -> BlocksWood.LOG.get(WoodTypes.YEW).getDefaultState().withProperty(PLACED, false))
      .leaves(() -> BlocksWood.LEAVES.get(WoodTypes.YEW).getDefaultState())
