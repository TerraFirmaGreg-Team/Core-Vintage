...
public class RenderAnimalPheasant extends RenderLiving<EntityAnimalPheasant> {
    ...
    private static final ResourceLocation CHICK_TEXTURE = ModUtils.resource("textures/entity/animal/huntable/pheasant_chick.png");
    private static final ResourceLocation MALE_TEXTURE = ModUtils.resource("textures/entity/animal/huntable/pheasant_male.png");
    private static final ResourceLocation FEMALE_TEXTURE = ModUtils.resource("textures/entity/animal/huntable/pheasant_female.png");
