package net.dries007.eerussianguy.firmalife;
...
public class ConfigFL {
  ...
  @Config(modid = MODID_FL, category = "general", name = "Firmalife -- General")
  @Config.LangKey("config." + MODID_FL + ".general")
  public static final class General {

    @Config.Comment("Worldgen Settings")
    @Config.LangKey("config." + MODID_FL + ".general.worldgen")
    public static final WorldgenCFG WORLDGEN = new WorldgenCFG();
    @Config.Comment("Compatibility Settings")
    @Config.LangKey("config." + MODID_FL + ".general.compat")
    public static final CompatCFG COMPAT = new CompatCFG();
    @Config.Comment("Balance Settings")
    @Config.LangKey("config." + MODID_FL + ".general.balance")
    ...
    public static final class WorldgenCFG {
      ...
      @Config.LangKey("config." + MODID_FL + ".general.worldgen.cinnamonRarity")
      ...
      @Config.RangeInt(min = 0)
      @Config.LangKey("config." + MODID_FL + ".general.worldgen.beeRarity")
    ...
    public static final class BalanceCFG {
      ...
      @Config.LangKey("config." + MODID_FL + "general.balance.cheeseTimeToVintage")
