...
import net.dries007.tfc.common.objects.inventory.ingredient.IngredientItemFoodTrait;
...
public class BarrelRecipeFoodPreservation extends BarrelRecipe {
    ...
    public BarrelRecipeFoodPreservation(String name, @Nonnull IIngredient<FluidStack> inputFluid, @Nonnull IIngredient<ItemStack> inputStack, FoodTrait trait, String tooltipName) {
        super(name, inputFluid, inputStack, null, ItemStack.EMPTY, -1);
        this.trait = trait;
        this.tooltipName = tooltipName;
    }

    public static BarrelRecipe vinegar(String name, @Nonnull IIngredient<ItemStack> inputStack) {
        return new BarrelRecipeFoodPreservation(name, IIngredient.of(FluidRegistry.getFluid("vinegar"), 125), new IngredientItemFoodTrait(inputStack, FoodTrait.PICKLED), FoodTrait.VINEGAR, "barrel_recipe_vinegar");
    }
