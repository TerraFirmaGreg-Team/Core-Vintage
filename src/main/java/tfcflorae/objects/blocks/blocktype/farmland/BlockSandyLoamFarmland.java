...
public class BlockSandyLoamFarmland extends FarmlandTFCF {
	...
	public BlockSandyLoamFarmland(RockTFCF rockTFCF, Rock rock) {
		...
		OreDictionaryHelper.register(this, "farmland", "sandy", "loam");
	}
	...
	private void turnToDirt(World world, BlockPos pos) {
		world.setBlockState(pos, get(rock, RockTFCF.SANDY_LOAM).getDefaultState());
