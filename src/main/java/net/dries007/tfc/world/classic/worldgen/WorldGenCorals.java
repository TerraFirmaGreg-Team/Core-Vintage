    ...
    private void generateCoral(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        for (int i = 0; i < (coralsInChunk) * 5; i++) {
            ...
            if ((b == BiomesTFC.OCEAN || b == BiomesTFC.DEEP_OCEAN || b == BiomesTFC.BEACH || b == BiomesTFC.GRAVEL_BEACH) &&
                ...
                if (isValidPosition(world, pos) && pos.getY() < WorldTypeTFC.SEALEVEL - 1 && pos.getY() > 119 && floraDensity >= 0.4f &&
        ...
        for (int i = 0; i < (coralsInChunk) * 100; i++) {
            ...
            if ((b == BiomesTFC.OCEAN || b == BiomesTFC.DEEP_OCEAN || b == BiomesTFC.BEACH || b == BiomesTFC.GRAVEL_BEACH) &&
                    world.provider.getDimension() == 0) {
                if (isValidPosition2(world, pos) && pos.getY() < WorldTypeTFC.SEALEVEL - 1 && pos.getY() > 119 && floraDensity >= 0.4f &&
