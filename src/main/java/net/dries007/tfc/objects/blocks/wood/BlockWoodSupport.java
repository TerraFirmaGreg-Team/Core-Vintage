...
public class BlockWoodSupport extends Block implements IWoodBlock {
    ...
    public BlockWoodSupport(WoodVariant_old woodVariant, WoodType woodType) {
    ...
    private int getHorizontalDistance(EnumFacing face, IBlockAccess worldIn, BlockPos pos) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (!(worldIn.getBlockState(offsetPos).getBlock() instanceof BlockWoodSupport) && !worldIn.isAirBlock(offsetPos)) {
                return 0;
            }
