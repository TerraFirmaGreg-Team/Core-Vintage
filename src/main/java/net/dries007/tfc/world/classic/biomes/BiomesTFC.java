...
public final class BiomesTFC {
    ...
    public static void registerBiomes(RegistryEvent.Register<Biome> event) {
        ...
        register(r, new BiomeTFC(0x7E7450, new Biome.BiomeProperties(MOD_NAME + " Gravel Beach").setBaseHeight(-1.69f)
                .setHeightVariation(-2.68f)
        ...
        register(r, new BiomeTFC(0x92567C, new Biome.BiomeProperties(MOD_NAME + " High Hills Edge").setBaseHeight(-1.5f)
                .setHeightVariation(-2.3f)
        ...
        register(r, new BiomeTFC(0x924A4C, new Biome.BiomeProperties(MOD_NAME + " Mountains Edge").setBaseHeight(-1.3f)
                .setHeightVariation(-1.9000001f)
        ...
        register(r, new BiomeTFC(0x000080, new Biome.BiomeProperties(MOD_NAME + " Deep Ocean").setBaseHeight(-3.2f)
                .setHeightVariation(-2.49999f)
                .setBaseBiome("tfc:ocean")), false, false, BiomeDictionary.Type.OCEAN, BiomeDictionary.Type.WET, BiomeDictionary.Type.WATER);
        register(r, new BiomeTFC(0x5D8C8D, new Biome.BiomeProperties(MOD_NAME + " Lake").setBaseHeight(-2.4f)
                .setHeightVariation(-2.5990001f)
        ...
        register(r, (new BiomeTFC(6013240, (new Biome.BiomeProperties(MOD_NAME + " Meadows")).setBaseHeight(-1.7F)
                .setHeightVariation(-2.88F))).setSpawnBiome(), true, true, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.LUSH);
        register(r, (new BiomeTFC(6975545, (new Biome.BiomeProperties(MOD_NAME + " Bayou")).setBaseHeight(-2.21F)
                        .setHeightVariation(-2.75F)
                        .setWaterColor(16767282), 16, 45)).setSpawnBiome(), true, true, BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.RIVER,
                BiomeDictionary.Type.WET, BiomeDictionary.Type.WATER, BiomeDictionary.Type.LUSH);
        register(r, new BiomeTFC(8236369, (new Biome.BiomeProperties(MOD_NAME + " Mangrove")).setBaseHeight(-2.21F)
                        .setHeightVariation(-2.75F)
                        .setWaterColor(16767282), 16, 45), true, true, BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.OCEAN, BiomeDictionary.Type.WET,
                BiomeDictionary.Type.WATER, BiomeDictionary.Type.LUSH);
        register(r, (new BiomeTFC(6725742, (new Biome.BiomeProperties(MOD_NAME + " Marsh")).setBaseHeight(-1.9F)
                        .setHeightVariation(-2.95F), 8, 20)).setSpawnBiome(), true, true, BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.RIVER,
                BiomeDictionary.Type.WET, BiomeDictionary.Type.WATER, BiomeDictionary.Type.LUSH);
        ...
        register(r, new BiomeMesaTFC(false, false, 9470285, (new Biome.BiomeProperties(MOD_NAME + " Mesa")).setBaseHeight(-1.7F)
                        .setHeightVariation(-1.4F)), true, true, BiomeDictionary.Type.MESA, BiomeDictionary.Type.HOT, BiomeDictionary.Type.SANDY,
                BiomeDictionary.Type.DRY, BiomeDictionary.Type.LUSH);
        register(r, new BiomeMesaTFC(false, false, 9470285, (new Biome.BiomeProperties(MOD_NAME + " Mesa Plateau")).setBaseHeight(-0.6F)
                        .setHeightVariation(-2.63F)), true, true, BiomeDictionary.Type.MESA, BiomeDictionary.Type.HOT, BiomeDictionary.Type.SANDY,
                BiomeDictionary.Type.DRY, BiomeDictionary.Type.LUSH);
        register(r, new BiomeMesaTFC(true, false, 9470285, (new Biome.BiomeProperties(MOD_NAME + " Mesa Bryce")).setBaseBiome("tfc:mesa")), true,
                true, BiomeDictionary.Type.MESA, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE,
        ...
        register(r, new BiomeMesaTFC(false, false, 9470285, (new Biome.BiomeProperties(MOD_NAME + " Mesa Plateau M")).setBaseBiome("tfc:mesa_plateau")
                        .setBaseHeight(-0.1F)
                        .setHeightVariation(-1.5F)), true, true, BiomeDictionary.Type.MESA, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY,
                BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.MOUNTAIN);
    }
    ...
    private static void register(IForgeRegistry<Biome> r, Biome biome, boolean isSpawn, boolean isWorldGen, BiomeDictionary.Type... types) {
        r.register(biome.setRegistryName(MODID_TFC, biome.biomeName.replace(MOD_NAME + " ", "")
                .replace(' ', '_')
                .toLowerCase()));
        ...
        if (BiomeDictionary.hasType(biome, BiomeDictionary.Type.WATER)) {
            ...
            biome.getSpawnableList(EnumCreatureType.WATER_CREATURE)
                    .add(new Biome.SpawnListEntry(EntitySquid.class, 20, 3, 7));
