package su.terrafirmagreg.modules.core.feature.playerdata.capability;
...
public class ProviderPlayerData implements ICapabilityPlayerData, ICapabilitySerializable<NBTTagCompound> {
  ...
  public ProviderPlayerData() {
    this(null);
  }

  public ProviderPlayerData(EntityPlayer player) {
