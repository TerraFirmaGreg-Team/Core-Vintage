package su.terrafirmagreg.api.registry.strategy;
...
public class VariantBlockItemModelRegistrationStrategy<T extends IVariant & Comparable<T>> implements IClientModelRegistrationStrategy {
