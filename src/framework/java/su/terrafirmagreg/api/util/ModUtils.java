...
public final class ModUtils {
  ...
  public static ResourceLocation resource(String key, String name) {
    ModUtils.isValidIdentifier(key, name);
    return new ResourceLocation(key, name);
  }

  public static ResourceLocation resource(String key, String name, String subname) {
    return ModUtils.resource(key, regKey(name, subname));
  }

  public static ResourceLocation resource(ResourceLocation resourceLocation, String name) {
    return ModUtils.resource(resourceLocation.getNamespace(), ModUtils.regKey(resourceLocation.getPath(), name));
  }
  ...
  public static String localize(String key, ResourceLocation resourceLocation) {
    return replace(String.format("%s.%s", key, localize(resourceLocation)));
  }
