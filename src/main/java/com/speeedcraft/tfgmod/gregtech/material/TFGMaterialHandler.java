...
import static com.speeedcraft.tfgmod.gregtech.material.TFGMaterials.*;
...
public class TFGMaterialHandler {
	...
	public static void init() {
		...
		// Custom Rocks
		Breccia = new Material.Builder(32100, gregtechId("breccia"))
				.dust()
				.color(0x706B5F)
				.build();
		...
		Komatiite = new Material.Builder(32110, gregtechId("komatiite"))
				.dust()
				.color(0x586455)
				.build();
		...
		Mudstone = new Material.Builder(32112, gregtechId("mudstone"))
				.dust()
				.color(0x938E84)
				.build();

		Novaculite = new Material.Builder(32113, gregtechId("novaculite"))
				.dust()
				.color(0xADA9A1)
				.build();

		Peridotite = new Material.Builder(32114, gregtechId("peridotite"))
				.dust()
				.color(0x565F56)
				.build();
		...
		Porphyry = new Material.Builder(32116, gregtechId("porphyry"))
				.dust()
				.color(0x422825)
				.build();
		...
		Sandstone = new Material.Builder(32118, gregtechId("sandstone"))
				.dust()
				.color(0xBAAE90)
				.build();
		...
		Siltstone = new Material.Builder(32121, gregtechId("siltstone"))
				.dust()
				.color(0xA98D79)
				.build();
