...
public class EntityDonkeyTFC extends EntityDonkey implements IAnimalTFC, ILivestock, IRidable {
        ...
        if (this.isHungry()) {
          ...
          if (!this.world.isRemote) {
            ...
            if (this.isFertilized() && this.getType() == Type.MAMMAL) {
              player.sendMessage(new TextComponentTranslation(TFC + ".tooltip.animal.mating.pregnant", getName()));
            }
          }
        }
      }
  ...
  public EntityAgeable createChild(@Nonnull EntityAgeable other) {
    ...
    if (other != this && this.getGender() == Gender.FEMALE && other instanceof IAnimalTFC) {
      ...
      EntityDonkeyTFC baby = new EntityDonkeyTFC(this.world, Gender.valueOf(Constants.RNG.nextBoolean()), (int) Calendar.PLAYER_TIME.getTotalDays());
