...
public class RenderAnimalYak extends RenderAnimal<EntityAnimalYak> {
    ...
    private static final ResourceLocation TEXTURE_YOUNG = ModUtils.resource("textures/entity/animal/livestock/yak_young.png");
    private static final ResourceLocation TEXTURE_OLD = ModUtils.resource("textures/entity/animal/livestock/yak_young.png");
