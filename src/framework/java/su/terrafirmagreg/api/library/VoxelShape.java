...
/**
 * Works like 'net.minecraft.util.shape.VoxelShape', construct the class with pixel-scaled parameters.
 */
public class VoxelShape extends AxisAlignedBB {
  ...
  /**
   * This constructor will automatically divide all parameters with 16 to satisfy AxisAlignedBB's actual scale.
   *
