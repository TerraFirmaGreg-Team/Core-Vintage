...
public class EntityCoyoteTFC extends EntityAnimalMammal implements IPredator {
	...
	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {return SoundAnimal.ANIMAL_COYOTE_HURT;}

	@Override
	protected SoundEvent getDeathSound() {return SoundAnimal.ANIMAL_COYOTE_DEATH;}
	...
	protected SoundEvent getAmbientSound() {
		return Constants.RNG.nextInt(100) < 5 ? SoundAnimal.ANIMAL_COYOTE_CRY : SoundAnimal.ANIMAL_COYOTE_SAY;
	}
