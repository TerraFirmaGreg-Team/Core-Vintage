package net.dries007.tfc.module.animal.common.entity.livestock;
...
import net.dries007.tfc.module.animal.common.entity.ai.EntityAnimalAIPanic;
...
public class EntityAnimalLlama extends EntityLlama implements IAnimal, ILivestock {
    ...
    private static final DataParameter<Long> PREGNANT_TIME = EntityDataManager.createKey(EntityAnimalLlama.class, EntitiesTFC.getLongDataSerializer());
