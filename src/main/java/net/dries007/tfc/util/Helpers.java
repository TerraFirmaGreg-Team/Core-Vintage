...
public final class Helpers {
    ...
    @Nullable public static Entity getTFCReplacement(Entity entity) {
     ...
     */
    @Nullable public static Entity getSittingEntity(@Nonnull World world, @Nonnull BlockPos pos) {
        if (!world.isRemote) {
     ...
     */
    @Nullable public static RayTraceResult rayTrace(World worldIn, EntityPlayer playerIn, boolean useLiquids) {
     ...
     */
    @Nullable public static RayTraceResult rayTrace(Entity entity, double blockReachDistance, float partialTicks) {
    ...
    @Nullable public static ResourceLocation readResourceLocation(ByteBuf buf) {
        if (buf.readBoolean()) {
