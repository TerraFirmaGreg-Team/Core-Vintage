package net.dries007.tfc.module.core.common.objects.entity.ai;
...
public class EntityAIFindNest extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (theCreature instanceof IAnimalTFC animal && ((IAnimalTFC) theCreature).getType() == IAnimalTFC.Type.OVIPAROUS) {
    ...
    public void updateTask() {
        ...
        if (this.theCreature.getDistanceSq(nestPos) > 1.25D) {
            ...
            if (te != null && theCreature instanceof IAnimalTFC animal && ((IAnimalTFC) theCreature).getType() == IAnimalTFC.Type.OVIPAROUS) {
                if (!te.hasBird()) {
