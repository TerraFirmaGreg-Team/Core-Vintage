...
/**
 * Helper class Determines which IRL biome you should have in the collection of TFC's rainfall, temperature and flora density Keep in mind that this
 * won't check for oceans and mountains, you should check for this and the biomes provided in BiomesTFC for accuracy
 * <p>
