package net.dries007.tfc.module.ceramic.objects.tiles;
...
import static net.dries007.tfc.module.ceramic.objects.blocks.BlockLargeVessel.SEALED;
...
public class TELargeVessel extends TEInventory implements IItemHandlerSidedCallback {
    ...
    public boolean canInsert(int slot, ItemStack stack, EnumFacing side) {
        return !world.getBlockState(pos).getValue(BlockLargeVessel.SEALED) && isItemValid(slot, stack);
    }
    ...
    public void onBreakBlock(World world, BlockPos pos, IBlockState state) {
        if (!state.getValue(BlockLargeVessel.SEALED)) {
