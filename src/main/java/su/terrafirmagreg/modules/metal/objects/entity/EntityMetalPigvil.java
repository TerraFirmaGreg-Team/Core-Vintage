...
public class EntityMetalPigvil
    ...
    private static final DataParameter<String> ANVIL_TYPE = EntityDataManager.createKey(EntityMetalPigvil.class, DataSerializers.STRING);
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register(ANVIL_TYPE, BlocksMetal.PIGVIL.get(MetalTypes.STEEL).getRegistryName().toString());
    }
