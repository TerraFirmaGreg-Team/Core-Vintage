...
import net.dries007.tfc.module.animal.common.entity.livestock.EntityAnimalCamel;
...
public class ModelAnimalCamel extends ModelBase {
    ...
    public ModelAnimalCamel(float scale) {
        textureWidth = 128;
        textureHeight = 80;
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        } else if (abstractchesthorse instanceof EntityAnimalCamel && ((EntityAnimalCamel) abstractchesthorse).isHalter()) {
            bridleFront1.isHidden = false;
            bridleFront2.isHidden = false;
            bridleBack1.isHidden = false;
            bridleBack2.isHidden = false;
