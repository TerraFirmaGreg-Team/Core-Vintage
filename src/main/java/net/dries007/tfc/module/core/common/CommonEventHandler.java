...
import net.dries007.tfc.module.core.common.objects.blocks.devices.BlockQuern;
import net.dries007.tfc.module.core.common.objects.blocks.fluid.BlockFluidTFC;
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!player.isCreative() && stack.isEmpty() && player.getFoodStats() instanceof IFoodStatsTFC foodStats && event.getHand() == EnumHand.MAIN_HAND) {
            ...
            if (result != null && result.typeOfHit == RayTraceResult.Type.BLOCK) {
                ...
                boolean isFreshWater = TFCBlocks.isFreshWater(waterState), isSaltWater = TFCBlocks.isSaltWater(waterState);
