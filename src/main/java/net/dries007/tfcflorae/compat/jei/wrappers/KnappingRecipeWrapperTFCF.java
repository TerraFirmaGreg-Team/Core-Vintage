package net.dries007.tfcflorae.compat.jei.wrappers;
...
//
//    public Mud(KnappingRecipe recipe, IGuiHelper helper, SoilType type) {
//      super(recipe, helper, ItemsSoil.MUD.get(type).getForegroundTexture(), ItemsSoil.MUD.get(type).getBackgroundTexture());
//
//      this.type = type;
//    }
//
...
//          CollectionUtils.listOf(CollectionUtils.listOf(recipe.getOutput(new ItemStack(ItemMud.get(type))))));
//    }
//  }
}
