...
public class KnappingRecipeWrapperTFCF extends KnappingRecipeWrapper {
	...
	private static final ResourceLocation SISAL_CLOTH_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/blocks/devices/loom/product/sisal.png");
	private static final ResourceLocation COTTON_CLOTH_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/blocks/devices/loom/product/cotton.png");
	private static final ResourceLocation LINEN_CLOTH_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/blocks/devices/loom/product/linen.png");
	private static final ResourceLocation HEMP_CLOTH_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/blocks/devices/loom/product/hemp.png");
	...
	private static final ResourceLocation EARTHENWARE_CLAY_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/earthenware_clay_button.png");
	private static final ResourceLocation EARTHENWARE_CLAY_DISABLED_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/earthenware_clay_button_disabled.png");
	private static final ResourceLocation KAOLINITE_CLAY_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/kaolinite_clay_button.png");
	private static final ResourceLocation KAOLINITE_CLAY_DISABLED_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/kaolinite_clay_button_disabled.png");
	private static final ResourceLocation STONEWARE_CLAY_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/stoneware_clay_button.png");
	private static final ResourceLocation STONEWARE_CLAY_DISABLED_TEXTURE = new ResourceLocation(MODID_TFCF, "textures/gui/knapping/stoneware_clay_button_disabled.png");
