...
public class PerformanceInfo {
    ...
    /**
     * Constructs a PerformanceInfo snapshot. Once constructed it can be used to get get info about the game at time of construction.
     */
    ...
    public String getMemoryString() {
        ...
        return String.format("Mem:% 2d%% %03d/%03dMB", this.getUsedMemory() * 100L / this.getMaxMemory(), this.getUsedMemoryMb(),
                this.getMaxMemoryMb());
    }
