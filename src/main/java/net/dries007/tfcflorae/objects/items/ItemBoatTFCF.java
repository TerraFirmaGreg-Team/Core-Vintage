...
import net.dries007.tfcflorae.objects.blocks.entity.EntityBoatTFCF;
  ...
  public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
    ...
    if (raytraceresult == null) {
      ...
      if (flag) {
        ...
        EntityBoatTFCF entityboat = new EntityBoatTFCF(worldIn, raytraceresult.hitVec.x,
        ...
        if (wood != null) {entityboat.setWood(wood);} else if (tree != null) {entityboat.setTree(tree);}
