...
//
//public class BlockRockWall extends BlockWall implements IStoneTypeBlock {
//
...
//
//	public BlockRockWall(RockBlockType blockType, RockVariant rockVariant, RockType rockType) {
...
//						case RAW:
//						case SMOOTH:
//							Block.spawnAsEntity(world, pos, new ItemStack(getBlockSoilMap(blockType, COBBLE, rockType), 1));
//							break;
//						case COBBLE:
//							//Block.spawnAsEntity(world, pos, new ItemStack(StoneTypeItems.ITEM_STONE_MAP.get(LOOSE.getName() + "/" + rockType.getName()), new Random().nextInt(2) + 2));
//							break;
