...
import net.dries007.horsepower.client.renderer.TESRChopperHorse;
...
public class BlockChopperHorse extends BaseBlockHorse implements IProbeInfoAccessor {
  ...
  public IBlockState getStateFromMeta(int meta) {
    ...
    return getDefaultState().withProperty(HORIZONTALS, enumfacing).withProperty(CHOPPER_PART, EnumChopperPart.BASE);
  }

  @Override
  public int getMetaFromState(IBlockState state) {
    return state.getValue(HORIZONTALS).getIndex();
  }
  ...
  public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
    if (!worldIn.isRemote) {
      EnumFacing enumfacing = state.getValue(HORIZONTALS);
      worldIn.setBlockState(pos, state.withProperty(HORIZONTALS, enumfacing)
                                      .withProperty(CHOPPER_PART, EnumChopperPart.BASE), 2);
    }
  }
  ...
  protected BlockStateContainer createBlockState() {
    return new BlockStateContainer(this, CHOPPER_PART, HORIZONTALS);
  }
  ...
  public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta,
    ...
    return getDefaultState().withProperty(HORIZONTALS, placer.getHorizontalFacing().getOpposite())
                            .withProperty(CHOPPER_PART, EnumChopperPart.BASE);
  }
