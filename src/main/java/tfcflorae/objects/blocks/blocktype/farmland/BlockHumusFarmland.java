...
public class BlockHumusFarmland extends FarmlandTFCF {
	...
	public BlockHumusFarmland(RockTFCF rockTFCF, Rock rock) {
		super(rockTFCF, rock);
		...
		OreDictionaryHelper.register(this, "farmland", "humus");
	}
