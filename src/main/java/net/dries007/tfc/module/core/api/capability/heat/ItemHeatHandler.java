 ...
 * рекомендуется наследоваться от этого класса или использовать его, вместо того чтобы реализовывать IItemHeat напрямую
 * Исключение - если вы хотите наследоваться от другого объекта возможности (см. SmallVessel), но вы все равно должны реализовать эту функциональность где-то
 */
