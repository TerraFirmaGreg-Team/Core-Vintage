...
import su.terrafirmagreg.modules.animal.content.render.RenderAnimalCoyote;
...
public class EntityAnimalCoyote extends EntityAnimalMammal implements IPredator {
  ...
  public EntityAnimalCoyote(World worldIn, Gender gender, int birthDay) {
  ...
  protected ResourceLocation getLootTable() {
    return LootTablesAnimal.ANIMALS_COYOTE;
  }
