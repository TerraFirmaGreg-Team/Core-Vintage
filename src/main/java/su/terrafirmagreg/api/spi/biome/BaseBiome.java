...
import static su.terrafirmagreg.modules.world.classic.BiomeProviderClassic.WORLD_GEN_BIOMES;
...
public abstract class BaseBiome extends Biome implements IBiomeSettings {
    ...
    public BaseBiome(Settings settings) {
        ...
        if (settings.worldGen) WORLD_GEN_BIOMES.add(this);
