...
public class Waterflasks {
	...
	@Mod.Instance(MODID_WATERFLASKS)
	...
	public void init(FMLInitializationEvent event) {
		...
		LootFunctionManager.registerFunction(new ApplyRequiredSkill.Serializer(new ResourceLocation(MODID_WATERFLASKS, "apply_req_skill")));
	}
	...
	public static class ObjectRegistryHandler {
		...
		public static void registerSounds(RegistryEvent.Register<SoundEvent> event) {
			ResourceLocation soundID = new ResourceLocation(MODID_WATERFLASKS, "item.flaskbreak");
