...
public class EntityCamelTFC extends EntityLlamaTFC implements IAnimal, ILivestock, IRidable {
    ...
    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {return SoundsAnimal.ANIMAL_CAMEL_HURT;}

    @Override
    protected SoundEvent getDeathSound() {return SoundsAnimal.ANIMAL_CAMEL_DEATH;}
    ...
    @Nullable
    @Override
    public EntityCamelTFC createChild(@NotNull EntityAgeable other) {
