...
public final class BlocksDevice {
  ...
  public static void onRegister(IContentRegistrar registrar) {
    ...
    ALLOY_CALCULATOR = registrar.addBlock("alloy_calculator", new BlockAlloyCalculator());
    BEAR_TRAP = registrar.addBlock("bear_trap", new BlockBearTrap());
    SNARE = registrar.addBlock("snare", new BlockSnare());
//    CRATE = registrar.addBlock(new BlockCrate());
    BELLOWS = registrar.addBlock("bellows", new BlockBellows());
    BLAST_FURNACE = registrar.addBlock("blast_furnace", new BlockBlastFurnace());
    BLOOM = registrar.addBlock("bloom", new BlockBloom());
    BLOOMERY = registrar.addBlock("bloomery", new BlockBloomery());
    CHARCOAL_FORGE = registrar.addBlock("charcoal_forge", new BlockCharcoalForge());
    CHARCOAL_PILE = registrar.addBlock("charcoal_pile", new BlockCharcoalPile());
    CRUCIBLE = registrar.addBlock("crucible", new BlockCrucible());
    FIRE_PIT = registrar.addBlock("fire_pit", new BlockFirePit());
    PIT_KILN = registrar.addBlock("pit_kiln", new BlockPitKiln());
//    QUERN_MANUAL = registrar.addBlock(new BlockQuernManual());
//    QUERN_HORSE = registrar.addBlock(new BlockQuernHorse());
    MOLTEN = registrar.addBlock("molten", new BlockMolten());
    LOG_PILE = registrar.addBlock("log_pile", new BlockLogPile());
    CELLAR_SHELF = registrar.addBlock("cellar/shelf", new BlockCellarShelf());
    CELLAR_DOOR = registrar.addBlock("cellar/door", new BlockCellarDoor());
    CELLAR_WALL = registrar.addBlock("cellar/wall", new BlockCellarWall());
    ICE_BUNKER = registrar.addBlock("ice_bunker", new BlockIceBunker());
    INFECTED_AIR = registrar.addBlock("infected_air", new BlockInfectedAir());
    FREEZE_DRYER = registrar.addBlock("freeze_dryer", new BlockFreezeDryer());
    POWDERKEG = registrar.addBlock("powderkeg", new BlockPowderKeg());
    THATCH_BED = registrar.addBlock("thatch_bed", new BlockThatchBed());
...
//    INDUCTION_CRUCIBLE = registrar.addBlock(new BlockInductionCrucible());
    FRIDGE = registrar.addBlock("fridge", new BlockFridge());
    LATEX_EXTRACTOR = registrar.addBlock("latex_extractor", new BlockLatexExtractor());
    SMELTERY_CAULDRON = registrar.addBlock("smeltery/cauldron", new BlockSmelteryCauldron());
    SMELTERY_FIREBOX = registrar.addBlock("smeltery/firebox", new BlockSmelteryFirebox());
    GREENHOUSE_DOOR = registrar.addBlock("greenhouse/door", new BlockGreenhouseDoor());
    GREENHOUSE_ROOF = registrar.addBlock("greenhouse/roof", new BlockGreenhouseRoof());
    GREENHOUSE_WALL = registrar.addBlock("greenhouse/wall", new BlockGreenhouseWall());
    OVEN_BASE = registrar.addBlock("oven/base", new BlockOven());
    OVEN_WALL = registrar.addBlock("oven/wall", new BlockOvenWall());
    OVEN_CHIMNEY = registrar.addBlock("oven/chimney", new BlockOvenChimney());
    LEAF_MAT = registrar.addBlock("leaf_mat", new BlockLeafMat());
    DRYING_MAT = registrar.addBlock("drying_mat", new BlockDryingMat());
