...
public class BlockHangingPlantTFC extends BlockCreepingPlantTFC implements IGrowable {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if (worldIn.getBlockState(pos.down())
		           .getBlock() == this && (Boolean) actualState.getValue(UP) && !(Boolean) actualState.getValue(DOWN) && !(Boolean) actualState.getValue(NORTH) && !(Boolean) actualState.getValue(SOUTH) && !(Boolean) actualState.getValue(EAST) && !(Boolean) actualState.getValue(WEST)) {
		...
		if (worldIn.getBlockState(pos.up())
		           .getBlock() == this && !(Boolean) actualState.getValue(UP) && !(Boolean) actualState.getValue(NORTH) && !(Boolean) actualState.getValue(SOUTH) && !(Boolean) actualState.getValue(EAST) && !(Boolean) actualState.getValue(WEST)) {
	...
	protected boolean canPlantConnectTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
		return !super.canPlantConnectTo(world, pos, facing) && world.getBlockState(pos.up())
		                                                            .getBlock() == this && facing != EnumFacing.DOWN && facing != EnumFacing.UP ? this.canPlantConnectTo(world, pos.up(), facing) : super.canPlantConnectTo(world, pos, facing);
	}
