...
public class ModelBaker {
	...
	public ModelBaker putCube(float offsetX, float offsetY, float offsetZ, float scaleX, float scaleY, float scaleZ, float uMin, float uMax, float vMin, float vMax) {
