...
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorFalls;
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorFissure;
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorFruitTrees;
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorRarityBased;
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorSnowIce;
import su.terrafirmagreg.modules.worldgen.classic.objects.generator.GeneratorSoilPits;
...
import su.terrafirmagreg.modules.worldgen.classic.objects.layer.datalayers.drainage.GenLayerDrainage;
import su.terrafirmagreg.modules.worldgen.classic.objects.layer.datalayers.ph.GenLayerPH;
import su.terrafirmagreg.modules.worldgen.classic.objects.mapgen.MapGenCaves;
import su.terrafirmagreg.modules.worldgen.classic.objects.mapgen.MapGenRavine;
import su.terrafirmagreg.modules.worldgen.classic.objects.mapgen.MapGenRiverRavine;
...
public class ChunkGenClassic implements IChunkGenerator {
  ...
  private static final IWorldGenerator LARGE_ROCKS_GEN = new GeneratorRarityBased(x -> x.largeRockRarity, new GeneratorRockLarge());
  ...
  private static final IWorldGenerator LOOSE_ROCKS_GEN = new GeneratorRockSurface();
  private static final IWorldGenerator SPELEOTHEM_GEN = new GeneratorRockSpeleothem();
