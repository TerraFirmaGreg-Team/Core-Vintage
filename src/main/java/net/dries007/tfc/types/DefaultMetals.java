...
public final class DefaultMetals {
  ...
  public static void onPreRegisterMetal(TFCRegistryEvent.RegisterPreBlock<Metal> event) {
    event.getRegistry().registerAll(
            ...
            new Metal(BISMUTH_BRONZE, TIER_II, true, 0.35f, 985, 0xFF418E4F, ToolMaterials.BISMUTH_BRONZE, ArmorMaterialTFC.BISMUTH_BRONZE),
            new Metal(BLACK_BRONZE, TIER_II, true, 0.35f, 1070, 0xFF3B2636, ToolMaterials.BLACK_BRONZE, ArmorMaterialTFC.BLACK_BRONZE),
            new Metal(BRASS, TIER_I, true, 0.35f, 930, 0xFF96892E, null, null),
            new Metal(BRONZE, TIER_II, true, 0.35f, 950, 0xFF7C5E33, ToolMaterials.BRONZE, ArmorMaterialTFC.BRONZE),
            new Metal(COPPER, TIER_I, true, 0.35f, 1080, 0xFFB64027, ToolMaterials.COPPER, ArmorMaterialTFC.COPPER),
            ...
            new Metal(WROUGHT_IRON, TIER_III, true, 0.35f, 1535, 0xFF989897, ToolMaterials.WROUGHT_IRON, ArmorMaterialTFC.WROUGHT_IRON),
            new Metal(PIG_IRON, TIER_III, true, 0.35f, 1535, 0xFF6A595C, null, null),
            new Metal(STEEL, TIER_IV, true, 0.35f, 1540, 0xFF5F5F5F, ToolMaterials.STEEL, ArmorMaterialTFC.STEEL),
            new Metal(PLATINUM, TIER_V, true, 0.35f, 1730, 0xFF9DADC0, null, null),
            new Metal(BLACK_STEEL, TIER_V, true, 0.35f, 1485, 0xFF111111, ToolMaterials.BLACK_STEEL, ArmorMaterialTFC.BLACK_STEEL),
            new Metal(BLUE_STEEL, TIER_VI, true, 0.35f, 1540, 0xFF2D5596, ToolMaterials.BLUE_STEEL, ArmorMaterialTFC.BLUE_STEEL),
            new Metal(RED_STEEL, TIER_VI, true, 0.35f, 1540, 0xFF700503, ToolMaterials.RED_STEEL, ArmorMaterialTFC.RED_STEEL),
