...
public class RenderTurkeyTFC extends RenderLiving<EntityTurkeyTFC> {
  ...
  private static final ResourceLocation MALE = new ResourceLocation(TFC, "textures/entity/animal/huntable/turkeym.png");
  private static final ResourceLocation FEMALE = new ResourceLocation(TFC, "textures/entity/animal/huntable/turkeyf.png");
