package su.terrafirmagreg.modules.core.content.gui;
...
public final class GuiOverlayAmbiental {
  ...
  @Getter(lazy = true)
  private static final GuiOverlayAmbiental instance = new GuiOverlayAmbiental();
