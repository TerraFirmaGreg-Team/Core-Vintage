package net.dries007.tfcthings.tileentity;
...
public class TileEntityGrindstone extends TEInventory implements ITickable {
  ...
  public boolean isItemValid(int slot, ItemStack stack) {
    switch (slot) {
      ...
      case SLOT_INPUT:
        return stack.hasCapability(CapabilitySharpness.CAPABILITY, null);
      default:
        return false;
    }
  }
  ...
  public ItemStack insertOrSwapItem(int slot, ItemStack playerStack) {
    ...
    if (!grindstoneStack.isEmpty() && (!playerStack.isStackable() || !grindstoneStack.isStackable() || grindstoneStack.getItem() != playerStack.getItem()
        ...
        if (grindstoneStack.isEmpty()) {
          for (int i = 0; i < 15; ++i) {
            this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK,
              ...
              (this.world.rand.nextDouble() - this.world.rand.nextDouble()) / 4.0D, Item.getIdFromItem(TFCThingsItems.ITEM_GRINDSTONE_QUARTZ));
          }
