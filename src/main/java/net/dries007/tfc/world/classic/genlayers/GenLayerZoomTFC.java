...
public class GenLayerZoomTFC extends GenLayerTFC {
  ...
  protected int choose4(int id0, int id1, int id2, int id3) {
    if (id1 == id2 && id2 == id3) {return id1;} else if (id0 == id1 && id0 == id2) {return id0;} else if (id0 == id1 && id0 == id3) {return id0;} else if (
      id0 == id2 && id0 == id3) {return id0;} else if (
      id0 == id1 && id2 != id3) {return id0;} else if (
      id0 == id2 && id1 != id3) {return id0;} else if (
      id0 == id3 && id1 != id2) {return id0;} else if (
      id1 == id0 && id2 != id3) {return id1;} else if (
      id1 == id2 && id0 != id3) {return id1;} else if (
      id1 == id3 && id0 != id2) {return id1;} else if (
      id2 == id0 && id1 != id3) {return id2;} else if (
      id2 == id1 && id0 != id3) {return id2;} else if (
      id2 == id3 && id0 != id1) {return id2;} else if (
      id3 == id0 && id1 != id2) {return id2;} else if (
      id3 == id1 && id0 != id2) {return id2;} else if (
      id3 == id2 && id0 != id1) {return id2;} else {
