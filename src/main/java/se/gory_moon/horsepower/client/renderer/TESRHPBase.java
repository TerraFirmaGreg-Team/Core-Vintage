...
public abstract class TESRHPBase<T extends TileHPBase> extends TileEntitySpecialRenderer<T> {
  ...
  protected void renderStillItem(TileHPBase tile, ItemStack stack, float x, float y, float z, float scale) {
    renderItem(tile, stack, x, y, z, scale, false);
  }

  private void renderItem(TileHPBase tile, ItemStack stack, float x, float y, float z, float scale, boolean rotate) {
  ...
  protected void renderItem(TileHPBase tile, ItemStack stack, float x, float y, float z, float scale) {
    renderItem(tile, stack, x, y, z, scale, true);
  }

  public void drawString(TileHPBase tile, String str, double x, double y, double z) {
