...
import net.dries007.tfc.module.core.common.objects.inventory.ingredient.IngredientItemFoodTrait;
...
public class BarrelRecipeFoodPreservation extends BarrelRecipe {
    ...
    public static BarrelRecipe vinegar(@Nonnull IIngredient<ItemStack> inputStack) {
        return new BarrelRecipeFoodPreservation(IIngredient.of(FluidRegistry.getFluid("vinegar"), 125), new IngredientItemFoodTrait(inputStack, FoodTrait.PICKLED), FoodTrait.VINEGAR, "barrel_recipe_vinegar");
    }
