...
/**
 * ModelGoatTFC Created using Tabula 7.1.0
 */

@SideOnly(Side.CLIENT)

public class ModelAnimalGoat extends ModelBase {
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5,
    ...
    if (!(((EntityAnimalGoat) ent).sheepTimer > 0)) {
      this.head1.rotateAngleX = par5 / (180F / MathUtils.PI);
      this.head2.rotateAngleX = par5 / (180F / MathUtils.PI);
    }
    this.head1.rotateAngleY = par4 / (180F / MathUtils.PI);
    this.head2.rotateAngleY = par4 / (180F / MathUtils.PI);
    this.body.rotateAngleX = MathUtils.PI / 2F;
    this.leg1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.2F * par2;
    this.leg2.rotateAngleX = MathHelper.cos(par1 * 0.6662F + MathUtils.PI) * 1.2F * par2;
    this.leg3.rotateAngleX = MathHelper.cos(par1 * 0.6662F + MathUtils.PI) * 1.2F * par2;
  ...
  public void setLivingAnimations(EntityLivingBase entity, float limbSwing, float limbSwingAmount,
    ...
    float rotX = ((EntityAnimalGoat) entity).getHeadRotationAngleX(partialTicks);
