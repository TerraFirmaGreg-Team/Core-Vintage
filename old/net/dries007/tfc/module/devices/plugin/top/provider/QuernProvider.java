...
import static net.dries007.tfc.module.devices.objects.tile.TEQuern.SLOT_HANDSTONE;
...
public class QuernProvider implements IProbeInfoProvider {
    ...
    public void addProbeInfo(ProbeMode probeMode, IProbeInfo iProbeInfo, EntityPlayer entityPlayer, World world, IBlockState iBlockState, IProbeHitData iProbeHitData) {
        ...
        if (quern != null && quern.hasHandstone() && (handler = quern.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null)) != null && !(handstone = handler.getStackInSlot(TEQuern.SLOT_HANDSTONE)).isEmpty()) {
