...
public class BlockWoodChopping extends BlockWoodChoppingBase {
  ...
  public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state,
    ...
    return player instanceof FakePlayer || player == null || super.onBlockActivated(worldIn, pos,
        state, player, hand, facing, hitX, hitY, hitZ);
  }
  ...
  @Override
  public void onBlockClicked(@NotNull World world, @NotNull BlockPos pos,
