...
import net.dries007.tfc.objects.items.ItemHikingBoots;
import net.dries007.tfc.objects.items.ItemHookJavelin;
import net.dries007.tfc.objects.items.ItemMetalBracing;
import net.dries007.tfc.objects.items.ItemMetalSlingAmmo;
import net.dries007.tfc.objects.items.ItemPigIronCarrot;
import net.dries007.tfc.objects.items.ItemProspectorsHammer;
import net.dries007.tfc.objects.items.ItemRopeBridge;
import net.dries007.tfc.objects.items.ItemRopeJavelin;
import net.dries007.tfc.objects.items.ItemSling;
import net.dries007.tfc.objects.items.ItemSnowShoes;
