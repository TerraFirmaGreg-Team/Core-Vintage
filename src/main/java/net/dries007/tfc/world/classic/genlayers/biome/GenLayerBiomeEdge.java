      ...
      for (int xx = 0; xx < xSize; ++xx) {
        ...
        if (thisID == this.highHillsID) {
          ...
          if (thisID != this.mesaPlateauMID && thisID != this.mesaPlateauID && thisID != this.mesaBryceID) {
            ...
            zn != this.mesaPlateauID || xp != this.mesaPlateauID || xn != this.mesaPlateauID || zp != this.mesaPlateauID) && (zn != this.mesaBryceID
                                                                                                                              || xp != this.mesaBryceID
                                                                                                                              || xn != this.mesaBryceID
                                                                                                                              || zp != this.mesaBryceID)) {
        ...
        } else if ((zn != this.flatlandsID || xp != this.flatlandsID || xn != this.flatlandsID || zp != this.flatlandsID) && (zn != this.fieldsID
                                                                                                                              || xp != this.fieldsID
                                                                                                                              || xn != this.fieldsID
                                                                                                                              || zp != this.fieldsID)) {
