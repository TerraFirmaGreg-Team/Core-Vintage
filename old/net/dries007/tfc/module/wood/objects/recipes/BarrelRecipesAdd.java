...
public class BarrelRecipesAdd {
    ...
    public static void register() {
        var registry = RegistryCore.BARREL;

        // Hide Processing (all three conversions)
        new BarrelRecipe.Builder("small_prepared_hide")
                .setInputFluid(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 300))
                .setInputStack(IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, ItemAnimalHide.HideSize.SMALL)))
                .setOutputFluid(null)
                .setOutputStack(new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, ItemAnimalHide.HideSize.SMALL)))
                .setDuration(8 * ICalendar.TICKS_IN_HOUR)
                .build();

        new BarrelRecipe.Builder("medium_prepared_hide")
                .setInputFluid(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 400))
                .setInputStack(IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, ItemAnimalHide.HideSize.MEDIUM)))
                .setOutputFluid(null)
                .setOutputStack(new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, ItemAnimalHide.HideSize.MEDIUM)))
                .setDuration(8 * ICalendar.TICKS_IN_HOUR)
                .build();

        new BarrelRecipe.Builder("large_prepared_hide")
                .setInputFluid(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500))
                .setInputStack(IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, ItemAnimalHide.HideSize.LARGE)))
                .setOutputFluid(null)
                .setOutputStack(new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, ItemAnimalHide.HideSize.LARGE)))
                .setDuration(8 * ICalendar.TICKS_IN_HOUR)
                .build();
        ...
        // Food preservation
        BarrelRecipeFoodTraits.pickling("pickling_fruit", new IngredientItemFood(IIngredient.of("categoryFruit")));
        BarrelRecipeFoodTraits.pickling("pickling_vegetable", new IngredientItemFood(IIngredient.of("categoryVegetable")));
        BarrelRecipeFoodTraits.pickling("pickling_meat", new IngredientItemFood(IIngredient.of("categoryMeat")));
        BarrelRecipeFoodTraits.brining("brining_fruit", new IngredientItemFood(IIngredient.of("categoryFruit")));
        BarrelRecipeFoodTraits.brining("brining_vegetable", new IngredientItemFood(IIngredient.of("categoryVegetable")));
        BarrelRecipeFoodTraits.brining("brining_meat", new IngredientItemFood(IIngredient.of("categoryMeat")));
        BarrelRecipeFoodPreservation.vinegar("vinegar_fruit", new IngredientItemFood(IIngredient.of("categoryFruit")));
        BarrelRecipeFoodPreservation.vinegar("vinegar_vegetable", new IngredientItemFood(IIngredient.of("categoryVegetable")));
        BarrelRecipeFoodPreservation.vinegar("vinegar_meat", new IngredientItemFood(IIngredient.of("categoryMeat")));
...
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 600), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, SUGARCANE), 5)), null, new ItemStack(Items.SUGAR), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("sugar"),
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("limewater"), 500), IIngredient.of(new ItemStack(Items.DYE, 1, EnumDyeColor.WHITE.getDyeDamage())), null, new ItemStack(ItemsCore.GLUE), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("glue"),
...
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, BARLEY_FLOUR))), new FluidStack(FluidRegistry.getFluid("beer"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("beer"),
...
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, RICE_FLOUR))), new FluidStack(FluidRegistry.getFluid("sake"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("sake"),
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, POTATO))), new FluidStack(FluidRegistry.getFluid("vodka"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("vodka"),
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, WHEAT_FLOUR))), new FluidStack(FluidRegistry.getFluid("whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("whiskey"),
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, CORNMEAL_FLOUR))), new FluidStack(FluidRegistry.getFluid("corn_whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("corn_whiskey"),
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 500), new IngredientItemFood(IIngredient.of(StorageFood.getFoodItem(INGREDIENT, RYE_FLOUR))), new FluidStack(FluidRegistry.getFluid("rye_whiskey"), 500), ItemStack.EMPTY, 72 * ICalendar.TICKS_IN_HOUR).setRegistryName("rye_whiskey"),
...
//
//
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("limewater"), 100), IIngredient.of("sand"), null, new ItemStack(ItemsCore.MORTAR, 16), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("mortar"),
...
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("hot_water"), 125), IIngredient.of(new ItemStack(ItemsCore.WOOD_ASH)), new FluidStack(FluidRegistry.getFluid("lye"), 125), ItemStack.EMPTY, 0).setRegistryName("lye"),
...
//                new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("curdled_milk"), 625), IIngredient.of(ItemStack.EMPTY), null, new ItemStack(StorageFood.getFoodItem(INGREDIENT, CHEESE), 2), 8 * ICalendar.TICKS_IN_HOUR).setRegistryName("cheese"),
//
...
//                //new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("limewater"), 100), IIngredient.of("gemGypsum"), null, new ItemStack(BlocksCore.getAlabasterBlock(RAW, COLORLESS)), ICalendar.TICKS_IN_HOUR).setRegistryName("plain_alabaster"),
//
...
//        for (FoodType type : new FoodType[]{SALAD_DAIRY, SALAD_FRUIT, SALAD_GRAIN, SALAD_MEAT, SALAD_VEGETABLE, SOUP_DAIRY, SOUP_FRUIT, SOUP_GRAIN, SOUP_MEAT, SOUP_VEGETABLE}) {
//            registry.register(new BarrelRecipeDynamicBowlFood(IIngredient.of(FluidRegistry.getFluid("fresh_water"), 200), IIngredient.of(StorageFood.getFoodItem(INGREDIENT, type)), 0).setRegistryName(type.toString().toLowerCase() + "_cleaning"));
//        }
...
//                    new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksCore.AGGREGATE), null, new ItemStack(Blocks.CONCRETE_POWDER, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName("aggregate_" + dyeName),
//                    // Alabaster
//                    new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksCore.getAlabasterBlock("plain", BRICK)), null, new ItemStack(BlocksCore.getAlabasterBlock(dyeColor.getName(), BRICK)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_bricks_" + dyeColor.getName()),
//                    new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksCore.getAlabasterBlock("plain", RAW)), null, new ItemStack(BlocksCore.getAlabasterBlock(dyeColor.getName(), RAW)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_raw_" + dyeColor.getName()),
//                    new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksCore.getAlabasterBlock("plain", SMOOTH)), null, new ItemStack(BlocksCore.getAlabasterBlock(dyeColor.getName(), SMOOTH)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_polished_" + dyeColor.getName())
//            );
//        }
        // Un-dyeing Recipes
//        registry.registerAll(
...
//                // Alabaster
//                // new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("lye"), 125), IIngredient.of("alabasterBricks"), null, new ItemStack(BlocksCore.getAlabasterBlock(BRICKS, COLORLESS)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_bricks_undo"),
//                //new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("lye"), 125), IIngredient.of("alabasterRaw"), null, new ItemStack(BlocksCore.getAlabasterBlock(RAW, COLORLESS)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_raw_undo"),
//                //new BarrelRecipe(IIngredient.of(FluidRegistry.getFluid("lye"), 125), IIngredient.of("alabasterPolished"), null, new ItemStack(BlocksCore.getAlabasterBlock(SMOOTH, COLORLESS)), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_polished_undo")
//        );
        // Dye combinations.
//        registry.registerAll(
//                //Orange
