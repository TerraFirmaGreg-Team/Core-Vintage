...
public class CapabilityFood {
    ...
    /**
     * Возвращает пользовательский интерфейс Capability для указанного предмета.
     *
     * @param stack Предмет, для которого нужно получить пользовательский интерфейс Capability
     * @return Пользовательский интерфейс Capability или null, если не найдено соответствующего пользовательского интерфейса
     */
    @Nullable
