...
import net.dries007.firmalife.items.ItemBlockJar;
import net.dries007.firmalife.items.ItemCheesecloth;
import net.dries007.firmalife.items.ItemDriedPineapple;
import net.dries007.firmalife.items.ItemFoodFL;
import net.dries007.firmalife.items.ItemFruitDoor;
import net.dries007.firmalife.items.ItemFruitPole;
import net.dries007.firmalife.items.ItemGreenhouseDoor;
import net.dries007.firmalife.items.ItemHeatableFoodFL;
import net.dries007.firmalife.items.ItemPizza;
import net.dries007.firmalife.items.ItemRoastedCocoaBeans;
import net.dries007.firmalife.items.ItemSandwichFL;
import net.dries007.firmalife.items.ItemTrailMix;
import net.dries007.firmalife.items.ItemWateringCan;
