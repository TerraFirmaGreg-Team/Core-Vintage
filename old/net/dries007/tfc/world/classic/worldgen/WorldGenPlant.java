...
public class WorldGenPlant extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        switch (plant.getPlantVariant()) {
            case PlantEnumVariant.MUSHROOM -> {
            ...
            case PlantEnumVariant.REED, PlantEnumVariant.REED_SEA -> {
            ...
            case PlantEnumVariant.TALL_REED, PlantEnumVariant.TALL_REED_SEA, PlantEnumVariant.TALL_PLANT -> {
            ...
            case PlantEnumVariant.DESERT, PlantEnumVariant.DRY -> {
                var plantBlock = (BlockPlant) StoragePlant.getPlantBlock(plant.getPlantVariant(), plant);
                IBlockState state = plantBlock.getDefaultState();
            ...
            case PlantEnumVariant.DESERT_TALL_PLANT, PlantEnumVariant.DRY_TALL_PLANT -> {
                var plantBlock = (BlockPlantTall) StoragePlant.getPlantBlock(plant.getPlantVariant(), plant);
                IBlockState state = plantBlock.getDefaultState();
            ...
            case PlantEnumVariant.WATER, PlantEnumVariant.WATER_SEA -> {
            ...
            case PlantEnumVariant.EMERGENT_TALL_WATER, PlantEnumVariant.EMERGENT_TALL_WATER_SEA -> {
            ...
            case PlantEnumVariant.TALL_WATER, PlantEnumVariant.TALL_WATER_SEA -> {
