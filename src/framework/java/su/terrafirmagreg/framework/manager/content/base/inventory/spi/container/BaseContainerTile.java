package su.terrafirmagreg.framework.manager.content.base.inventory.spi.container;
...
public abstract class BaseContainerTile<T extends BaseTileInventory> extends BaseContainer {
  ...
  protected BaseContainerTile(InventoryPlayer playerInv, T tile, int yOffset) {
    ...
    this.shouldSyncFields = tile instanceof IProviderTileFields;
  ...
  public void updateProgressBar(int id, int data) {
    if (shouldSyncFields) {
      ((IProviderTileFields) tile).setField(id, data);
    }
  }

  protected void detectAndSendFieldChanges() {
    IProviderTileFields tileFields = (IProviderTileFields) tile;
