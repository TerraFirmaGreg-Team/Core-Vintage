package net.dries007.tfcpassingdays.fixes;
...
import net.dries007.tfcpassingdays.PassingDayWorldProviderServer;
...
public class BlockDaylightDetectorFixed extends BlockDaylightDetector {
  ...
  public void updatePower(World worldIn, BlockPos pos) {
    ...
    if (i > 0 && !this.inverted) {
      float f1 = f < MathUtils.PI ? 0.0F : ((float) Math.PI * 2F);
      f = f + (f1 - f) * 0.2F;
