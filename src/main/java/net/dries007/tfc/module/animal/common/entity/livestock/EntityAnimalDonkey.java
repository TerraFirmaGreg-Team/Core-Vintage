...
public class EntityAnimalDonkey extends EntityDonkey implements IAnimal, ILivestock, IRidable {
    ...
    private static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(EntityAnimalDonkey.class, DataSerializers.VARINT);
    private static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(EntityAnimalDonkey.class, DataSerializers.FLOAT);
    ...
    private static final DataParameter<Long> PREGNANT_TIME = EntityDataManager.createKey(EntityAnimalDonkey.class, EntitiesTFC.getLongDataSerializer());
    ...
    public EntityAnimalDonkey(World world) {
        this(world, Gender.valueOf(Constants.RNG.nextBoolean()), TFCEntityAnimal.getRandomGrowth(ConfigTFC.Animals.DONKEY.adulthood, ConfigTFC.Animals.DONKEY.elder));
    }
