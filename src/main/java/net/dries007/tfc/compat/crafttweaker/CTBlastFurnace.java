...
public class CTBlastFurnace {
  ...
  public static void addRecipe(String outputMetal, String inputMetal, crafttweaker.api.item.IIngredient additive) {
    ...
    if (additive == null) {throw new IllegalArgumentException("Additive is not allowed to be empty");}
    if (additive instanceof ILiquidStack) {throw new IllegalArgumentException("There is a fluid where it's supposed to be an item!");}
