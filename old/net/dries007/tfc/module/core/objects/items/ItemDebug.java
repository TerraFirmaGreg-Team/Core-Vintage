        ...
        try {
            ...
            if (tile != null) {
                try {
                    ...
                    ModuleCoreOld.LOGGER.info("No debug method found to invoke on {}", tile);
                }

                ModuleCoreOld.LOGGER.info("Tile Data: {}", tile.serializeNBT());

                IItemHandler inventory = tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);
                if (inventory != null) {
                    ModuleCoreOld.LOGGER.info("Found item handler: {}", inventory);
                }

                IFluidHandler fluids = tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, null);
                if (fluids != null) {
                    ModuleCoreOld.LOGGER.info("Found fluid handler: {}", fluids);
                }
            }
        } catch (Exception t) { /* Nothing Burger */ }
