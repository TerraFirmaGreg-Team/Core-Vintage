...
public class SoilItemVariantHandler {
    public static void init() {
        ...
        SoilItemVariants.PILE = new SoilItemVariant("pile", ItemSoilPile::new);
        SoilItemVariants.MUD_BRICK = new SoilItemVariant("mud_brick", ItemSoilMudBrick::new);
        SoilItemVariants.MUD_BRICK_WET = new SoilItemVariant("mud_brick_wet", ItemSoilMudWetBrick::new);
