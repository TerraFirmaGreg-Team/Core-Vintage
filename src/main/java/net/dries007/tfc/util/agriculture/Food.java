...
import static net.dries007.tfc.util.agriculture.Food.Category.BREAD;
import static net.dries007.tfc.util.agriculture.Food.Category.COOKED_MEAT;
import static net.dries007.tfc.util.agriculture.Food.Category.DAIRY;
import static net.dries007.tfc.util.agriculture.Food.Category.FRUIT;
import static net.dries007.tfc.util.agriculture.Food.Category.GRAIN;
import static net.dries007.tfc.util.agriculture.Food.Category.MEAL;
import static net.dries007.tfc.util.agriculture.Food.Category.MEAT;
import static net.dries007.tfc.util.agriculture.Food.Category.OTHER;
import static net.dries007.tfc.util.agriculture.Food.Category.VEGETABLE;
