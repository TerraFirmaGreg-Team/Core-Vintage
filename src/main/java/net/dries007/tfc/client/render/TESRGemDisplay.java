...
import net.dries007.tfc.client.model.ModelGemBase;
import net.dries007.tfc.client.model.ModelGemChipped;
import net.dries007.tfc.client.model.ModelGemExquisite;
import net.dries007.tfc.client.model.ModelGemFlawed;
import net.dries007.tfc.client.model.ModelGemFlawless;
import net.dries007.tfc.client.model.ModelGemNormal;
...
public class TESRGemDisplay extends TileEntitySpecialRenderer<TEGemDisplay> {
  ...
  public void render(TEGemDisplay te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
  ...
  private ArrayList<Vec3d> getLocation(TEGemDisplay te) {
  ...
  private ModelGemBase getModel(TEGemDisplay te) {
    switch (Gem.Grade.valueOf(te.getGrade())) {
      case EXQUISITE:
  ...
  private ResourceLocation getGemTexture(ItemStack gem) {
    if (gem.getItem() instanceof ItemGem gemItem) {
