...
import net.dries007.tfc.module.wood.objects.blocks.itemblocks.ItemBlockWoodDoor;
...
public class BlockWoodDoor extends BlockDoor implements IWoodBlock {
    ...
    public ItemStack getPickBlock(@Nonnull IBlockState state, @Nonnull RayTraceResult target, @Nonnull World world, @Nonnull BlockPos pos, @Nonnull EntityPlayer player) {
        ...
        return new ItemStack(ForgeRegistries.ITEMS.getValue(Helpers.getID(getName())));
    }
