...
public class BlockPlantFloatingWater extends BlockPlant {
  ...
  public BlockPlantFloatingWater(PlantBlockVariant variant, PlantType type) {
    super(variant, type);
  }
  ...
  public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
    if (pos.getY() >= 0 && pos.getY() < 256) {
      ...
      return (material == Material.WATER && stateDown.getValue(BlockLiquid.LEVEL) == 0 && stateDown == type.getWaterType()) ||
