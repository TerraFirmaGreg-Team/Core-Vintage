...
public class BlockPlantEpiphyte extends BlockPlant {
    ...
    public BlockPlantEpiphyte(PlantEnumVariant plantBlockVariant, PlantType plant) {
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return switch (state.getValue(FACING)) {
            case EnumFacing.EAST -> PLANT_EAST_AABB;
            case EnumFacing.WEST -> PLANT_WEST_AABB;
            case EnumFacing.SOUTH -> PLANT_SOUTH_AABB;
            case EnumFacing.NORTH -> PLANT_NORTH_AABB;
            case EnumFacing.DOWN -> PLANT_DOWN_AABB;
