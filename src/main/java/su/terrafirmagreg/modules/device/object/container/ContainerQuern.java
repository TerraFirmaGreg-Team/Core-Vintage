...
import static su.terrafirmagreg.modules.device.object.tile.TileQuernManual.SLOT_INPUT;
import static su.terrafirmagreg.modules.device.object.tile.TileQuernManual.SLOT_OUTPUT;

public class ContainerQuern extends BaseContainerTile<TileQuernManual> {

  public ContainerQuern(InventoryPlayer playerInv, TileQuernManual tile) {
