...
public class BlockCrate extends Block implements ICapabilitySize {
  ...
  public static void toggleCrateSeal(World world, BlockPos pos) {
    TileCrate tile = Helpers.getTE(world, pos, TileCrate.class);
    if (tile != null) {
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
    TileCrate tile = Helpers.getTE(worldIn, pos, TileCrate.class);
    if (tile != null) {
  ...
  public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    if (!worldIn.isRemote) {
      ...
      TileCrate te = Helpers.getTE(worldIn, pos, TileCrate.class);
      if (te != null) {
