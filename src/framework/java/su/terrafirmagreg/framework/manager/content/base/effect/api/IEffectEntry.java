package su.terrafirmagreg.framework.manager.content.base.effect.api;

import su.terrafirmagreg.api.util.ModUtils;
import su.terrafirmagreg.framework.manager.content.api.IContentEntry;
import su.terrafirmagreg.framework.manager.content.base.effect.api.IEffectEntry.EffectSettings;
...
public interface IEffectEntry extends IContentEntry<EffectSettings, Potion> {


  @Getter
  @NoArgsConstructor(access = AccessLevel.PROTECTED)
  class EffectSettings extends ContentSettings<EffectSettings> {
