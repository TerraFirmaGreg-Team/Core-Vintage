...
public class RenderYakTFC extends RenderAnimalTFC<EntityYakTFC> {
  ...
  private static final ResourceLocation TEXTURE_YOUNG = new ResourceLocation(TFC, "textures/entity/animal/livestock/yak_young.png");
  private static final ResourceLocation TEXTURE_OLD = new ResourceLocation(TFC, "textures/entity/animal/livestock/yak_young.png");
  ...
  protected void preRenderCallback(EntityYakTFC yakTFC, float par2) {
    if (yakTFC.getGender() == EntityAnimalTFC.Gender.MALE) {GlStateManager.scale(1.2f, 1.2f, 1.2f);} else {
