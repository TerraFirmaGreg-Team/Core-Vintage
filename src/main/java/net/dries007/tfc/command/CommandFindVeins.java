...
public class CommandFindVeins extends CommandBase {
  ...
  public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
    if (sender.getCommandSenderEntity() == null) {throw new WrongUsageException("tfc.command.findveins.usage_expected_player");}
  ...
  private static class Worker implements WorldWorkerManager.IWorker {
    ...
    public boolean doWork() {
      ...
      AnvilChunkLoader loader =
        world.getChunkProvider().chunkLoader instanceof AnvilChunkLoader ? (AnvilChunkLoader) world.getChunkProvider().chunkLoader : null;
