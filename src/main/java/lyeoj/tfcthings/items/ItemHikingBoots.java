...
public class ItemHikingBoots extends ItemArmor implements ICapabilitySize, IDamageResistance, TFCThingsConfigurableItem {
                    ...
                    for (int j = blockpos$pooledmutableblockpos.getY(); j <= blockpos$pooledmutableblockpos1.getY(); ++j) {
                        for (int k = blockpos$pooledmutableblockpos.getZ(); k <= blockpos$pooledmutableblockpos1.getZ(); ++k) {
                            ...
                            if (iblockstate.getBlock() instanceof BlockPlantTFC) {
                                ...
                                if (!world.isRemote && ConfigTFCThings.Items.HIKING_BOOTS.damageTicks > 0 &&
