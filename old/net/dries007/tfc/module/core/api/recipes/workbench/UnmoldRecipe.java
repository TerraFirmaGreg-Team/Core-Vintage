package net.dries007.tfc.module.core.api.recipes.workbench;
...
public class UnmoldRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    ...
    public boolean matches(@Nonnull InventoryCrafting inv, @Nonnull World world) {
        for (var slotId = 0; slotId < inv.getSizeInventory(); slotId++) {
            ...
            var fluidHandler = stack.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, null);
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        for (var slotId = 0; slotId < inv.getSizeInventory(); slotId++) {
            ...
            var capability = (IMoldHandler) stack.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, null);
