                        ...
                        for (int width = -tz; width <= tz; width++) {
                            ...
                            for (int y = -depth; y <= +depth; y++) {
                                ...
                                if (BlockUtils.isSoilOrGravel(current) || BlockUtils.isRawStone(current)) {
                                    world.setBlockState(pos, BlocksRock.SAND.get(ProviderChunkData.getRockHeight(world, pos)).getDefaultState(), 2);
                                }
                            }
                        }
                    }
                        ...
                        for (int width = -tz; width <= tz; width++) {
                            ...
                            for (int y = -depth; y <= +depth; y++) {
                                ...
                                if (BlockUtils.isGrass(current)) {
                                    world.setBlockState(pos, BlocksSoil.PODZOL.get(ProviderChunkData.getSoilHeight(world, pos))
                                            .getDefaultState(), 2);
                        ...
                        for (int width = -tz; width <= tz; width++) {
                            ...
                            for (int y = -depth; y <= +depth; y++) {
                                ...
                                if (BlockUtils.isDirt(current)) {
                                    world.setBlockState(pos, BlocksSoil.MUD.get(ProviderChunkData.getSoilHeight(world, pos)).getDefaultState(), 2);
