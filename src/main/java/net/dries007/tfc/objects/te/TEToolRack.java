...
public class TEToolRack extends TEBase {
    ...
    public static boolean isItemEligible(@Nullable ItemStack stack) {
        ...
        return item instanceof ItemMetalTool || item instanceof ItemTool || item instanceof ItemBow || item instanceof ItemHoe ||
                item instanceof ItemSword || item instanceof ItemFireStarter || item instanceof ItemFlintAndSteel || !item
