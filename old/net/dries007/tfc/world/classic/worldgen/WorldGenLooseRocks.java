...
public class WorldGenLooseRocks implements IWorldGenerator {
    ...
    protected void generateRock(Random random, World world, BlockPos pos, RockType type) {
        ...
        if (world.isAirBlock(pos) &&
            ...
            world.setBlockState(pos, StorageRock.getRockBlock(RockBlockVariants.LOOSE_ROCK, type).getDefaultState().withProperty(BlockRockLoose.AXIS, EnumFacing.byHorizontalIndex(random.nextInt(4))), 2);
        }
    }
}
