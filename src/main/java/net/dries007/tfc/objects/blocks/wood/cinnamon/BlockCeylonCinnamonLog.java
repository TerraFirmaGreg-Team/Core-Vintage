...
public class BlockCeylonCinnamonLog extends Block {
        ...
        for (EnumFacing d : EnumFacing.HORIZONTALS) {
          if (world.getBlockState(checkPos.offset(d)).getBlock() instanceof BlockCeylonCinnamonLeaves) {
            ...
            if (world.getBlockState(checkPos.offset(d, 2))
                     .getBlock() instanceof BlockCeylonCinnamonLeaves) {
              leafCount++;
  ...
  public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
    ...
    boolean shouldDestroy = !(downState.getBlock() instanceof BlockCeylonCinnamonLog) && !BlockHelper.isGrowableSoil(downState);
    if (shouldDestroy) {
