...
public class ModuleDevice extends ModuleBase {
    ...
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleDevice.class.getSimpleName());


    public ModuleDevice() {
        super(0, Tags.MOD_ID);

        this.setRegistry(new Registry(Tags.MOD_ID, DEVICES_TAB));
