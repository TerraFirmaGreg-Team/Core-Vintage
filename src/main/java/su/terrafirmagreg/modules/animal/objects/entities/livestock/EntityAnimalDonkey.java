...
public class EntityAnimalDonkey extends EntityDonkey implements IAnimal, ILivestock, IRidable {
    ...
    private static final DataParameter<Long> PREGNANT_TIME = EntityDataManager.createKey(EntityAnimalDonkey.class, DataSerializers.LONG);
    ...
    public EntityAnimalDonkey(World world) {
        this(world, Gender.valueOf(RNG.nextBoolean()),
                EntityAnimalBase.getRandomGrowth(ConfigAnimal.ENTITIES.DONKEY.adulthood, ConfigAnimal.ENTITIES.DONKEY.elder));
    }
