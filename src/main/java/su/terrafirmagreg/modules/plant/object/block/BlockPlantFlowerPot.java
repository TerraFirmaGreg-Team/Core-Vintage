...
@Getter
public class BlockPlantFlowerPot extends BaseBlock implements IPlantBlock {

  protected static final AxisAlignedBB FLOWER_POT_AABB = new AxisAlignedBB(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.375D, 0.6875D);

  protected final PlantType type;
  protected final PlantBlockVariant variant;

  public BlockPlantFlowerPot(PlantBlockVariant variant, PlantType type) {
  ...
  public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
    drops.clear();
    drops.add(new ItemStack(BlocksPlant.PLANT.get(type)));
