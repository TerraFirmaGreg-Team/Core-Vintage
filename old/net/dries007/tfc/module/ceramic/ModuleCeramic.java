...
public class ModuleCeramic extends ModuleBase {
    ...
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModuleCeramic.class.getSimpleName());

    public ModuleCeramic() {
        super(0, Tags.MOD_ID);

        this.setRegistry(new Registry(Tags.MOD_ID, POTTERY_TAB));
