...
import static su.terrafirmagreg.modules.device.object.block.BlockFreezeDryer.FACING;

public class TileFreezeDryer extends TEInventory implements IItemHandlerSidedCallback, ITickable {
  ...
  public boolean canInsert(int i, ItemStack itemStack, EnumFacing enumFacing) {
    ...
    return (itemStack.getItem() != ModItems.SEA_ICE_SHARD &&
