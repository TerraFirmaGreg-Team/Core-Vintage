package net.dries007.tfc.module.core.api.recipes.heat;
...
public abstract class HeatRecipe extends IForgeRegistryEntry.Impl<HeatRecipe> implements IJEISimpleRecipe {
    ...
    public static HeatRecipe get(ItemStack stack, int tier) {
        return RegistryCore.HEAT.getValuesCollection().stream().filter(r -> r.isValidInput(stack, tier)).findFirst().orElse(null);
    }
