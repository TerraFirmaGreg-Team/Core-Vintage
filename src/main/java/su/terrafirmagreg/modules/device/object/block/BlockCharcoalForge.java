...
public class BlockCharcoalForge extends Block implements IBellowsConsumerBlock, ILightableBlock {
  ...
  public void onAirIntake(World world, BlockPos pos, int airAmount) {
    TileCharcoalForge teForge = Helpers.getTE(world, pos, TileCharcoalForge.class);
    if (teForge != null) {
  ...
  public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
    TileCharcoalForge te = Helpers.getTE(worldIn, pos, TileCharcoalForge.class);
  ...
  public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random rng) {
    if (state.getValue(LIT)) {
      ...
      if (rng.nextInt(3) == 1) {world.spawnParticle(EnumParticleTypes.LAVA, x + rng.nextFloat() - 0.5, y, z + rng.nextFloat() - 0.5, 0.0D, 0.2D, 0.0D);}
    }
  }
