...
public class ItemKaoliniteMoldTFCE extends ItemPottery {
    ...
    public ItemKaoliniteMoldTFCE(ItemMetalTFCE.ItemType type, int fluidCapacity) {
        this.type = type;
    ...
    public static ItemKaoliniteMoldTFCE get(ItemMetalTFCE.ItemType category) {
        ...
        if (!world.isRemote) {
            ...
            if (player.isSneaking()) {
                ...
                for (IRecipe recipe : ForgeRegistries.RECIPES.getValuesCollection()) {
                    if (recipe instanceof UnmoldRecipeKaolinite && recipe.matches(craftMatrix, world)) {
                        ItemStack result = recipe.getCraftingResult(craftMatrix);
                        if (!result.isEmpty()) {
                            ItemStack moldResult = ((UnmoldRecipeKaolinite) recipe).getMoldResult(stack);
