...
public interface ICalendarTickable {
  ...
  /**
   * Here we check every tick for a calendar discrepancy. This only checks for differences in player time, and calls
   * {@link ICalendarTickable#onCalendarUpdate(long playerTickDelta)} as necessary
   * <p>
  ...
  /**
   * Gets the last update tick. This should use a locally cached value. No need for serialization
   */
