...
public class ArmorMaterialTFC implements IArmorMaterialTFC {
  ...
  public static final IArmorMaterialTFC QUIVER = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("quiver", MODID_TFC + ":quiver", 10, new int[]{0, 0, 0, 0}, 9, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
    0, 0, 0f);
  public static final IArmorMaterialTFC COPPER = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("copper", MODID_TFC + ":copper", 14, new int[]{1, 3, 4, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    10, 10, 6.25f);
  public static final IArmorMaterialTFC BISMUTH_BRONZE = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("bismuth_bronze", MODID_TFC + ":bismuth_bronze", 21, new int[]{1, 4, 4, 1}, 9,
                                SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), 15, 10, 8.25f);
  public static final IArmorMaterialTFC BLACK_BRONZE = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("black_bronze", MODID_TFC + ":black_bronze", 21, new int[]{1, 4, 4, 1}, 9,
                                SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), 10, 15, 8.25f);
  public static final IArmorMaterialTFC BRONZE = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("bronze", MODID_TFC + ":bronze", 21, new int[]{1, 4, 4, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
    12.5f, 12.5f, 8.25f);
  public static final IArmorMaterialTFC WROUGHT_IRON = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("wrought_iron", MODID_TFC + ":wrought_iron", 33, new int[]{1, 4, 5, 2}, 12,
                                SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), 20, 20, 13.2f);
  public static final IArmorMaterialTFC STEEL = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("steel", MODID_TFC + ":steel", 40, new int[]{2, 5, 6, 2}, 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), 25,
    30, 16.5f);
  public static final IArmorMaterialTFC BLACK_STEEL = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("black_steel", MODID_TFC + ":black_steel", 50, new int[]{2, 5, 6, 2}, 17,
                                SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), 50, 45, 33);
  public static final IArmorMaterialTFC BLUE_STEEL = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("blue_steel", MODID_TFC + ":blue_steel", 68, new int[]{3, 6, 8, 3}, 23, SoundEvents.ITEM_ARMOR_EQUIP_IRON,
                                2.0F), 62.5f, 50, 50);
  ...
  public static final IArmorMaterialTFC SNOW_SHOES_MATERIAL = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("snow_shoes", "tfcthings:snow_shoes", 14, new int[]{1, 0, 0, 0}, 9, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F), 5.0F, 5.0F,
    10.0F);

  public static final IArmorMaterialTFC HIKING_BOOTS_MATERIAL = new ArmorMaterialTFC(
    EnumHelper.addArmorMaterial("hiking_boots", "tfcthings:hiking_boots", 28, new int[]{1, 0, 0, 0}, 9, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F), 5.0F, 5.0F,
    10.0F);
