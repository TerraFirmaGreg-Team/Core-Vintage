...
public final class ConfigTFC {
    ...
    public static final class General {
        ...
        public static final class DebugCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.debug.enable")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.debug.debugWorldGenDanger")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.debug.debugWorldGenSafe")
            @Config.RequiresWorldRestart
        ...
        public static final class OverridesCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.enableTorchOverride")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.enableFrozenOverrides")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.torchTime")
            public int torchTime = 72000;

            @Config.Comment("Overrides lava and water making vanilla stones to TFC variants.")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.enableLavaWaterPlacesTFCBlocks")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.forceTFCWorldType")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.removeVanillaRecipes")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.removeVanillaLoots")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.forceNoVanillaNaturalRegeneration")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.overrides.forceReplaceVanillaAnimals")
        ...
        public static final class DifficultyCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.difficulty.animalSpawnCount")
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.difficulty.mobSpawnCount")
            public int mobSpawnCount = 140;

            @Config.Comment("Prevent mob spawning on surface?")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.difficulty.preventMobsOnSurface")
            public boolean preventMobsOnSurface = true;

            @Config.Comment("Give wrought iron weapons to vanilla mobs?")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.difficulty.giveVanillaMobsEquipment")
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.difficulty.acceptableAnvilRange")
        ...
        public static final class TreeCFG {
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.tree.leafStickDropChanceBonus")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.tree.leafStickDropChanceBonusClasses")
        ...
        public static final class SpawnProtectionCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.preventMobs")
            public boolean preventMobs = true;

            @Config.Comment("Should living in a chunk prevent predators spawning over time?")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.preventPredators")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.minYMobs")
            ...
            @Config.RangeInt(min = 1, max = 255)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.maxYMobs")
            ...
            @Config.RangeInt(min = 1, max = 255)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.minYPredators")
            ...
            @Config.RangeInt(min = 1, max = 255)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.spawn_protection.maxYPredators")
        ...
        public static final class DamageCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.slashingSources")
            public String[] slashingSources = new String[]{};

            @Config.Comment("Damage Source Types that will default to Piercing damage.")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.piercingSources")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.crushingSources")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.slashingEntities")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.piercingEntities")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.damage.crushingEntities")
        ...
        public static final class PlayerCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.inventoryCraftingMode")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.minHealthModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.maxHealthModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.thirstModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.naturalRegenerationModifier")
            @Config.RangeDouble(min = 0, max = 100)
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.peacefulDifficultyPassiveRegeneration")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.passiveExhaustionMultiplier")
            @Config.RangeDouble(min = 0, max = 100)
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.nutritionRotationHungerWindow")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.drinkDelay")
            @Config.RangeInt(min = 1)
            public int drinkDelay = 12;

            @Config.Comment("Chance that a salty drink apply a thirst effect")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.chanceThirstOnSaltyDrink")
            @Config.RangeDouble(min = 0, max = 1)
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.player.quiverSearch")
        ...
        public static final class WorldCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.hemisphereType")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.temperatureMode")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.latitudeTemperatureModifier")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.clayRarity")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.clayRainfallThreshold")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.looseRocksFrequency")
            public int looseRocksFrequency = 12;

            @Config.Comment("Enable generation of loose rocks (just the rocks)?")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.enableLooseRocks")
            public boolean enableLooseRocks = true;

            @Config.Comment("Enable generation of loose rocks (just the rocks)?")
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.enableLooseSticks")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.sticksDensityModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.rainfallSpreadFactor")
            ...
            @Config.Comment({"This controls how spread the flora diversity distribution is. Higher values means the world will be distributed towards the extremes more, making forests have much more different kinds of trees.",
                    "WARNING: This can cause very weird world generation conditions."})
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.floraDiversitySpreadFactor")
            ...
            @Config.Comment({"This controls how spread the flora density distribution is. Higher values means the world will be distributed towards the extremes more, making more dense forest pockets.",
                    "WARNING: This can cause very weird world generation conditions."})
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.floraDensitySpreadFactor")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.world.respawnableCreatures")
        ...
        public static final class FoodCFG {
            ...
            @Config.RangeDouble(min = 0, max = 10)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.food.decayModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.food.decayStackTime")
            ...
            @Config.RangeDouble(min = 0.01, max = 100)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.food.fruitTreeGrowthTimeModifier")
        ...
        public static final class MiscCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.defaultMonthLength")
            @Config.RangeInt(min = 1)
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.plantGrowthRate")
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.leafMovementModifier")
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.berryBushMovementModifier")
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.snowMovementModifier")
            ...
            @Config.RangeDouble(min = 0, max = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.minimumPlantMovementModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.pluckableEntities")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.damagePerFeather")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".general.misc.rockMiningTimeModifier")
    ...
    public static final class Devices {
        ...
        public static final class TemperatureCFG {
            ...
            @Config.RangeDouble(min = 0, max = 10)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.temperature.globalModifier")
            ...
            @Config.RangeDouble(min = 0, max = 10)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.temperature.heatingModifier")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.temperature.coolHeatablesInWorld")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.temperature.ticksBeforeAttemptToCool")
        ...
        public static final class BarrelCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.barrel.tank")
            public int tank = 10_000;

            @Config.Comment("List of fluids allowed to be inserted into a barrel.")
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.barrel.fluidWhitelist")
        ...
        public static final class BlastFurnaceCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.blast_furnace.consumption")
        ...
        public static final class BloomeryCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.bloomery.ticks")
        ...
        public static final class CrucibleCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.crucible.tank")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.crucible.enableAllSlots")
            public boolean enableAllSlots = false;

            @Config.Comment("How fast should crucibles accept fluids from molds / small vessel?")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.crucible.pouringSpeed")
        ...
        public static final class CharcoalPitCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.charcoal_pit.ticks")
            public int ticks = 18_000;

            @Config.Comment("Can charcoal pits take glass (or stained glass) as a valid cover block?")
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.charcoal_pit.glass")
        ...
        public static final class CharcoalForgeCFG {
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.charcoal_forge.rainTicks")
        ...
        public static final class FirePitCFG {
            ...
            @Config.RangeInt(min = 20)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.fire_pit.ticks")
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.fire_pit.rainTicks")
        ...
        public static final class PitKilnCFG {
            ...
            @Config.RangeInt(min = 20)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.pit_kiln.ticks")
        ...
        public static final class LampCFG {
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.lamp.tank")
            public int tank = 250;
        ...
        public static final class ChiselCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.chisel.requireHammerInOffHand")
        ...
        public static final class SmallVesselCFG {
            ...
            @Config.RangeInt(min = 100, max = Alloy.SAFE_MAX_ALLOY)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.small_vessel.tank")
        ...
        public static final class JugCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.jug.dumpWaterOnShiftRightClick")
        ...
        public static final class BellowsCFG {
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".devices.bellows.maxTicks")
    ...
    public static class Client {
        ...
        public static final class TooltipCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.tooltip.showOreDictionaryTooltip")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.tooltip.propickOutputToActionBar")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.tooltip.anvilWeldOutputToActionBar")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.tooltip.vesselOutputToActionBar")
        ...
        public static final class DisplayCFG {
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.display.healthDisplayFormat")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.display.useVanillaHealth")
            public boolean useVanillaHealth = false;

            @Config.Comment({"Disable TFC hunger bar and use vanilla instead?"})
            @Config.LangKey("config." + Tags.MOD_ID + ".client.display.useVanillaHunger")
            public boolean useVanillaHunger = false;

            @Config.Comment({"Hide the thirst bar?"})
            @Config.LangKey("config." + Tags.MOD_ID + ".client.display.hideThirstBar")
            ...
            @Config.LangKey("config." + Tags.MOD_ID + ".client.display.rottenFoodOverlayColor")
    ...
    public static final class Animals {
        ...
        public static final class AlpacaCFG {
            ...
            @Config.RangeInt(min = 0)
            @Config.LangKey("config." + Tags.MOD_ID + ".animals.rarity")
        ...
        public static final class CowCFG {
            ...
            @Config.RangeInt(min = 1_000)
            @Config.LangKey("config." + Tags.MOD_ID + ".animals.milkTicks")
        ...
        public static final class ChickenCFG {
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + Tags.MOD_ID + ".animals.hatch")
            public int hatch = 8;

            @Config.Comment("How many ticks it is needed for this animal to lay eggs?")
            @Config.RangeInt(min = 1_000)
            @Config.LangKey("config." + Tags.MOD_ID + ".animals.eggTicks")
        ...
        public static final class OcelotCFG {
            ...
            @Config.Comment({"This controls which registered entities will be hunted by this animal (unless tamed), in priority order.",
                    ...
                    "Invalid entries will be ignored."})
            @Config.LangKey("config." + Tags.MOD_ID + ".animals.huntCreatures")
