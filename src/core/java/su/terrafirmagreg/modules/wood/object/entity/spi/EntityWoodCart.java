...
public abstract class EntityWoodCart extends BaseEntity implements IEntityAdditionalSpawnData {
    ...
    if (this.pulling == null || entityIn == null) {
      if (!this.world.isRemote) {
        if (entityIn == null) {
          ...
          ((WorldServer) this.world).getEntityTracker().sendToTracking(this, new SCPacketDrawnUpdate(-1, this.getEntityId()).getPacketFrom());
        } else {
          ...
          ((WorldServer) this.world).getEntityTracker().sendToTracking(this, new SCPacketDrawnUpdate(entityIn.getEntityId(), this.getEntityId()).getPacketFrom());
  ...
  public WoodType getWood() {
    ...
    return WoodType.getTypes().stream()
      ...
      .findFirst().orElse(WoodTypes.ACACIA);
  }
