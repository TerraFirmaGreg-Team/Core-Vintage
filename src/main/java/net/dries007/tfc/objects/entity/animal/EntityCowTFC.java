...
public class EntityCowTFC extends EntityAnimalMammal implements ILivestock {
  ...
  public TextComponentTranslation getTooltip() {
    if (getGender() == Gender.MALE) {
      return new TextComponentTranslation(TFC + ".tooltip.animal.product.male_milk");
      ...
      return new TextComponentTranslation(TFC + ".tooltip.animal.product.no_milk", getAnimalName());
    }
    return null;
  }
