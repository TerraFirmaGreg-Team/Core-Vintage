...
public class TEFirePit extends TETickableInventory
                    ...
                    if (temperature < COOKING_POT_BOILING_TEMPERATURE) {
                        ...
                        if (boilingTicks > ConfigTFC.Devices.FIRE_PIT.ticks) {
                            ...
                            if (ingredientCount > 0) {
                                ...
                                soupContents = new FoodData(4, water, saturation, nutrition, Food.SOUP_GRAIN.getData()
                                        .getDecayModifier());
            ...
            case SLOT_EXTRA_INPUT_START + 4:
                ...
                if (attachment == BlockFirePit.FirePitAttachment.COOKING_POT) {
                    ...
                    return stack.hasCapability(CapabilityFood.CAPABILITY, null) &&
                            Food.Category.doesStackMatchCategories(stack, Food.Category.FRUIT, Food.Category.VEGETABLE, Food.Category.COOKED_MEAT,
                                    Food.Category.MEAT);
                } else if (attachment == BlockFirePit.FirePitAttachment.GRILL) {
