    ...
    for (int zz = 0; zz < zSize; ++zz) {
      for (int xx = 0; xx < xSize; ++xx) {
        ...
        if (thisID == highHillsID) {
          if (zn == highHillsID && xp == highHillsID && xn == highHillsID && zp == highHillsID) {outCache[xx + zz * xSize] = thisID;} else {
            outCache[xx + zz * xSize] = highHillsEdgeID;
          }
        } else if (thisID == mountainsID) {
          if (zn == mountainsID && xp == mountainsID && xn == mountainsID && zp == mountainsID) {outCache[xx + zz * xSize] = thisID;} else {
            outCache[xx + zz * xSize] = mountainsEdgeID;
          }
        } else if (thisID == swamplandID) {
          if (zn == swamplandID && xp == swamplandID && xn == swamplandID && zp == swamplandID) {outCache[xx + zz * xSize] = thisID;} else {
            outCache[xx + zz * xSize] = plainsID;
          }
        } else if (thisID == highPlainsID) {
          if (zn == highPlainsID && xp == highPlainsID && xn == highPlainsID && zp == highPlainsID) {outCache[xx + zz * xSize] = thisID;} else {
            outCache[xx + zz * xSize] = plainsID;
          }
        } else {
