package com.speeedcraft.tfgmod.gregtech.items.tools.behaviors;

import com.speeedcraft.tfgmod.gregtech.items.tools.TFGToolHelper;
...
public class ChiselBehavior implements IToolBehavior {
	...
	public static boolean hasHammerForChisel(EntityPlayer player) {
		...
		if (OreDictionaryHelper.doesStackMatchOre(player.inventory.offHandInventory.get(0), "toolHammer"))
			return true;
