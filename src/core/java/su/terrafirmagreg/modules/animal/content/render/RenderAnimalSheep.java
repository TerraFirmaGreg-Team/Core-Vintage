...
import su.terrafirmagreg.modules.animal.content.model.ModelAnimalSheepBody;
import su.terrafirmagreg.modules.animal.content.model.ModelAnimalSheepWool;
...
public class RenderAnimalSheep extends RenderAnimal<EntityAnimalSheep> {
  ...
  private static final ResourceLocation SHEEP_YOUNG = ModUtils.resource("textures/entity/animal/livestock/sheep_young.png");
  private static final ResourceLocation SHEEP_OLD = ModUtils.resource("textures/entity/animal/livestock/sheep_old.png");
  ...
  @SideOnly(Side.CLIENT)
  public static class LayerSheepWool implements LayerRenderer<EntityAnimalSheep> {
