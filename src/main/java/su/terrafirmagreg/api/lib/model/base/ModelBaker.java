...
public class ModelBaker {
    ...
    public ModelBaker putQuad(float offsetX, float offsetY, float offsetZ, float scaleX, float scaleY, float scaleZ, float uMin, float uMax,
    ...
    public ModelBaker putTexturedCube(float offsetX, float offsetY, float offsetZ, float size) {
        ...
        putCube(offsetX, offsetY, offsetZ, size, texture.getMinU(), texture.getMaxU(), texture.getMinV(), texture.getMaxV());
        return this;
    }
    ...
    public ModelBaker putCube(float offsetX, float offsetY, float offsetZ, float scaleX, float scaleY, float scaleZ, float uMin, float uMax,
                              float vMin, float vMax) {
        for (EnumFacing facing : EnumFacing.values()) putQuad(offsetX, offsetY, offsetZ, scaleX, scaleY, scaleZ, uMin, uMax, vMin, vMax, facing);
        return this;
    }
