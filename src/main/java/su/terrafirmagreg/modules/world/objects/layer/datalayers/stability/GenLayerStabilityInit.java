package su.terrafirmagreg.modules.world.objects.layer.datalayers.stability;
    ...
    public int[] getInts(int par1, int par2, int maxX, int maxZ) {
        ...
        for (int z = 0; z < maxZ; ++z) {
            for (int x = 0; x < maxX; ++x) {
                ...
                cache[x + z * maxX] = this.nextInt(3) == 0 ? DataLayerClassic.SEISMIC_UNSTABLE.layerID : DataLayerClassic.SEISMIC_STABLE.layerID;
            }
        }
