...
public class Alloy implements INBTSerializable<NBTTagCompound> {
  ...
  /**
   * Add metal to an alloy from an item stack, ignoring temperature and tier Note if the an item doesn't match a recipe it will be ignored
   *
  ...
  /**
   * Add metal to an alloy from an item stack Note if the an item doesn't match a heat recipe it will be ignored
   *
   * @param stack       an item stack
  ...
  /**
   * Copy the contents of one alloy into another Does not modify the other alloy
   *
  ...
  /**
   * Removes an amount of the current result from the alloy Use {@link Alloy#getResult()} to see what alloy has been removed / returned
   *
