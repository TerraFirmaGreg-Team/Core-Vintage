...
public class RenderAnimalPig extends RenderAnimal<EntityAnimalPig> {
    ...
    private static final ResourceLocation PIG_YOUNG = ModUtils.resource("textures/entity/animal/livestock/pig_young.png");
    private static final ResourceLocation PIG_OLD = ModUtils.resource("textures/entity/animal/livestock/pig_old.png");
