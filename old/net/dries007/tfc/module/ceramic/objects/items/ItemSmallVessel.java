            ...
            if (cap instanceof ISmallVesselHandler) {
                ...
                switch (mode) {
                    ...
                    case LIQUID_MOLTEN:
                        ...
                        break;
                    case LIQUID_SOLID:
                        ModuleCoreOld.PACKET_SERVICE.sendTo(SCPacketSimpleMessage.translateMessage(MessageCategory.VESSEL, Tags.MOD_ID + ".vessel.liquid_solid"), (EntityPlayerMP) playerIn);
                        break;
                }
            }
        }
