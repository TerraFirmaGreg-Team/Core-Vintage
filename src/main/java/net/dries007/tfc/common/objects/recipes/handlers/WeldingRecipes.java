...
public class WeldingRecipes {
    ...
    public static void register() {
        ...
        for (var material : GregTechAPI.materialManager.getRegistry("gregtech")) {
            if (material.hasProperty(TFGPropertyKey.HEAT) && !material.hasFlag(TFGMaterialFlags.UNUSABLE)) {
                ...
                registry.register(new WeldingRecipe(
                        Helpers.getID("plate_" + material.getName()),
                ...
                registry.register(new WeldingRecipe(
                        Helpers.getID("double_plate_" + material.getName()),
                ...
                registry.register(new WeldingRecipe(
                        Helpers.getID("triple_plate_" + material.getName()),
        ...
        registry.register(new WeldingRecipe(
                Helpers.getID("high_carbon_black_steel"),
        ...
        registry.register(new WeldingRecipe(
                Helpers.getID("high_carbon_blue_steel"),
        ...
        registry.register(new WeldingRecipe(
                Helpers.getID("high_carbon_red_steel"),
