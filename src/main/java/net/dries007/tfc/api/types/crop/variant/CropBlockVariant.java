...
public class CropBlockVariant {
    ...
    @Nonnull
    private final Function<CropType, ICropBlock> factory;

    /**
     * Создает экземпляр класса CropBlockVariant с указанными параметрами.
     *
     * @param name    Имя варианта блока культур.
     * @param factory Фабричная функция для создания блока культур.
     */
    public CropBlockVariant(@Nonnull String name, @Nonnull Function<CropType, ICropBlock> factory) {
        this.name = name;
    ...
    /**
     * Возвращает набор всех вариантов блока культур.
     *
     * @return Набор всех вариантов блока культур.
     */
