...
public class StructureGenerator extends WorldGenerator {
	...
	public static boolean checkBiome(Template template, World world, BlockPos pos) {
		...
		if ((world.getBlockState(x1).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x1)
		                                                                                      .getBlock() == ChunkGenTFC.SALT_WATER.getBlock() || world.getBlockState(x1)
		                                                                                                                                               .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b1 == BiomesTFC.OCEAN || b1 == BiomesTFC.DEEP_OCEAN || b1 == BiomesTFC.LAKE || b1 == BiomesTFC.RIVER || b1 == BiomesTFC.BEACH || b1 == BiomesTFC.GRAVEL_BEACH) ||
				(world.getBlockState(x2).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x2)
				                                                                                  .getBlock() == ChunkGenTFC.SALT_WATER.getBlock() || world.getBlockState(x2)
				                                                                                                                                           .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b2 == BiomesTFC.OCEAN || b2 == BiomesTFC.DEEP_OCEAN || b2 == BiomesTFC.LAKE || b2 == BiomesTFC.RIVER || b2 == BiomesTFC.BEACH || b2 == BiomesTFC.GRAVEL_BEACH) ||
				(world.getBlockState(x3).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x3)
				                                                                                  .getBlock() == ChunkGenTFC.SALT_WATER.getBlock() || world.getBlockState(x3)
				                                                                                                                                           .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b3 == BiomesTFC.OCEAN || b3 == BiomesTFC.DEEP_OCEAN || b3 == BiomesTFC.LAKE || b3 == BiomesTFC.RIVER || b3 == BiomesTFC.BEACH || b3 == BiomesTFC.GRAVEL_BEACH))
			return false;
							...
							for (Plant plant : TFCRegistries.PLANTS.getValuesCollection()) {
								if (world.getBlockState(new BlockPos(posX, posY, posZ)).getBlock() == Blocks.AIR ||
									...
									if (BlocksTFC.isSand(current)) {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariant.get(ChunkDataTFC.getRockHeight(world, position), Rock.Type.SAND)
										                                                                    .getDefaultState(), 2);
									} else if (BlocksTFC.isDirt(current) || BlocksTFCF.isDirt(current)) {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariant.get(ChunkDataTFC.getRockHeight(world, position), Rock.Type.DIRT)
										                                                                    .getDefaultState(), 2);
									} else if (BlocksTFC.isDryGrass(current)) {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariant.get(ChunkDataTFC.getRockHeight(world, position), Rock.Type.DRY_GRASS)
										                                                                    .getDefaultState(), 2);
									} else if (BlocksTFC.isGrass(current) || BlocksTFCF.isGrass(current)) {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariant.get(ChunkDataTFC.getRockHeight(world, position), Rock.Type.GRASS)
										                                                                    .getDefaultState(), 2);
									} else if (BlocksTFCF.isSparseGrass(current)) {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariantTFCF.get(ChunkDataTFC.getRockHeight(world, position), RockTFCF.SPARSE_GRASS)
										                                                                        .getDefaultState(), 2);
									} else {
										world.setBlockState(new BlockPos(posX, posY, posZ), BlockRockVariant.get(ChunkDataTFC.getRockHeight(world, position), Rock.Type.DIRT)
										                                                                    .getDefaultState(), 2);
