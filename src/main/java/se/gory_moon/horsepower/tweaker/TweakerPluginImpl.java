...
public class TweakerPluginImpl implements ITweakerPlugin {
	...
	public static ShapedChoppingRecipe convert(CTShapedChoppingRecipe recipe, ResourceLocation name) {
		...
		return new ShapedChoppingRecipe(name, Lists.newArrayList(getItemStacks(recipe.getOre()
		                                                                             .getItems())), (ItemStack) recipe.getOutput()
	...
	public static ShapelessChoppingRecipe convert(CTShapelessChoppingRecipe recipe, ResourceLocation name) {
		...
		return new ShapelessChoppingRecipe(name, Lists.newArrayList(getItemStacks(recipe.getOre()
		                                                                                .getItems())), (ItemStack) recipe.getOutput()
		                                                                                                                 .getInternal(), items);
	}
	...
	private static class AddShapedChoppingRecipe implements IAction {
		...
		public void apply() {
			...
			IRecipe recipe = convert(ctRecipe, new ResourceLocation(MODID_HORSEPOWER, name));

			recipe.setRegistryName(new ResourceLocation(MODID_HORSEPOWER, this.name));
