...
public class TextComponents {
  ...
  /**
   * Creates a new {@link TextComponentBuilder} around the given block state's name.
   */
  ...
  /**
   * Creates a new {@link TextComponentBuilder} around the given item stack's display name. The display name includes any custom name.
   */
  ...
  /**
   * Creates a new {@link TextComponentBuilder} around the given fluid stack's display name.
   */
  ...
  /**
   * Creates a new {@link TextComponentBuilder} around the given entity's display name. The display name includes custom names.
   */
  ...
  /**
   * Converts the dimension registry name to a capitalized name and creates a new {@link TextComponentBuilder} around it.
   */
  public static TextComponentBuilder dimension(DimensionType dimension) {
    ...
    for (int i = 0; i < dimensionName.length() - 1; i++) {
      if (dimensionName.charAt(i) == '_' && Character.isAlphabetic(dimensionName.charAt(i + 1))) {
        dimensionName =
          dimensionName.substring(0, i) + ' ' + (i + 2 < dimensionName.length() ? dimensionName.substring(i + 1, i + 2).toUpperCase() + dimensionName.substring(
            i + 2) : dimensionName.substring(i + 1).toUpperCase());
      }
    }
  ...
  public static class TextComponentBuilder {
    ...
    /**
     * Appends the given string to the text component and returns a new {@link TextComponentBuilder} for the given string.
     *
    ...
    /**
     * Appends the given translation to the text component and returns a new {@link TextComponentBuilder} for the given translation.
     *
