...
import su.terrafirmagreg.modules.rock.objects.containers.ContainerRockAnvil;
...
public class TileRockAnvil
  ...
  @Override
  public ContainerRockAnvil getContainer(InventoryPlayer inventoryPlayer, World world,
      IBlockState state, BlockPos pos) {
    return new ContainerRockAnvil(inventoryPlayer, this);
  }

  @Override
  public GuiRockAnvil getGuiContainer(InventoryPlayer inventoryPlayer, World world,
      IBlockState state, BlockPos pos) {
    return new GuiRockAnvil(getContainer(inventoryPlayer, world, state, pos), inventoryPlayer,
        this);
  }
