...
public class BlockPlantCaveMushroom extends BlockPlantMushroom implements IGrowable, ICapabilitySize {
...
//  ArrayList<PotionEffectToHave> PotionEffects = new ArrayList<PotionEffectToHave>();
  ...
  public BlockPlantCaveMushroom(FloraBlockVariant variant, FloraType type) {
    super(variant, type);
...
//    }
  ...
  protected BlockStateContainer createPlantBlockState() {
    return new BlockStateContainer(this, STAGE, DOWN, UP, NORTH, EAST, WEST, SOUTH, DAYPERIOD, AGE_4);
  }
