...
import su.terrafirmagreg.modules.animal.content.entity.predator.EntityAnimalJackal;
...
/**
 * ModelJackalTFC Created using Tabula 7.1.0
 */

@SideOnly(Side.CLIENT)

public class ModelAnimalJackal extends ModelBase {
  ...
  public void render(@NotNull Entity entity, float par2, float par3, float par4, float par5,
    ...
    EntityAnimalJackal jackal = ((EntityAnimalJackal) entity);
