...
public class ModModelManager {
  ...
  public static void onModelBake(ModelBakeEvent event) {
    ...
    event.getModelRegistry()
      .putObject(getModel("chopper"), event.getModelRegistry().getObject(new ModelResourceLocation("horsepower:chopper", "facing=north,part=base")));
    event.getModelRegistry()
      .putObject(getModel("chopper"), event.getModelRegistry().getObject(new ModelResourceLocation("horsepower:chopper", "facing=south,part=base")));
    event.getModelRegistry()
      .putObject(getModel("chopper"), event.getModelRegistry().getObject(new ModelResourceLocation("horsepower:chopper", "facing=west,part=base")));
    event.getModelRegistry()
      .putObject(getModel("chopper"), event.getModelRegistry().getObject(new ModelResourceLocation("horsepower:chopper", "facing=east,part=base")));
