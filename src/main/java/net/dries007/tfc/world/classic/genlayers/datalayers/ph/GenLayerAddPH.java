    ...
    for (int var11 = 0; var11 < zSize; ++var11) {
      for (int var12 = 0; var12 < xSize; ++var12) {
        ...
        if (id0 > thisID || id1 > thisID || id2 > thisID || id3 > thisID) {
          ...
          if (this.nextInt(3) == 0 && outID <= GenPHLayer.MAX) {outCache[var12 + var11 * xSize] = outID;} else {outCache[var12 + var11 * xSize] = thisID;}
          ...
          if (this.nextInt(3) == 0 && outID >= GenPHLayer.MIN) {outCache[var12 + var11 * xSize] = outID;} else {outCache[var12 + var11 * xSize] = thisID;}
        } else {
