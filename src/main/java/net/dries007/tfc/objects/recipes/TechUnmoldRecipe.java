...
public class TechUnmoldRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
  ...
  public TechUnmoldRecipe(ResourceLocation group, NonNullList<Ingredient> input, @Nonnull ItemTechMetal.ItemType type, float chance) {
    this.group = group;
    this.input = input;
    this.type = type;
    this.chance = chance;
  ...
  public static class Factory implements IRecipeFactory {
    ...
    public IRecipe parse(final JsonContext context, final JsonObject json) {
      ...
      return new TechUnmoldRecipe(group.isEmpty() ? new ResourceLocation(result) : new ResourceLocation(group), ingredients, type, chance);
    }
  }
}
