...
import net.dries007.tfc.module.animal.client.model.ModelAnimalMuskOxWool;
import net.dries007.tfc.module.animal.common.entity.livestock.EntityAnimalMuskOx;
...
public class LayerMuskOxWool implements LayerRenderer<EntityAnimalMuskOx> {
    ...
    @Override
    public void doRenderLayer(EntityAnimalMuskOx muskox, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
