...
import su.terrafirmagreg.modules.animal.content.entity.predator.EntityAnimalCoyote;
...
/**
 * ModelCoyoteTFC Created using Tabula 7.1.0
 */

@SideOnly(Side.CLIENT)

public class ModelAnimalCoyote extends ModelBase {
  ...
  public ModelAnimalCoyote() {
    ...
    leftEar.mirror = true;
    leftEar.setRotationPoint(2.2F, -0.2F, -0.5F);
    leftEar.addBox(-2.0F, -3.0F, -2.0F, 2, 2, 1, 0.0F);
    ...
    neckMane1 = new ModelRenderer(this, 41, 17);
    ...
    neckMane2 = new ModelRenderer(this, 38, 9);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5,
    ...
    setRotateAngle(neck, f4 / (1.5F * (180F / MathUtils.PI)) + -((float) Math.PI / 4F),
    ...
    frontLLegTop.rotateAngleX =
      MathHelper.cos(f * 0.4862F + MathUtils.PI) * 0.8F * f1 + 0.13962634015954636F;
