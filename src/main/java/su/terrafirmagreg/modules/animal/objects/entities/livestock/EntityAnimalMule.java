...
public class EntityAnimalMule extends EntityMule implements IAnimal, ILivestock, IRidable {
	...
	private static final DataParameter<Boolean> GENDER = EntityDataManager.createKey(EntityAnimalMule.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(EntityAnimalMule.class, DataSerializers.VARINT);
	private static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(EntityAnimalMule.class, DataSerializers.FLOAT);
	private static final DataParameter<Boolean> HALTER = EntityDataManager.createKey(EntityAnimalMule.class, DataSerializers.BOOLEAN);
