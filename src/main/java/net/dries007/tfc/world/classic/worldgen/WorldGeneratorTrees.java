...
public class WorldGeneratorTrees implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if ((b == BiomesTFC.MOUNTAINS || b == BiomesTFC.MOUNTAINS_EDGE || b == BiomesTFC.HIGH_HILLS || b == BiomesTFC.HIGH_HILLS_EDGE) &&
        ...
        if ((b == BiomesTFC.ROLLING_HILLS || b == BiomesTFC.FIELDS || b == BiomesTFC.FLATLANDS || b == BiomesTFC.PLAINS ||
                b == BiomesTFC.HIGH_PLAINS) && (avgTemperature <= 10 + gauss)) {
...

        {
            ...
            for (int i = random.nextInt(Math.round(1 / diversity)); i < (1 + density) * treesPerChunk; i++) {
                ...
                if ((BlocksTFC.isGround(down) || BlocksTFCF.isGround(down) || world.getBlockState(blockPos)
                        .getBlock() == ChunkGenTFC.FRESH_WATER.getBlock()) && b1 == BiomesTFC.BAYOU) {
                    ...
                    if (10f <= avgTemperature && 38f >= avgTemperature && 180f <= rainfall && 500f >= rainfall &&
                            blockPos.getY() >= WorldTypeTFC.SEALEVEL - 8) {
        ...
        }
        {
            ...
            for (int i = random.nextInt(Math.round(1 / diversity)); i < (1 + density) * treesPerChunk; i++) {
                ...
                if ((BlocksTFC.isGround(down) || BlocksTFCF.isGround(down) || world.getBlockState(blockPos)
                        .getBlock() == ChunkGenTFC.SALT_WATER.getBlock()) && b1 == BiomesTFC.MANGROVE) {
        ...
        if (((rainfall >= 100 && density <= 0.3f) || rainfall <= 100)) {
            ...
            for (int i = random.nextInt(Math.round(1 / diversity)); i < (density) * treesPerChunk; i++) {
                ...
                if (b1 != BiomesTFC.BAYOU && b1 != BiomesTFC.MARSH && !BiomesTFC.isOceanicBiome(b1) && !BiomesTFC.isLakeBiome(b1) &&
                        !BiomesTFC.isBeachBiome(b1) && !BiomesTFC.isMesaBiome(b1)) {
                    if ((BlocksTFC.isSand(down) || BlocksTFC.isSoilOrGravel(down) || BlocksTFCF.isSand(down) || BlocksTFCF.isSoilOrGravel(down)) &&
                        ...
                        if (15f <= avgTemperature && 40f >= avgTemperature && 65f <= rainfall && 150f >= rainfall &&
                                blockPos.getY() >= WorldTypeTFC.SEALEVEL) {
