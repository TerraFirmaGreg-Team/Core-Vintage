...
import static net.dries007.tfc.util.agriculture.Crop.CropType.PICKABLE;
import static net.dries007.tfc.util.agriculture.Crop.CropType.SIMPLE;
import static net.dries007.tfc.util.agriculture.Crop.CropType.SPREADING;
...
public enum Crop implements ICrop {
  ...
  public void addInfo(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
    if (GuiScreen.isShiftKeyDown()) {
      ...
      tooltip.add(
        TextFormatting.GOLD + I18n.format("tfc.tooltip.climate_info_temperature", String.format("%.1f", tempMinGrow), String.format("%.1f", tempMaxGrow)));
    } else {
