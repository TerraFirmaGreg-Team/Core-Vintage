...
public final class NBTUtils {
    ...
    /**
     * Retrieves an array of ItemStack from an NBTTagCompound. This method is intended to be used with the NBT version of an IInventory and can be
     * used when parsing things like TileEntity NBT data.
     *
    ...
    /**
     * Provides a way to access an NBTTagCompound that is very deep within another NBTTagCompound. This will allow you to use an array of strings
