...
public final class TreesTFCF {
    ...
    public static final ITreeGenerator GEN_NORMAL = new GeneratorTreeRandom(1, 3, 3);
    public static final ITreeGenerator GEN_MEDIUM = new GeneratorTreeRandom(2, 2, 3);
    public static final ITreeGenerator GEN_TALL = new GeneratorTreeRandom(3, 3, 3);
    ...
    public static final Tree WHITE_CEDAR_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "white_cedar"), 10f, 240f, -8f, 17f,
            GEN_TALL_SINGLE).setHeight(16)
            .setBushes()
            .setBurnInfo(625f, 1500)
            .build();

    public static final Tree BAOBAB_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "baobab"), 10f, 150f, 21f, 40f, GEN_BAOBAB).setDecayDist(
                    6)
            .setGrowthTime(20)
    ...
    public static final Tree EUCALYPTUS_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "eucalyptus"), 120f, 300f, 18f, 39f,
            GEN_EUCALYPTUS).setGrowthTime(8)
            .setBushes()
            .setDensity(0.35f, 2f)
    ...
    public static final Tree JOSHUA_TREE_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "joshua_tree"), 20f, 150f, 15f, 40f,
            GEN_JOSHUA_TREE).setDominance(0f)
            .setDensity(0f, 0f)
            .setGrowthTime(8)
            .setConifer()
            .setBurnInfo(696f, 1250)
    ...
    public static final Tree BLACK_WALNUT_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "black_walnut"), 180f, 300f, -10f, 16f,
            GEN_BLACK_WALNUT).setGrowthTime(9)
            .setBushes()
    ...
    public static final Tree BUTTERNUT_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "butternut"), 180f, 320f, -8f, 17f,
            GEN_BUTTERNUT).setGrowthTime(9)
            .setBushes()
            .setBurnInfo(758f, 1800)
            .build();
    public static final Tree EUROPEAN_OAK_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "european_oak"), 140f, 430f, -8f, 15f,
            GEN_EUROPEAN_OAK).setGrowthTime(10)
            .setBushes()
            .setTannin()
            .setBurnInfo(728f, 2250)
            .build();
    public static final Tree GINKGO_TREE = new Tree.Builder(new ResourceLocation(MODID_TFC, "ginkgo"), 240f, 550f, 6f, 20f, GEN_GINKGO).setGrowthTime(
                    8)
            .setDensity(0.25f, 1f)
    ...
    public static final Tree CASSIA_CINNAMON_TREE = new Tree(new ResourceLocation(MODID_TFC, "cassia_cinnamon"), GEN_CASSIA_CINNAMON, 20, 35, 250,
            400, 0.1f, 1, 2, 4, 15, 6, false, null, false, 15, 710f, 1000);
    public static final Tree CEYLON_CINNAMON_TREE = new Tree(new ResourceLocation(MODID_TFC, "ceylon_cinnamon"), GEN_CEYLON_CINNAMON, 20, 35, 250,
            400, 0.1f, 1, 2, 4, 15, 6, false, null, false, 15, 710f, 1000);
    ...
    public static final Tree BLACK_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "black_bamboo"), GEN_BLACK_BAMBOO, 24, 35, 240, 420, 1, 2, 1, 4,
            15, 6, false, null, false, 10, 400f, 800);
    public static final Tree BLUE_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "blue_bamboo"), GEN_BLUE_BAMBOO, 24, 35, 240, 420, 1, 2, 1, 4, 15,
            6, false, null, false, 10, 400f, 800);
    public static final Tree DRAGON_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "dragon_bamboo"), GEN_DRAGON_BAMBOO, 24, 35, 240, 420, 1, 2, 1,
            4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree GOLDEN_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "golden_bamboo"), GEN_GOLDEN_BAMBOO, 24, 35, 240, 420, 1, 2, 1,
            4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree NARROW_LEAF_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "narrow_leaf_bamboo"), GEN_NARROW_LEAF_BAMBOO, 24, 35, 240,
            420, 1, 2, 1, 4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree RED_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "red_bamboo"), GEN_RED_BAMBOO, 24, 35, 240, 420, 1, 2, 1, 4, 15, 6,
            false, null, false, 10, 400f, 800);
    public static final Tree TEMPLE_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "temple_bamboo"), GEN_TEMPLE_BAMBOO, 24, 35, 240, 420, 1, 2, 1,
            4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree THORNY_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "thorny_bamboo"), GEN_THORNY_BAMBOO, 24, 35, 240, 420, 1, 2, 1,
            4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree TIMBER_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "timber_bamboo"), GEN_TIMBER_BAMBOO, 24, 35, 240, 420, 1, 2, 1,
            4, 15, 6, false, null, false, 10, 400f, 800);
    public static final Tree TINWA_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "tinwa_bamboo"), GEN_TINWA_BAMBOO, 24, 35, 240, 420, 1, 2, 1, 4,
            15, 6, false, null, false, 10, 400f, 800);
    public static final Tree WEAVERS_BAMBOO = new Tree(new ResourceLocation(MODID_TFC, "weavers_bamboo"), GEN_WEAVERS_BAMBOO, 24, 35, 240, 420, 1, 2,
    ...
    public static void onPreRegisterTrees(TFCRegistryEvent.RegisterPreBlock<Tree> event) {
        ...
        event.getRegistry()
                .registerAll(
                        new Tree.Builder(new ResourceLocation(MODID_TFC, "african_padauk"), 275f, 500f, 22f, 50f, GEN_AFRICAN_PADAUK).setRadius(1)
                                .setDecayDist(6)
                                .setGrowthTime(18)
                                .setBushes()
                                .setDensity(0.5f, 2f)
        ...
        event.getRegistry()
                .registerAll(
                        new Tree.Builder(new ResourceLocation(MODID_TFC, "yellow_meranti"), 260f, 500f, 21f, 50f, GEN_YELLOW_MERANTI).setRadius(1)
                                .setDecayDist(6)
                                .setGrowthTime(18)
                                .setBushes()
                                .setDensity(0.5f, 2f)
        ...
        event.getRegistry()
                .registerAll(
                        new Tree.Builder(new ResourceLocation(MODID_TFC, "nordmann_fir"), 100f, 380f, -16f, 7f, GEN_NORDMANN_FIR).setGrowthTime(8)
                                .setConifer()
        ...
        event.getRegistry()
                .registerAll(
                        new Tree.Builder(new ResourceLocation(MODID_TFC, "norway_spruce"), 100f, 380f, -20f, 5f, GEN_NORWAY_SPRUCE).setGrowthTime(8)
                                .setConifer()
                                .setDensity(0.1f, 0.9f)
                                .setBurnInfo(628f, 1500)
                                .build());
