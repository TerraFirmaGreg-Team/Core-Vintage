...
import static su.terrafirmagreg.old.core.util.TFGModUtils.TFG_OREPREFIX_REGISTRY;
  ...
  private static void registerKnappingRecipes() {
    ...
    TFG_OREPREFIX_REGISTRY.forEach(s -> {
      ...
      if (s.getOrePrefix() != TFGOrePrefix.toolHeadHammer) {
        r.register(new KnappingRecipeSimple(KnappingType.FLINT, true, OreDictUnifier.get(s.getOrePrefix(), Materials.Flint), s.getStoneKnappingRecipe()).setRegistryName(MOD_ID,
                                                                                                                                                                         s.getOrePrefix()
                                                                                                                                                                          .name()
                                                                                                                                                                          .toLowerCase()
                                                                                                                                                                         + "_flint_head"));
