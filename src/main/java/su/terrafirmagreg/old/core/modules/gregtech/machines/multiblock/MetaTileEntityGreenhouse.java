package su.terrafirmagreg.old.core.modules.gregtech.machines.multiblock;

import su.terrafirmagreg.old.core.modules.gregtech.recipes.TFGRecipeMaps;
...
public class MetaTileEntityGreenhouse extends RecipeMapMultiblockController {
  ...
  public MetaTileEntityGreenhouse(ResourceLocation metaTileEntityId) {
    super(metaTileEntityId, TFGRecipeMaps.GREENHOUSE_RECIPES); // Use Nomi Labs recipes if the mod is installed
