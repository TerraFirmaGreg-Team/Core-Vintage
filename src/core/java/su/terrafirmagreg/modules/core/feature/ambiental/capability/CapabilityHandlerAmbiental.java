...
public class CapabilityHandlerAmbiental {
  ...
  public static void init() {
    ...
    ITEM.register(CapabilityHandlerAmbiental::handleHeatItem);

    // TFC-Tech
    TILE.register(CapabilityHandlerAmbiental::handleElectricForge); // Тигель
    TILE.register(CapabilityHandlerAmbiental::handleInductionCrucible); // Кузня
    TILE.register(CapabilityHandlerAmbiental::handleFridge); // Холодос

    // Firmalife
    TILE.register(CapabilityHandlerAmbiental::handleClayOven); // Oven

    // TFC
    TILE.register(CapabilityHandlerAmbiental::handleLamps); // Лампа
    ...
    EQUIPMENT.register(CapabilityHandlerAmbiental::handleArmor);

    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleGeneralTemperature);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleTimeOfDay);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleShade);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleCozy);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleThirst);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleFood);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleDiet);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleFire);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleWater);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleRain);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleSprinting);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handleUnderground);
    ENVIRONMENT.register(CapabilityHandlerAmbiental::handlePotionEffects);
  }
