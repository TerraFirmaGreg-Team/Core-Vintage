...
public class TileDataServiceOverlayRenderer {
            ...
            if (traceResult != null
                ...
                if (map != null) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        fontRenderer.drawStringWithShadow(dataClass.getSimpleName() + " " + count, x + 64 /* TODO: cost */ + 5, y + 9 + index * 10,
                                Color.WHITE.getRGB());
                        index += 1;
                    }
                }
    ...
    private static void bufferColoredQuad(BufferBuilder renderer, int x, int y, float width, int height, float red, float green, float blue,
                                          float alpha) {
