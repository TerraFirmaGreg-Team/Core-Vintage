...
public class StructureGenerator extends WorldGenerator {
    ...
    public static boolean checkBiome(Template template, World world, BlockPos pos) {
        ...
        if ((world.getBlockState(x1).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x1)
                ...
                .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b1 == BiomesTFC.OCEAN || b1 == BiomesTFC.DEEP_OCEAN || b1 == BiomesTFC.LAKE ||
                b1 == BiomesTFC.RIVER || b1 == BiomesTFC.BEACH || b1 == BiomesTFC.GRAVEL_BEACH) ||
                (world.getBlockState(x2).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x2)
                        ...
                        .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b2 == BiomesTFC.OCEAN || b2 == BiomesTFC.DEEP_OCEAN ||
                ...
                (world.getBlockState(x3).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x3)
                        ...
                        .getBlock() == ChunkGenTFC.HOT_WATER.getBlock() || b3 == BiomesTFC.OCEAN || b3 == BiomesTFC.DEEP_OCEAN ||
