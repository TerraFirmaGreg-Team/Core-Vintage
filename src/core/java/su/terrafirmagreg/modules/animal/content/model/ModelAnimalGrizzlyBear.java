...
import su.terrafirmagreg.modules.animal.content.entity.predator.EntityAnimalGrizzlyBear;
...
/**
 * ModelGrizzlyBearTFC Created using Tabula 7.1.0
 */

@SideOnly(Side.CLIENT)

public class ModelAnimalGrizzlyBear extends ModelBase {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks,
                                ...
                                Entity entityIn) {
    bearHead.rotateAngleX = headPitch / (180F / MathUtils.PI);
    bearHead.rotateAngleY = netHeadYaw / (180F / MathUtils.PI);
