...
public class PlantsFL {
	...
	public static final Tree CINNAMON_TREE = new Tree(new ResourceLocation(Constants.MODID_TFC, "cinnamon"), new TreeGenSequoia(), 28, 35, 280, 400, 0f, 1f, 0, 4, 15, 4, false, null, false, 15, 0, 0);
