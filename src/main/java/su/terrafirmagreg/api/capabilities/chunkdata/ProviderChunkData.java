...
public final class ProviderChunkData implements ICapabilityChunkData {
    ...
    public static boolean isStable(World world, BlockPos pos) {
        return CapabilityChunkData.get(world, pos).getStabilityLayer(pos.getX() & 15, pos.getZ() & 15).valueInt == 0;
    }
    ...
    public static int getDrainage(World world, BlockPos pos) {
        return CapabilityChunkData.get(world, pos).getDrainageLayer(pos.getX() & 15, pos.getZ() & 15).valueInt;
    }
    ...
    public static RockType getRockHeight(World world, BlockPos pos) {
        return CapabilityChunkData.get(world, pos).getRockLayerHeight(pos.getX() & 15, pos.getY(), pos.getZ() & 15);
    }
    ...
    public static SoilType getSoilHeight(World world, BlockPos pos) {
        return CapabilityChunkData.get(world, pos).getSoilLayerHeight(pos.getX() & 15, pos.getY(), pos.getZ() & 15);
    }
