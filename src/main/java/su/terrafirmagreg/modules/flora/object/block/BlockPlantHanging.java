...
public class BlockPlantHanging extends BlockPlantCreeping implements IGrowable {
  ...
  public BlockPlantHanging(FloraBlockVariant variant, FloraType type) {
    super(variant, type);
  }
  ...
  public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
    ...
    if (worldIn.getBlockState(pos.down()).getBlock() == this && actualState.getValue(UP) && !actualState.getValue(DOWN) &&
        !actualState.getValue(NORTH) && !actualState.getValue(SOUTH) && !actualState.getValue(EAST) &&
        !actualState.getValue(WEST)) {
    ...
    if (worldIn.getBlockState(pos.up()).getBlock() == this && !actualState.getValue(UP) && !actualState.getValue(NORTH) &&
  ...
  protected boolean canPlantConnectTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
    return !super.canPlantConnectTo(world, pos, facing) && world.getBlockState(pos.up())
           ...
           ? this.canPlantConnectTo(world, pos.up(), facing) :
