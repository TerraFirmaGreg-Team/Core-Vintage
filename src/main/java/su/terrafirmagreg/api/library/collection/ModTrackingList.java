...
public class ModTrackingList<T> extends AbstractList<T> implements RandomAccess {
  ...
  /**
   * The main constructor for the tracking list. Entries added and removed from this list will be tracked.
   *
   * @param delegate The parent/delegate list. This can be empty, but should probably represent the list you are replacing, if you are replacing one.
   */
  ...
  /**
   * The backing constructor for the tracking list. Entries added and removed from this list will be tracked.
   *
   * @param delegate        The parent/delegate list. This can be empty, but should probably represent the list you are replacing, if you are replacing one.
  ...
  /**
   * Gets the mod container that was active when the passed element was handled by this list. This can be null if the element has not been handled by this
   * list.
   *
