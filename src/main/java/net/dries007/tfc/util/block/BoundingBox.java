...
/**
 * Not Axis Aligned Bounding Box Helper class to compute AABBs for different facings **No more AABBs for each direction** (only NSWE) For performance
 * purposes, this class will create AABBs on demand, and supply the same AABB object if asked again
 */
public class BoundingBox {
    ...
    /**
     * Bounding Box AKA AABB from a single facing To be used in computing other facings
     *
