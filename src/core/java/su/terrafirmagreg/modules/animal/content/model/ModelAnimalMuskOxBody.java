...
/**
 * ModelMuskOxTFC Created using Tabula 7.1.0
 */

@SideOnly(Side.CLIENT)

public class ModelAnimalMuskOxBody extends ModelBase {
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5,
    ...
    this.headBase.rotateAngleX = par5 / (180F / MathUtils.PI);
    this.headBase.rotateAngleY = par4 / (180F / MathUtils.PI);
