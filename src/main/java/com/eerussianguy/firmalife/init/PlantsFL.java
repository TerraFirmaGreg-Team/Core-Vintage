...
public class PlantsFL {
  ...
  public static final Tree CINNAMON_TREE = new Tree(new ResourceLocation(TerraFirmaCraft.MODID_TFC, "cinnamon"), new TreeGenSequoia(), 28, 35, 280, 400, 0f, 1f, 0, 4, 15, 4, false, null, false, 15, 0, 0);
  ...
  private static class PlantWrapper extends Plant {
    ...
    public PlantWrapper(@Nonnull String name, int[] stages, float minTemp, float maxTemp, float minRain, float maxRain) {
      super(new ResourceLocation(TerraFirmaCraft.MODID_TFC, name), PlantType.STANDARD, stages, false, false, minTemp, maxTemp, minTemp, maxTemp, minRain, maxRain, 9, 15, 1, 0, 0, 0.8F, null);
    }
  }
}
