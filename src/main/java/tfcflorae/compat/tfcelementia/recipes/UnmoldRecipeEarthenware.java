...
public class UnmoldRecipeEarthenware extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    ...
    private UnmoldRecipeEarthenware(@Nullable ResourceLocation group, NonNullList<Ingredient> input, @NotNull ItemMetalTFCE.ItemType type,
                                    float chance) {
        this.group = group;
        this.input = input;
        this.type = type;
    ...
    public static class Factory implements IRecipeFactory {
        ...
        public IRecipe parse(final JsonContext context, final JsonObject json) {
            ...
            return new UnmoldRecipeEarthenware(group.isEmpty() ? new ResourceLocation(result) : new ResourceLocation(group), ingredients, type,
                    chance);
        }
    }
}
