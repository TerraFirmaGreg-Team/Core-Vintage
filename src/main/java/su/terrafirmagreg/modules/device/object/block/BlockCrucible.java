...
public class BlockCrucible extends Block implements IHeatConsumerBlock, ICapabilitySize {
  ...
  public void acceptHeat(World world, BlockPos pos, float temperature) {
    TileCrucible tile = Helpers.getTE(world, pos, TileCrucible.class);
    if (tile != null) {
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
    TileCrucible te = Helpers.getTE(worldIn, pos, TileCrucible.class);
    if (te != null) {
