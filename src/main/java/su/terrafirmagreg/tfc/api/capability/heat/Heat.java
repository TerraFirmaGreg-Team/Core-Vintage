package su.terrafirmagreg.tfc.api.capability.heat;
...
//            }
    ...
    /**
     * Получить минимальную температуру диапазона
     *
     * @return минимальная тем
     */
    public float getMin() {
        return min;
    }
    ...
    /**
     * Получить максимальную температуру диапазона
     *
     * @return максимальная температура диапазона
     */
    public float getMax() {
        return max;
    }
