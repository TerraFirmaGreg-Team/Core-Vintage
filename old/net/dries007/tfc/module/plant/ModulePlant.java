...
public class ModulePlant extends ModuleBase {
    ...
    public static final Logger LOGGER = LogManager.getLogger(Tags.MOD_NAME + "." + ModulePlant.class.getSimpleName());
...
//    public static IPacketService PACKET_SERVICE;
    ...
    public ModulePlant() {
        ...
        this.setRegistry(new Registry(Tags.MOD_ID, FLORA_TAB));
