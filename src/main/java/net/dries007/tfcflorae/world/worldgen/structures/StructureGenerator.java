...
package net.dries007.tfcflorae.world.worldgen.structures;
...
public class StructureGenerator extends WorldGenerator {
  ...
  public static int getLowestCorner(Template template, World world, BlockPos pos) {
    ...
    if (groundX1 <= groundX2 && groundX1 <= groundX3 && groundX1 <= groundX4) {return groundX1;} else if (groundX2 <= groundX1 && groundX2 <= groundX3
                                                                                                          && groundX2 <= groundX4) {return groundX2;} else if (
      groundX3 <= groundX1 && groundX3 <= groundX2
      && groundX3 <= groundX4) {
      return groundX3;
    } else {return groundX4;}
  }
  ...
  public static boolean checkBiome(Template template, World world, BlockPos pos) {
    ...
    if ((world.getBlockState(x1).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x1).getBlock() == ChunkGenTFC.SALT_WATER.getBlock()
        ...
        (world.getBlockState(x3).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(x3).getBlock() == ChunkGenTFC.SALT_WATER.getBlock()
         ...
         || b3 == BiomesTFC.LAKE || b3 == BiomesTFC.RIVER || b3 == BiomesTFC.BEACH || b3 == BiomesTFC.GRAVEL_BEACH)) {return false;}
  ...
  public static int getGroundFromAbove(World world, int x, int z) {
    ...
    if (world.getBlockState(pos).getBlock() == ChunkGenTFC.FRESH_WATER.getBlock() || world.getBlockState(pos).getBlock() == ChunkGenTFC.SALT_WATER.getBlock()
        || world.getBlockState(pos).getBlock() == ChunkGenTFC.HOT_WATER.getBlock()) {
      y = -99;
    }
    ...
    if (canSpawnHere(template, worldServer, position, variation) && checkBiome(template, world, position)) {
      ...
      for (Entry<BlockPos, String> entry : dataBlocks.entrySet()) {
        try {
          ...
          if (data.length == 3) {state = block.getStateFromMeta(Integer.parseInt(data[2]));} else {state = block.getDefaultState();}
