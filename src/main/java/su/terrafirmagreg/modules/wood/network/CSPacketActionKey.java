        ...
        sender.getServerWorld().addScheduledTask(() -> {
            ...
            if (!result.isEmpty()) {
                ...
                for (EntityWoodCart cart : result) {
                    ...
                    if (new Vec3d(cart.posX - sender.posX, cart.posY - sender.posY, cart.posZ - sender.posZ).length() <
                            new Vec3d(closest.posX - sender.posX, closest.posY - sender.posY, closest.posZ - sender.posZ).length()) {
                        closest = cart;
                    }
                }
