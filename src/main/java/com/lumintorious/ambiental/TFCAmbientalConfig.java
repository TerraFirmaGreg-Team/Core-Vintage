...
public class TFCAmbientalConfig {
    ...
    public static class ClientCFG {
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".client.celsius")
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".client.sneakyDetails")
    ...
    public static class GeneralCFG {
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.temperatureMultiplier")
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.positiveModifier")
        public float positiveModifier = 5f;

        @Config.Comment(
                "How fast does temperature change when it's going away from the average. If you think you are giving yourself a challenge by increasing this number, think twice. It makes it so that you have to warm yourself up every so often. Default = 1")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.negativeModifier")
        public float negativeModifier = 1f;

        @Config.Comment(
                "How many ticks between modifier calculations. Too high values help performance but behave weirdly. 20 = 1 second means modifiers are checked every second. Also affects the packet sending interval. Default = 20")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.tickInterval")
        public int tickInterval = 20;

        @Config.Comment(
                "How potent are multipliers with more than one instance. (Eg. 2 fire pits nearby means they have 2 * this effectiveness). Default = 0.7")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.diminishedModifierMultiplier")
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.takeDamage")
        public boolean takeDamage = true;

        @Config.Comment(
                "If true, you will start losing hunger when below cold temperatures and losing thirst when above hot temperatures. Default = true")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.loseHungerThirst")
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.modifierCap")
        public int modifierCap = 4;

        @Config.Comment("If true, temperate areas won't be as mild. Default = true")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.harsherTemperateAreas")
        public boolean harsherTemperateAreas = true;

        @Config.Comment(
                "If harsherTemperateAreas is true, environmental temperatures going away from the average are multiplied by this number. (The less temperate an area is, the less the modifier affects it). Default = 1.2 ")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.harsherMultiplier")
        public float harsherMultiplier = 1.20f;

        @Config.Comment(
                "The temperature at which you are at equilibrium. It's advisable to not change this by a lot since the entire ecosystem revolves around this. Default = 15")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.averageTemperature")
        public float averageTemperature = 15f;

        @Config.Comment(
                "The temperature at which your screen starts heating. It's advisable to not change this by a lot since the entire ecosystem revolves around this. Default = 20")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.hotTemperature")
        public float hotTemperature = 20f;

        @Config.Comment(
                "The temperature at which your screen starts freezing. It's advisable to not change this by a lot since the entire ecosystem revolves around this. Default = 10")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.coldTemperature")
        public float coldTemperature = 10f;

        @Config.Comment(
                "The temperature at which you start burning and taking damage. It's advisable to not change this by a lot since the entire ecosystem revolves around this. Default = 25")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.burningTemperature")
        public float burningTemperature = 25f;

        @Config.Comment(
                "The temperature at which you start freezing and taking damage. It's advisable to not change this by a lot since the entire ecosystem revolves around this. Default = 5")
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.freezingTemperature")
        ...
        @Config.LangKey("config." + MODID_TFCAMBIENTAL + ".general.enableDebug")
