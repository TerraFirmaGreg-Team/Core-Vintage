...
//import static net.dries007.tfc.objects.blocks.rock.BlockRock.getBlockSoilMap;
//
//public abstract class BlockRockSlab extends BlockSlab implements IStoneTypeBlock {
//	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
//
//	public final Block modelBlock;
//	protected Half halfSlab;
//
//	private BlockRockSlab(RockBlockType blockType, RockVariant rockVariant, RockType rockType) {
//		this(getBlockSoilMap(ORDINARY, rockVariant, rockType));
//
//		Block c = getBlockSoilMap(ORDINARY, rockVariant, rockType);
...
//							case RAW:
//							case SMOOTH:
//								Block.spawnAsEntity(world, pos, new ItemStack(getBlockSoilMap(SLAB, COBBLE, rockType), 1));
//								break;
//							case COBBLE:
