...
public class GeneratorCorals implements IWorldGenerator {
    ...
    private void generateCoral(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        for (int i = 0; i < (coralsInChunk) * 5; i++) {
            ...
            if ((b == BiomesWorld.OCEAN || b == BiomesWorld.DEEP_OCEAN || b == BiomesWorld.BEACH || b == BiomesWorld.GRAVEL_BEACH) &&
                ...
                if (isValidPosition(world, pos) && pos.getY() < WorldTypeClassic.SEALEVEL - 1 && pos.getY() > 119 && floraDensity >= 0.4f &&
        ...
        for (int i = 0; i < (coralsInChunk) * 100; i++) {
            ...
            if ((b == BiomesWorld.OCEAN || b == BiomesWorld.DEEP_OCEAN || b == BiomesWorld.BEACH || b == BiomesWorld.GRAVEL_BEACH) &&
                    world.provider.getDimension() == 0) {
                if (isValidPosition2(world, pos) && pos.getY() < WorldTypeClassic.SEALEVEL - 1 && pos.getY() > 119 && floraDensity >= 0.4f &&
