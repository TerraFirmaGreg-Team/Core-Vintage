...
public class BushTypeHandler {
    ...
    public static void init() {
        BushTypes.BLACKBERRY = new BushType.Builder("blackberry")
        ...
        BushTypes.BLUEBERRY = new BushType.Builder("blueberry")
        ...
        BushTypes.BUNCH_BERRY = new BushType.Builder("bunch_berry")
        ...
        BushTypes.CLOUD_BERRY = new BushType.Builder("cloud_berry")
        ...
        BushTypes.CRANBERRY = new BushType.Builder("cranberry")
        ...
        BushTypes.ELDERBERRY = new BushType.Builder("elderberry")
        ...
        BushTypes.GOOSEBERRY = new BushType.Builder("gooseberry")
        ...
        BushTypes.RASPBERRY = new BushType.Builder("raspberry")
        ...
        BushTypes.SNOW_BERRY = new BushType.Builder("snow_berry")
        ...
        BushTypes.STRAWBERRY = new BushType.Builder("strawberry")
        ...
        BushTypes.WINTERGREEN_BERRY = new BushType.Builder("wintergreen_berry")
