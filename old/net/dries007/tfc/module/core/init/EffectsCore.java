...
public final class EffectsCore {
    public static final Potion OVERBURDENED = Helpers.getNull();
    public static final Potion THIRST = Helpers.getNull();
    public static final Potion FOOD_POISON = Helpers.getNull();
