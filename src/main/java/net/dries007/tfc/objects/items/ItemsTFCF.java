...
import net.dries007.tfc.objects.blocks.groundcover.BlockSurfaceOreDeposit;
...
import net.dries007.tfc.objects.items.tools.ItemAxeTFCF;
import net.dries007.tfc.objects.items.tools.ItemBowTFCF;
import net.dries007.tfc.objects.items.tools.ItemHammerTFCF;
import net.dries007.tfc.objects.items.tools.ItemHoeTFCF;
import net.dries007.tfc.objects.items.tools.ItemJavelinTFCF;
import net.dries007.tfc.objects.items.tools.ItemKnifeTFCF;
import net.dries007.tfc.objects.items.tools.ItemShovelTFCF;
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        */
        ...
        simpleItems.add(register(r, "tools/flint/axe/flint",
                new ItemAxeTFCF(ToolMaterialsTFC.FLINT, 2.5f, -3f, 50, "axe", "axe_flint", "axe_stone", "axe_stone_sedimentary"), CT_ROCK_BLOCKS));
        simpleItems.add(register(r, "tools/flint/hammer/flint",
                new ItemHammerTFCF(ToolMaterialsTFC.FLINT, 2.5f, -3f, 50, "hammer", "hammer_flint", "hammer_stone", "hammer_stone_sedimentary"),
                CT_ROCK_BLOCKS));
        simpleItems.add(register(r, "tools/flint/hoe/flint",
                new ItemHoeTFCF(ToolMaterialsTFC.FLINT, 2.25f, -2f, 50, "hoe", "hoe_flint", "hoe_stone", "hoe_stone_sedimentary"), CT_ROCK_BLOCKS));
        simpleItems.add(register(r, "tools/flint/javelin/flint",
                new ItemJavelinTFCF(ToolMaterialsTFC.FLINT, 1.95f, -1.8f, 50, "javelin", "javelin_flint", "javelin_stone",
                        "javelin_stone_sedimentary"), CT_ROCK_BLOCKS));
        simpleItems.add(register(r, "tools/flint/knife/flint",
                new ItemKnifeTFCF(ToolMaterialsTFC.FLINT, 1.5f, -1.5f, 50, "knife", "knife_flint", "knife_stone", "knife_stone_sedimentary"),
                CT_ROCK_BLOCKS));
        simpleItems.add(register(r, "tools/flint/shovel/flint",
                new ItemShovelTFCF(ToolMaterialsTFC.FLINT, 1.25f, -3f, 50, "shovel", "shovel_flint", "shovel_stone", "shovel_stone_sedimentary"),
                CT_ROCK_BLOCKS));
