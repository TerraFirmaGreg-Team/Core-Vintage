...
public class GuiFirePit extends GuiContainerTE<TEFirePit> {
    private static final ResourceLocation FIRE_PIT_BACKGROUND = TerraFirmaGreg.getID("textures/gui/fire_pit.png");
    private static final ResourceLocation FIRE_PIT_COOKING_POT_BACKGROUND = TerraFirmaGreg.getID("textures/gui/fire_pit_cooking_pot.png");
    private static final ResourceLocation FIRE_PIT_GRILL_BACKGROUND = TerraFirmaGreg.getID("textures/gui/fire_pit_grill.png");
