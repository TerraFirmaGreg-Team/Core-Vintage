...
public class ConfigTFCF {
    ...
    public static void onConfigChangedEvent(ConfigChangedEvent.OnConfigChangedEvent event) {
        if (event.getModID().equals(MODID_TFCF)) {
            TFCFlorae.getLog().warn("Config changed");
            ConfigManager.sync(MODID_TFCF, Config.Type.INSTANCE);
        }
    }

    @Config(modid = MODID_TFCF, category = "general", name = "TFCFlorae - General")
    @Config.LangKey("config." + MODID_TFCF + ".general")
    public static final class General {

        @Config.Comment("World generation settings")
        @Config.LangKey("config." + MODID_TFCF + ".general.world")
        public static final WorldCFG WORLD = new WorldCFG();

        @Config.Comment("Structure generation settings")
        @Config.LangKey("config." + MODID_TFCF + ".general.structures")
        ...
        public static final class WorldCFG {
            ...
            @Config.Comment(
                    "The rarity for earthenware clay pits to occur. On average 1 / N chunks will have a earthenware clay deposit, if the chunk in question is valid for earthenware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.earthenwareClayRarity")
            public int earthenwareClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy earthenware clay pits to occur. On average 1 / N chunks will have a sandy earthenware clay deposit, if the chunk in question is valid for sandy earthenware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyEarthenwareClayRarity")
            public int sandyEarthenwareClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy earthenware clay loam pits to occur. On average 1 / N chunks will have a sandy earthenware clay loam deposit, if the chunk in question is valid for sandy earthenware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyEarthenwareClayLoamRarity")
            public int sandyEarthenwareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for earthenware clay loam pits to occur. On average 1 / N chunks will have a earthenware clay loam deposit, if the chunk in question is valid for earthenware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.earthenwareClayLoamRarity")
            public int earthenwareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty earthenware clay loam pits to occur. On average 1 / N chunks will have a silty earthenware clay loam deposit, if the chunk in question is valid for silty earthenware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyEarthenwareClayLoamRarity")
            public int siltyEarthenwareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty earthenware clay pits to occur. On average 1 / N chunks will have a silty earthenware clay deposit, if the chunk in question is valid for silty earthenware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyEarthenwareClayRarity")
            public int siltyEarthenwareClayRarity = 150;

            @Config.Comment(
                    "The rarity for earthenware clay humus pits to occur. On average 1 / N chunks will have a earthenware clay humus deposit, if the chunk in question is valid for earthenware clay humus to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.earthenwareClayHumusRarity")
            public int earthenwareClayHumusRarity = 150;

            @Config.Comment(
                    "The rarity for kaolinite clay pits to occur. On average 1 / N chunks will have a kaolinite clay deposit, if the chunk in question is valid for kaolinite clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.kaoliniteClayRarity")
            public int kaoliniteClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy kaolinite clay pits to occur. On average 1 / N chunks will have a sandy kaolinite clay deposit, if the chunk in question is valid for sandy kaolinite clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyKaoliniteClayRarity")
            public int sandyKaoliniteClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy kaolinite clay loam pits to occur. On average 1 / N chunks will have a sandy kaolinite clay loam deposit, if the chunk in question is valid for sandy kaolinite clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyKaoliniteClayLoamRarity")
            public int sandyKaoliniteClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for kaolinite clay loam pits to occur. On average 1 / N chunks will have a kaolinite clay loam deposit, if the chunk in question is valid for kaolinite clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.kaoliniteClayLoamRarity")
            public int kaoliniteClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty kaolinite clay loam pits to occur. On average 1 / N chunks will have a silty kaolinite clay loam deposit, if the chunk in question is valid for silty kaolinite clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyKaoliniteClayLoamRarity")
            public int siltyKaoliniteClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty kaolinite clay pits to occur. On average 1 / N chunks will have a silty kaolinite clay deposit, if the chunk in question is valid for silty kaolinite clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyKaoliniteClayRarity")
            public int siltyKaoliniteClayRarity = 150;

            @Config.Comment(
                    "The rarity for kaolinite clay humus pits to occur. On average 1 / N chunks will have a kaolinite clay humus deposit, if the chunk in question is valid for kaolinite clay humus to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.kaoliniteClayHumusRarity")
            public int kaoliniteClayHumusRarity = 150;

            @Config.Comment(
                    "The rarity for stoneware clay pits to occur. On average 1 / N chunks will have a stoneware clay deposit, if the chunk in question is valid for stoneware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.stonewareClayRarity")
            public int stonewareClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy stoneware clay pits to occur. On average 1 / N chunks will have a sandy stoneware clay deposit, if the chunk in question is valid for sandy stoneware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyStonewareClayRarity")
            public int sandyStonewareClayRarity = 150;

            @Config.Comment(
                    "The rarity for sandy stoneware clay loam pits to occur. On average 1 / N chunks will have a sandy stoneware clay loam deposit, if the chunk in question is valid for sandy stoneware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.sandyStonewareClayLoamRarity")
            public int sandyStonewareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for stoneware clay loam pits to occur. On average 1 / N chunks will have a stoneware clay loam deposit, if the chunk in question is valid for stoneware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.stonewareClayLoamRarity")
            public int stonewareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty stoneware clay loam pits to occur. On average 1 / N chunks will have a silty stoneware clay loam deposit, if the chunk in question is valid for silty stoneware clay loam to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyStonewareClayLoamRarity")
            public int siltyStonewareClayLoamRarity = 150;

            @Config.Comment(
                    "The rarity for silty stoneware clay pits to occur. On average 1 / N chunks will have a silty stoneware clay deposit, if the chunk in question is valid for silty stoneware clay to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.siltyStonewareClayRarity")
            public int siltyStonewareClayRarity = 150;

            @Config.Comment(
                    "The rarity for stoneware clay humus pits to occur. On average 1 / N chunks will have a stoneware clay humus deposit, if the chunk in question is valid for stoneware clay humus to spawn.")
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.stonewareClayHumusRarity")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.fungiUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.hangingVinesUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.creepingVinesUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + MODID_TFCF + ".general.world.creepingUndergroundCount")
            ...
            @Config.LangKey("config." + MODID_TFCF + ".general.world.enableGroundcoverOreDeposit")
            public boolean enableGroundcoverOreDeposit = true;

            @Config.Comment("Enable pinecone groundcover?")
            @Config.LangKey("config." + MODID_TFCF + ".general.world.enableGroundcoverPinecone")
        ...
        public static final class StructuresCFG {
            ...
            @Config.LangKey("config." + MODID_TFCF + ".general.structures.activateStructureGeneration")
            ...
            @Config.LangKey("config." + MODID_TFCF + ".general.structures.generationModifier")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.structures.spawnChanceRuins")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.structures.spawnChanceMoai")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + MODID_TFCF + ".general.structures.spawnChanceMaya")
