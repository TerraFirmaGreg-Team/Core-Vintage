...
public class BlockFirePit extends Block implements IBellowsConsumerBlock, ILightableBlock {
  ...
  public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
    TileFirePit te = Helpers.getTE(worldIn, pos, TileFirePit.class);
  ...
  public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random rng) {
    ...
    if (rng.nextInt(24) == 0) {
      world.playSound(
        pos.getX() + 0.5F,
        pos.getY() + 0.5F,
        pos.getZ() + 0.5F, SoundEvents.BLOCK_FIRE_AMBIENT, SoundCategory.BLOCKS, 1.0F + rng.nextFloat(), rng.nextFloat() * 0.7F + 0.3F, false);
    }
    ...
    if (state.getValue(ATTACHMENT) == FirePitAttachment.COOKING_POT) {
      TileFirePit tile = Helpers.getTE(world, pos, TileFirePit.class);
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
    TileFirePit tile = Helpers.getTE(worldIn, pos, TileFirePit.class);
    if (tile != null) {
  ...
  public void onAirIntake(World world, BlockPos pos, int airAmount) {
    TileFirePit teFirePit = Helpers.getTE(world, pos, TileFirePit.class);
    if (teFirePit != null) {
