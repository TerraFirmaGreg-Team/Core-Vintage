...
import net.dries007.tfc.module.core.client.button.GuiButtonPlayerInventoryTab;
import net.dries007.tfc.module.core.client.gui.overlay.PlayerDataOverlay;
import net.dries007.tfc.module.core.client.render.*;
