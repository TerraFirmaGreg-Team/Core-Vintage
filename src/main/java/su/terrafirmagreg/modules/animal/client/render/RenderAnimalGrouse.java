...
public class RenderAnimalGrouse extends RenderLiving<EntityAnimalGrouse> {
    ...
    private static final ResourceLocation FEMALE_YOUNG = ModUtils.getID("textures/entity/animal/livestock/grousef_young.png");
    private static final ResourceLocation FEMALE_OLD = ModUtils.getID("textures/entity/animal/livestock/grousef_old.png");

    private static final ResourceLocation MALE_YOUNG = ModUtils.getID("textures/entity/animal/livestock/grousem_young.png");
    private static final ResourceLocation MALE_OLD = ModUtils.getID("textures/entity/animal/livestock/grousem_old.png");

    private static final ResourceLocation CHICK_TEXTURE = ModUtils.getID("textures/entity/animal/livestock/grouse_chick.png");
