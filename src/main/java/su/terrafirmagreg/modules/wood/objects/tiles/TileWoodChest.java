...
public class TileWoodChest extends TileEntityChest implements ISlotCallback, IContainerProvider<ContainerWoodChest, GuiWoodChest> {
    ...
    public void update() {
        ...
        if (numPlayersUsing > 0 && lidAngle == 0.0F && adjacentChestZNeg == null && adjacentChestXNeg == null) {
            ...
            world.playSound(null, centerX, pos.getY() + 0.5D, centerZ, SoundEvents.BLOCK_CHEST_OPEN, SoundCategory.BLOCKS, 0.5F,
        ...
        if (numPlayersUsing == 0 && lidAngle > 0.0F || numPlayersUsing > 0 && lidAngle < 1.0F) {
            ...
            if (lidAngle < 0.5F && initialAngle >= 0.5F && adjacentChestZNeg == null && adjacentChestXNeg == null) {
                ...
                world.playSound(null, centerX, pos.getY() + 0.5D, centerZ, SoundEvents.BLOCK_CHEST_CLOSE, SoundCategory.BLOCKS, 0.5F,
                        world.rand.nextFloat() * 0.1F + 0.9F);
            }
