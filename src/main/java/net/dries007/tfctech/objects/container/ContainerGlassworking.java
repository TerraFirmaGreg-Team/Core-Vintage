package net.dries007.tfctech.objects.container;
...
import net.dries007.tfctech.api.recipes.GlassworkingRecipe;
...
public class ContainerGlassworking extends Container implements IButtonHandler {
  ...
  public ItemStack slotClick(int slotID, int dragType, ClickType clickType, EntityPlayer player) {
    if (slotID == this.itemIndex && (clickType == ClickType.QUICK_MOVE || clickType == ClickType.PICKUP || clickType == ClickType.THROW
  ...
  public boolean isSolidified() {
    ICapabilityHeat capHeat = stack.getCapability(CapabilityHeat.CAPABILITY, null);
