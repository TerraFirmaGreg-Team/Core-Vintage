					...
					if (onlySmeltables) {
						...
						for (Entry<Metal, Integer> entry : materials.entrySet()) {
							...
							if (key != null) {
								...
								text.add(textPosition, I18n.format(Constants.MODID_TFC + ".tooltip.small_vessel_unit_total", I18n.format(key.getTranslationKey()), metalAmount, Math.round((float) metalAmount / totalAmount * 1000) / 10f));
							}
						}
