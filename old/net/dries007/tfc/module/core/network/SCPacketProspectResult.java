...
public class SCPacketProspectResult implements IMessage, IMessageHandler<SCPacketProspectResult, IMessage> {
    private BlockPos pos;
    private Type type;
    private String materialName;

    @SuppressWarnings("unused")
    public SCPacketProspectResult() {
    }

    public SCPacketProspectResult(BlockPos pos, Type type, String materialName) {
        this.pos = pos;
        this.type = type;
    ...
    @Override
    public IMessage onMessage(SCPacketProspectResult message, MessageContext ctx) {
