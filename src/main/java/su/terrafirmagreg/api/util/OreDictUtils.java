...
public final class OreDictUtils {
  ...
  public static boolean contains(ItemStack itemStack, String oreDict) {
    if (!OreDictionary.doesOreNameExist(oreDict)) {
      TerraFirmaGreg.LOGGER.warn("Method called with non-existing name. stack: {} name: {}",
              itemStack, oreDict);
      return false;
    }
  ...
  public static void init() {
    ...
    OreDictionary.registerOre("glue",
            new ItemStack(BlockPlantTFC.get(TFCRegistries.PLANTS.getValue(PlantsTFCF.RESIN))));
    OreDictionary.registerOre("slimeball",
            new ItemStack(BlockPlantTFC.get(TFCRegistries.PLANTS.getValue(PlantsTFCF.RESIN))));
