...
public class TEMetalAnvil extends BaseTileInventory {
    ...
    //			return ((BlockMetalAnvil) state.getBlock()).getType()
    //					.getMetal()
    ...
    public boolean attemptWelding(EntityPlayer player) {
        ...
        //				// No flux
        //				ModuleMetal.PACKET_SERVICE.sendTo(SCPacketSimpleMessage.translateMessage(SCPacketSimpleMessage.MessageCategory.ANVIL, Tags.MOD_ID + ".tooltip.anvil_no_flux"), (EntityPlayerMP) player);
        //				return false;
        //			}
        //
        ...
        //					ModuleMetal.PACKET_SERVICE.sendTo(SCPacketSimpleMessage.translateMessage(SCPacketSimpleMessage.MessageCategory.ANVIL, Tags.MOD_ID + ".tooltip.anvil_too_cold"), (EntityPlayerMP) player);
        //				} else {
        //					ModuleMetal.PACKET_SERVICE.sendTo(SCPacketSimpleMessage.translateMessage(SCPacketSimpleMessage.MessageCategory.ANVIL, Tags.MOD_ID + ".tooltip.anvil_not_weldable"), (EntityPlayerMP) player);
        //				}
        //				return false;
        //			}
