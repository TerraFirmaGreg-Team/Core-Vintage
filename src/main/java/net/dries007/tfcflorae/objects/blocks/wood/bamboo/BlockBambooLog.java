package net.dries007.tfcflorae.objects.blocks.wood.bamboo;
...
import static net.dries007.tfcflorae.api.stateproperty.StatePropertiesTFCF.CONNECTED;
import static net.dries007.tfcflorae.api.stateproperty.StatePropertiesTFCF.GROWN;
...
public class BlockBambooLog extends Block {
  ...
  public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
    ...
    if (downState.getBlock() instanceof BlockBambooLog || BlocksTFC.isGrowableSoil(downState) || BlocksTFCF.isGrowableSoil(downState)) {shouldDestroy = false;}
    if (shouldDestroy) {
