...
import static net.dries007.tfc.api.types.Metal.ItemType.ICE_SAW_HEAD;
...
import static net.dries007.tfc.api.types.Metal.ItemType.MALLET_HEAD;
...
import static su.terrafirmagreg.modules.core.feature.playerdata.spi.SmithingSkill.Type.ARMOR;
...
import static su.terrafirmagreg.modules.core.init.FluidsCore.RUM;
...
public final class DefaultRecipes {
  ...
  public static void onRegisterBarrelRecipeEvent(RegistryEvent.Register<BarrelRecipe> event) {
    event.getRegistry().registerAll(
      ...
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 300), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, EnumHideSize.SMALL)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.SMALL)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("small_prepared_hide"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 400), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, EnumHideSize.MEDIUM)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.MEDIUM)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("medium_prepared_hide"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.SCRAPED, EnumHideSize.LARGE)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.LARGE)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("large_prepared_hide"),
      new BarrelRecipe(IIngredient.of(LIMEWATER.get(), 300), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.RAW, EnumHideSize.SMALL)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.SOAKED, EnumHideSize.SMALL)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("small_soaked_hide"),
      new BarrelRecipe(IIngredient.of(LIMEWATER.get(), 400), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.RAW, EnumHideSize.MEDIUM)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.SOAKED, EnumHideSize.MEDIUM)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("medium_soaked_hide"),
      new BarrelRecipe(IIngredient.of(LIMEWATER.get(), 500), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.RAW, EnumHideSize.LARGE)), null, new ItemStack(ItemAnimalHide.get(ItemAnimalHide.HideType.SOAKED, EnumHideSize.LARGE)),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("large_soaked_hide"),
      new BarrelRecipe(IIngredient.of(TANNIN.get(), 300), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.SMALL)), null, new ItemStack(Items.LEATHER),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("leather_small_hide"),
      new BarrelRecipe(IIngredient.of(TANNIN.get(), 400), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.MEDIUM)), null, new ItemStack(Items.LEATHER, 2),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("leather_medium_hide"),
      new BarrelRecipe(IIngredient.of(TANNIN.get(), 500), IIngredient.of(ItemAnimalHide.get(ItemAnimalHide.HideType.PREPARED, EnumHideSize.LARGE)), null, new ItemStack(Items.LEATHER, 3),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("leather_large_hide"),
      // Misc
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 1000), IIngredient.of("logWoodTannin"), new FluidStack(TANNIN.get(), 10000), ItemStack.EMPTY,
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("tannin"),
      ...
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 600), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.SUGARCANE), 5)), null, new ItemStack(Items.SUGAR),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("sugar"),
      new BarrelRecipe(IIngredient.of(LIMEWATER.get(), 500), IIngredient.of(new ItemStack(Items.DYE, 1, EnumDyeColor.WHITE.getDyeDamage())), null, new ItemStack(ItemsCore.GLUE),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("glue"),
      ...
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.BARLEY_FLOUR))), new FluidStack(FluidsCore.BEER.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("beer"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of("apple")), new FluidStack(FluidsCore.CIDER.get(), 500), ItemStack.EMPTY,
      ...
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.RICE_FLOUR))), new FluidStack(FluidsCore.SAKE.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("sake"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.POTATO))), new FluidStack(FluidsCore.VODKA.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("vodka"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.WHEAT_FLOUR))), new FluidStack(FluidsCore.WHISKEY.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("whiskey"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.CORNMEAL_FLOUR))), new FluidStack(FluidsCore.CORN_WHISKEY.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("corn_whiskey"),
      new BarrelRecipe(IIngredient.of(FRESH_WATER.get(), 500), new IngredientItemFood(IIngredient.of(ItemFoodTFC.get(Food.RYE_FLOUR))), new FluidStack(FluidsCore.RYE_WHISKEY.get(), 500), ItemStack.EMPTY,
        72 * ICalendar.TICKS_IN_HOUR).setRegistryName("rye_whiskey"),

      new BarrelRecipe(IIngredient.of(FluidsCore.RUM.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_RUM.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_rum"),
      new BarrelRecipe(IIngredient.of(FluidsCore.BEER.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_BEER.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_beer"),
      new BarrelRecipe(IIngredient.of(FluidsCore.WHISKEY.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_WHISKEY.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_whiskey"),
      new BarrelRecipe(IIngredient.of(FluidsCore.RYE_WHISKEY.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_RYE_WHISKEY.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_rye_whiskey"),
      new BarrelRecipe(IIngredient.of(FluidsCore.CORN_WHISKEY.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_CORN_WHISKEY.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_corn_whiskey"),
      new BarrelRecipe(IIngredient.of(FluidsCore.SAKE.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_SAKE.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_sake"),
      new BarrelRecipe(IIngredient.of(FluidsCore.VODKA.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_VODKA.get(), 1000), new ItemStack(Items.AIR),
        8 * ICalendar.TICKS_IN_DAY * 3).setRegistryName("aged_vodka"),
      new BarrelRecipe(IIngredient.of(FluidsCore.CIDER.get(), 1000), IIngredient.of(Items.AIR), new FluidStack(FluidsCore.AGED_CIDER.get(), 1000), new ItemStack(Items.AIR),
      ...
      new BarrelRecipe(IIngredient.of(250, FluidsCore.BEER.get(), FluidsCore.CIDER.get(), RUM.get(), FluidsCore.SAKE.get(), FluidsCore.VODKA.get(), FluidsCore.WHISKEY.get(), FluidsCore.CORN_WHISKEY.get(), FluidsCore.RYE_WHISKEY.get()), new IngredientItemFood(IIngredient.of("categoryFruit")), new FluidStack(FluidsCore.VINEGAR.get(), 250), ItemStack.EMPTY,
      ...
      new BarrelRecipe(IIngredient.of(CURDLED_MILK.get(), 625), IIngredient.of(ItemStack.EMPTY), null, new ItemStack(ItemFoodTFC.get(Food.CHEESE), 2),
        8 * ICalendar.TICKS_IN_HOUR).setRegistryName("cheese"),
      ...
      new BarrelRecipe(IIngredient.of(HOT_WATER.get(), 125), IIngredient.of(ItemsTFC.OLIVE_PASTE), new FluidStack(OLIVE_OIL_WATER.get(), 125), ItemStack.EMPTY,
        2 * ICalendar.TICKS_IN_HOUR).setRegistryName("olive_water"),
    ...
    for (Food food : new Food[]{Food.SALAD_DAIRY, Food.SALAD_FRUIT, Food.SALAD_GRAIN, Food.SALAD_MEAT, Food.SALAD_VEGETABLE, Food.SOUP_DAIRY, Food.SOUP_FRUIT,
                                Food.SOUP_GRAIN, Food.SOUP_MEAT, Food.SOUP_VEGETABLE}) {
      event.getRegistry()
        .register(new BarrelRecipeDynamicBowlFood(IIngredient.of(FRESH_WATER.get(), 200), IIngredient.of(ItemFoodTFC.get(food)), 0).setRegistryName(
          food.name().toLowerCase() + "_cleaning"));
    }
    ...
    for (EnumDyeColor dyeColor : EnumDyeColor.values()) {
      ...
      event.getRegistry().registerAll(
        // Dye fluid
        new BarrelRecipe(IIngredient.of(HOT_WATER.get(), 1000), IIngredient.of(OreDictionaryHelper.toString(
          "dye_" + dyeName)), new FluidStack(FluidsTFC.getFluidFromDye(dyeColor)
          .get(), 1000), ItemStack.EMPTY, ICalendar.TICKS_IN_HOUR).setRegistryName(dyeName),
        // Vanilla dye-able items
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of("woolWhite"), null, new ItemStack(Blocks.WOOL, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "wool_" + dyeName),
        new BarrelRecipe(IIngredient.of(fluid, 25), IIngredient.of(new ItemStack(Blocks.CARPET, 1, 0)), null, new ItemStack(Blocks.CARPET, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "carpet_" + dyeName),
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(new ItemStack(Items.BED, 1, 0)), null, new ItemStack(Items.BED, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "bed_" + dyeName),
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(Blocks.HARDENED_CLAY), null, new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "terracotta_" + dyeName),
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(Blocks.GLASS), null, new ItemStack(Blocks.STAINED_GLASS, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "glass_" + dyeName),
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(Blocks.GLASS_PANE), null, new ItemStack(Blocks.STAINED_GLASS_PANE, 1, dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "glass_pane_" + dyeName),
        // Glazed Vessels
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(ItemsTFC.UNFIRED_VESSEL), null, new ItemStack(ItemsTFC.UNFIRED_VESSEL_GLAZED, 1, 15
                                                                                                                                                     - dyeMeta), ICalendar.TICKS_IN_HOUR).setRegistryName(
        ...
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksTFC.ALABASTER_RAW_PLAIN), null, new ItemStack(BlockDecorativeStone.ALABASTER_RAW.get(dyeColor)), ICalendar.TICKS_IN_HOUR).setRegistryName(
          "alabaster_raw_" + dyeColor.getName()),
        new BarrelRecipe(IIngredient.of(fluid, 125), IIngredient.of(BlocksTFC.ALABASTER_POLISHED_PLAIN), null, new ItemStack(BlockDecorativeStone.ALABASTER_POLISHED.get(dyeColor)), ICalendar.TICKS_IN_HOUR).setRegistryName(
    ...
    event.getRegistry().registerAll(
      // Vanilla dye-able items
      new BarrelRecipe(IIngredient.of(FluidsCore.LYE.get(), 125), IIngredient.of("wool"), null, new ItemStack(Blocks.WOOL, 1, 0), ICalendar.TICKS_IN_HOUR).setRegistryName("wool_undo"),
      new BarrelRecipe(IIngredient.of(FluidsCore.LYE.get(), 25), IIngredient.of("carpet"), null, new ItemStack(Blocks.CARPET, 1, 0), ICalendar.TICKS_IN_HOUR).setRegistryName("carpet_undo"),
      new BarrelRecipe(IIngredient.of(FluidsCore.LYE.get(), 125), IIngredient.of("bed"), null, new ItemStack(Items.BED, 1, 0), ICalendar.TICKS_IN_HOUR).setRegistryName("bed_undo"),
      new BarrelRecipe(IIngredient.of(FluidsCore.LYE.get(), 125), IIngredient.of("terracotta"), null, new ItemStack(Blocks.HARDENED_CLAY), ICalendar.TICKS_IN_HOUR).setRegistryName("terracotta_undo"),
      ...
      new BarrelRecipe(IIngredient.of(FluidsCore.LYE.get(), 125), IIngredient.of("alabasterPolished"), null, new ItemStack(BlocksTFC.ALABASTER_POLISHED_PLAIN), ICalendar.TICKS_IN_HOUR).setRegistryName("alabaster_polished_undo")
    );
    // Dye combinations.
    event.getRegistry().registerAll(
      //Orange
  ...
  public static void onRegisterKnappingRecipeEvent(RegistryEvent.Register<KnappingRecipe> event) {
    ...
    for (Rock.ToolType type : Rock.ToolType.values()) {
      ...
      KnappingRecipe r = new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> new ItemStack(ItemRockToolHead.get(rockIn.getRockCategory(), type)), type.getPattern());
    ...
    event.getRegistry().registerAll(
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Stone, 2), "X  X ", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "stone_knife_head_1"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Stone, 2), "X   X", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "stone_knife_head_2"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Stone, 2), " X X ", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "stone_knife_head_3"),

      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Stone, 2), "XXXXX", "XX   ", "     ", "XXXXX", "XX   ").setRegistryName(MOD_ID, "stone_hoe_head_1"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Stone, 2), "XXXXX", "XX   ", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "stone_hoe_head_2"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Stone, 2), "XXXXX", "   XX", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "stone_hoe_head_3"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Stone, 2), "XXXXX", "   XX", "     ", "     ", "     ").setRegistryName(MOD_ID, "stone_hoe_head_4"),
      new KnappingRecipeStone(KnappingTypes.STONE, rockIn -> OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Stone, 2), "     ", "     ", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "stone_hoe_head_5"),

      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Flint, 2), "X  X ", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "flint_knife_head_1"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Flint, 2), "X   X", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "flint_knife_head_2"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadKnife, Materials.Flint, 2), " X X ", "XX XX", "XX XX", "XX XX", "XX XX").setRegistryName(MOD_ID, "flint_knife_head_3"),

      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Flint, 2), "XXXXX", "XX   ", "     ", "XXXXX", "XX   ").setRegistryName(MOD_ID, "flint_hoe_head_1"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Flint, 2), "XXXXX", "XX   ", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "flint_hoe_head_2"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Flint, 2), "XXXXX", "   XX", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "flint_hoe_head_3"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Flint, 2), "XXXXX", "   XX", "     ", "     ", "     ").setRegistryName(MOD_ID, "flint_hoe_head_4"),
      new KnappingRecipeSimple(KnappingTypes.FLINT, true, OreDictUnifier.get(OrePrefixCore.toolHeadHoe, Materials.Flint, 2), "     ", "     ", "     ", "XXXXX", "   XX").setRegistryName(MOD_ID, "flint_hoe_head_5")
    ...
    for (Metal.ItemType type : Metal.ItemType.values()) {
      if (type.hasMold(null)) {
        ...
        event.getRegistry()
          .register(new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemUnfiredMold.get(type), amount), type.getPattern()).setRegistryName(
            type.name().toLowerCase() + "_mold"));
      }
    }

    event.getRegistry().registerAll(
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_VESSEL), " XXX ", "XXXXX", "XXXXX", "XXXXX", " XXX ").setRegistryName("clay_small_vessel"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_JUG), " X   ", "XXXX ", "XXX X", "XXXX ", "XXX  ").setRegistryName("clay_jug"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_POT), "X   X", "X   X", "X   X", "XXXXX", " XXX ").setRegistryName("clay_pot"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, false, new ItemStack(ItemsTFC.UNFIRED_BOWL, 2), "X   X", " XXX ").setRegistryName(TFC, "clay_bowl"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_BOWL, 4), "X   X", " XXX ", "     ", "X   X", " XXX ").setRegistryName("clay_bowl_2"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_LARGE_VESSEL), "X   X", "X   X", "X   X", "X   X", "XXXXX").setRegistryName("clay_large_vessel"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_BRICK, 3), "XXXXX", "     ", "XXXXX", "     ", "XXXXX").setRegistryName("clay_brick"),
      new KnappingRecipeSimple(KnappingTypes.CLAY, true, new ItemStack(ItemsTFC.UNFIRED_FLOWER_POT, 2), " X X ", " XXX ", "     ", " X X ", " XXX ").setRegistryName("clay_flower_pot")
    );

    /* LEATHER ITEMS */

    event.getRegistry().registerAll(
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(Items.LEATHER_HELMET), "XXXXX", "X   X", "X   X", "     ", "     ").setRegistryName("leather_helmet"),
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(Items.LEATHER_CHESTPLATE), "X   X", "XXXXX", "XXXXX", "XXXXX", "XXXXX").setRegistryName("leather_chestplate"),
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(Items.LEATHER_LEGGINGS), "XXXXX", "XXXXX", "XX XX", "XX XX", "XX XX").setRegistryName("leather_leggings"),
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(Items.LEATHER_BOOTS), "XX   ", "XX   ", "XX   ", "XXXX ", "XXXXX").setRegistryName("leather_boots"),
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(Items.SADDLE), "  X  ", "XXXXX", "XXXXX", "XXXXX", "  X  ").setRegistryName("leather_saddle"),
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(ItemsTFC.QUIVER), " XXXX", "X XXX", "X XXX", "X XXX", " XXXX").setRegistryName("leather_quiver")
    );

    /* FIRE CLAY ITEMS */

    event.getRegistry().registerAll(
      new KnappingRecipeSimple(KnappingTypes.FIRE_CLAY, true, new ItemStack(ItemsTFC.UNFIRED_CRUCIBLE), "X   X", "X   X", "X   X", "X   X", "XXXXX").setRegistryName("fire_clay_crucible"),
      new KnappingRecipeSimple(KnappingTypes.FIRE_CLAY, true, new ItemStack(ItemsTFC.UNFIRED_FIRE_BRICK, 3), "XXXXX", "     ", "XXXXX", "     ", "XXXXX").setRegistryName("fire_clay_brick")
    );

    // WaterFlask
    event.getRegistry().registerAll(
      new KnappingRecipeSimple(KnappingTypes.LEATHER, true, new ItemStack(ItemsDevice.LEATHER_FLASK_UNFINISHED),
  ...
  public static void onRegisterHeatRecipeEvent(RegistryEvent.Register<HeatRecipe> event) {
    ...
    for (EnumDyeColor dye : EnumDyeColor.values()) {
      r.register(
        new HeatRecipeSimple(IIngredient.of(new ItemStack(ItemsTFC.UNFIRED_VESSEL_GLAZED, 1, dye.getMetadata())), new ItemStack(ItemsTFC.FIRED_VESSEL_GLAZED, 1, dye.getMetadata()), 1599f, Metal.Tier.TIER_I).setRegistryName(
    ...
    for (Metal.ItemType type : Metal.ItemType.values()) {
      ...
      if (unfiredMold != null && firedMold != null) {
        r.register(new HeatRecipeSimple(IIngredient.of(unfiredMold), new ItemStack(firedMold), 1599f, Metal.Tier.TIER_I).setRegistryName(
          "fired_mold_" + type.name().toLowerCase()));
      }
    }
...
//    addAnvil(r, INGOT, CHISEL_HEAD, true, TOOLS, HIT_LAST, HIT_NOT_LAST, DRAW_NOT_LAST);
    ...
    // Blooms
    r.register(new AnvilRecipeMeasurable(new ResourceLocation(TFC, "refining_bloom"), IIngredient.of(ItemsTFC.UNREFINED_BLOOM), new ItemStack(ItemsTFC.REFINED_BLOOM), Metal.Tier.TIER_II, HIT_LAST, HIT_SECOND_LAST, HIT_THIRD_LAST));
...
//    });
    ...
    // Cellars
    addAnvil(r, DOUBLE_INGOT, ICE_SAW_HEAD, true, TOOLS, HIT_LAST, UPSET_SECOND_LAST, DRAW_NOT_LAST);
    ...
    r.registerAll(new AnvilRecipe(new ResourceLocation(ModIDs.FL, "greenhouse_wall"), IIngredient.of(ItemMetal.get(Metal.WROUGHT_IRON, Metal.ItemType.SHEET)),
      new ItemStack(BlocksDevice.GREENHOUSE_WALL, 2), Metal.WROUGHT_IRON.getTier(), GENERAL, HIT_NOT_LAST, PUNCH_NOT_LAST, SHRINK_LAST));
    r.registerAll(new AnvilRecipe(new ResourceLocation(ModIDs.FL, "greenhouse_roof"), IIngredient.of(ItemMetal.get(Metal.WROUGHT_IRON, Metal.ItemType.SHEET)),
    ...
    r.registerAll(new AnvilRecipe(new ResourceLocation(ModIDs.FL, "greenhouse_door"), IIngredient.of(ItemMetal.get(Metal.WROUGHT_IRON, Metal.ItemType.SHEET)),
      new ItemStack(BlocksDevice.GREENHOUSE_DOOR), Metal.WROUGHT_IRON.getTier(), GENERAL, HIT_NOT_LAST, HIT_NOT_LAST, PUNCH_LAST));
    r.registerAll(new AnvilRecipe(new ResourceLocation(ModIDs.FL, "spout"), IIngredient.of("ingotBlackSteel"),
  ...
  private static void addAnvil(IForgeRegistry<AnvilRecipe> registry, Metal.ItemType inputType, Metal.ItemType outputType, boolean onlyToolMetals, @Nullable SmithingSkill.Type skillType, ForgeRule... rules) {
    ...
    for (Metal metal : TFCRegistries.METALS.getValuesCollection()) {
      if (onlyToolMetals && !metal.isToolMetal()) {continue;}
      ...
      if (!output.isEmpty()) {
        //noinspection ConstantConditions
        registry.register(new AnvilRecipe(new ResourceLocation(TFC, (outputType.name() + "_" + metal.getRegistryName()
  ...
  private static void addAnvil(IForgeRegistry<AnvilRecipe> registry, ResourceLocation inputMetalLoc, ResourceLocation outputMetalLoc, @Nullable SmithingSkill.Type skillType) {
    ...
    if (inputMetal != null && outputMetal != null) {
      ...
      if (!input.isEmpty() && !output.isEmpty()) {
        //noinspection ConstantConditions
        registry.register(new AnvilRecipe(new ResourceLocation(TFC, ("ingot_" + outputMetal.getRegistryName()
  ...
  private static void addAnvil(IForgeRegistry<AnvilRecipe> registry, String recipeName, Metal.ItemType inputType, ResourceLocation inputMetalRes, ItemStack output, Metal.Tier tier, @Nullable SmithingSkill.Type skillType, ForgeRule... rules) {
    ...
    if (inputMetal != null && !output.isEmpty()) {
      ...
      if (!input.isEmpty() && !output.isEmpty()) {
        registry.register(new AnvilRecipe(new ResourceLocation(TFC, recipeName), IIngredient.of(input), output, tier, skillType, rules));
      }
    }
  }
  ...
  private static void addWelding(IForgeRegistry<WeldingRecipe> registry, Metal.ItemType inputType1, Metal.ItemType inputType2, Metal.ItemType outputType, boolean onlyToolMetals, SmithingSkill.Type skillType) {
    ...
    for (Metal metal : TFCRegistries.METALS.getValuesCollection()) {
      ...
      if (!output.isEmpty()) {
        ...
        registry.register(new WeldingRecipe(new ResourceLocation(TFC, (outputType.name() + "_" + metal.getRegistryName()
  ...
  private static void addWelding(IForgeRegistry<WeldingRecipe> registry, ResourceLocation input1Loc, ResourceLocation input2Loc, ResourceLocation outputLoc) {
    ...
    if (inputMetal1 != null && inputMetal2 != null && outputMetal != null) {
      ...
      if (!input1.isEmpty() && !input2.isEmpty() && !output.isEmpty()) {
        // Note: Welding recipes require one less than the tier of the metal
        //noinspection ConstantConditions
        registry.register(new WeldingRecipe(new ResourceLocation(TFC, ("ingot_" + outputMetal.getRegistryName()
