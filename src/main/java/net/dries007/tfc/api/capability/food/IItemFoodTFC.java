 ...
 * initCapabilities are not visible to TFC - When duplicate capabilities get attached, they will decay independently and can lead to stackability
 * issues where invisible capability instances are preventing calls such as
 * {@link CapabilityFood#areStacksStackableExceptCreationDate(ItemStack, ItemStack)}
 */
