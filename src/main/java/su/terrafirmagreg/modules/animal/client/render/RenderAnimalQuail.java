...
public class RenderAnimalQuail extends RenderLiving<EntityAnimalQuail> {
    ...
    private static final ResourceLocation FEMALE_YOUNG = ModUtils.resource("textures/entity/animal/livestock/quailf_young.png");
    private static final ResourceLocation FEMALE_OLD = ModUtils.resource("textures/entity/animal/livestock/quailf_old.png");

    private static final ResourceLocation MALE_YOUNG = ModUtils.resource("textures/entity/animal/livestock/quailm_young.png");
    private static final ResourceLocation MALE_OLD = ModUtils.resource("textures/entity/animal/livestock/quailm_old.png");

    private static final ResourceLocation CHICK_TEXTURE = ModUtils.resource("textures/entity/animal/livestock/quail_chick.png");
