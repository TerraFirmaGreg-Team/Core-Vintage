...
public class EntityAnimalParrot extends EntityParrot implements IAnimal, ILivestock {
    ...
    private static final DataParameter<Boolean> GENDER = EntityDataManager.createKey(EntityAnimalParrot.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(EntityAnimalParrot.class, DataSerializers.VARINT);
    private static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(EntityAnimalParrot.class, DataSerializers.FLOAT);
