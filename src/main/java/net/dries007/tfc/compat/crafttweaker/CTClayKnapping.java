...
public class CTClayKnapping {
  ...
  public static void addRecipe(String registryName, IItemStack output, String... pattern) {
    ...
    KnappingRecipe recipe = new KnappingRecipeSimple(KnappingTypes.CLAY, true, outputStack, pattern).setRegistryName(registryName);
  ...
  public static void removeRecipe(IItemStack output) {
    ...
    TFCRegistries.KNAPPING.getValuesCollection()
      .stream()
      .filter(x -> x.getType() == KnappingTypes.CLAY && x.getOutput(ItemStack.EMPTY).isItemEqual(item))
