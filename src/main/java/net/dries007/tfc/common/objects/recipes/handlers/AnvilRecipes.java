...
import net.dries007.tfc.module.core.api.recipes.anvil.AnvilRecipeMeasurable;
import net.dries007.tfc.module.core.api.recipes.anvil.AnvilRecipeSplitting;
...
public class AnvilRecipes {
    ...
    public static void register() {
        var registry = RegistryCore.ANVIL;
            ...
            if (material.hasProperty(TFGPropertyKey.HEAT) && !material.hasFlag(TFGMaterialFlags.UNUSABLE)) {
                ...
                if (material.hasFlag(MaterialFlags.GENERATE_PLATE)) {
                    ...
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_plate_" + material.getName()),
                ...
                if (material.hasFlag(MaterialFlags.GENERATE_ROD)) {
                    // Ingot -> Stick
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_stick_" + material.getName()),
                ...
                if (material.hasProperty(PropertyKey.TOOL)) {
                    // Ingot x2 -> Sword Head
                    registry.register(new AnvilRecipe(
                            Helpers.getID("double_ingot_to_sword_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotDouble, material)),
                    ...
                    registry.register(new AnvilRecipe(
                            Helpers.getID("triple_ingot_to_pickaxe_" + material.getName()),
                    ...
                    // Ingot x3 -> Axe Head
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_axe_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotTriple, material)),
                    ...
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_shovel_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(OrePrefix.ingot, material)),
                    ...
                    // Ingot x2 -> Saw Head
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_saw_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotDouble, material)),
                    ...
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_hammer_" + material.getName()),
                    ...
                    // Ingot x3 -> Sense Head
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_sense_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotTriple, material)),
                    ...
                    // Ingot x1 -> Knife Head
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_knife_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(OrePrefix.ingot, material)),
                    ...
                    // Ingot 3x -> Propick
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_propick_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotTriple, material)),
                    ...
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_chisel_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotDouble, material)),
                    ...
                    // Ingot 6x -> TUYERE
                    registry.register(new AnvilRecipe(
                            Helpers.getID("ingot_to_tuyere_" + material.getName()),
                            IIngredient.of(OreDictUnifier.get(TFGOrePrefix.ingotHex, material)),
        ...
        registry.register(new AnvilRecipe(
                Helpers.getID("high_carbon_steel"),
        ...
        // Blooms
        registry.register(new AnvilRecipeMeasurable(Helpers.getID("refining_bloom"), IIngredient.of(ItemsCore.UNREFINED_BLOOM), new ItemStack(ItemsCore.REFINED_BLOOM), 2, HIT_LAST, HIT_SECOND_LAST, HIT_THIRD_LAST));
        registry.register(new AnvilRecipeSplitting(Helpers.getID("splitting_bloom"), IIngredient.of(ItemsCore.REFINED_BLOOM), new ItemStack(ItemsCore.REFINED_BLOOM), 144, 2, PUNCH_LAST));
        registry.register(new AnvilRecipe(Helpers.getID("iron_bloom"), x -> {
            if (x.getItem() == ItemsCore.REFINED_BLOOM) {
