...
public class BlockSiltFarmland extends FarmlandTFCF {
    ...
    public BlockSiltFarmland(RockTFCF rockTFCF, Rock rock) {
        super(rockTFCF, rock);
        ...
        OreDictionaryHelper.register(this, "farmland", "silt");
    }
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos) {
        ...
        if (fromPos.getY() == pos.getY() + 1 && world.getBlockState(fromPos)
                .isSideSolid(world, fromPos, EnumFacing.DOWN)) {
    ...
    private void turnToDirt(World world, BlockPos pos) {
        world.setBlockState(pos, get(rock, RockTFCF.SILT).getDefaultState());
