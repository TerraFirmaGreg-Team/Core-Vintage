...
import net.dries007.tfc.module.core.common.objects.blocks.devices.BlockPitKiln;
...
public class TEPitKiln extends TEPlacedItem implements ITickable {
    ...
    protected void updateBlock() {
        ...
        world.setBlockState(pos, state.withProperty(BlockPitKiln.FULL, getStrawCount() == STRAW_NEEDED && getLogCount() == WOOD_NEEDED));
        markForBlockUpdate();
    }
