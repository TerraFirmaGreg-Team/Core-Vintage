...
//import net.dries007.tfc.api.types2.wood.Tree;
...
//				trunk = BlockWoodLog.get(tree).getDefaultState().withProperty(PLACED, false);
//				bark = BlockWoodLog.get(tree).getDefaultState().withProperty(PLACED, false).withProperty(LOG_AXIS, BlockLog.EnumAxis.NONE);
//
