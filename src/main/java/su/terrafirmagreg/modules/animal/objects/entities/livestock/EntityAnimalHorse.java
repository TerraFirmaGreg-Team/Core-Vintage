...
public class EntityAnimalHorse extends EntityHorse implements IAnimal, ILivestock, IRidable {
	...
	private static final DataParameter<Long> PREGNANT_TIME = EntityDataManager.createKey(EntityAnimalHorse.class, TFCEntities.getLongDataSerializer());
	...
	public EntityAnimalHorse(World world) {
		this(world, Gender.valueOf(Constants.RANDOM.nextBoolean()), EntityAnimalBase.getRandomGrowth(ModuleAnimalConfig.ENTITIES.HORSE.adulthood, ModuleAnimalConfig.ENTITIES.HORSE.elder));
	}
	...
	public EntityAgeable createChild(@Nonnull EntityAgeable other) {
		...
		if (other != this && this.getGender() == Gender.FEMALE && other instanceof IAnimal) {
			...
			EntityAnimalHorse baby = new EntityAnimalHorse(this.world, Gender.valueOf(Constants.RANDOM.nextBoolean()), (int) CalendarTFC.PLAYER_TIME.getTotalDays());
