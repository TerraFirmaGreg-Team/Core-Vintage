package su.terrafirmagreg.modules.wood.object.render;
...
import su.terrafirmagreg.modules.wood.object.model.ModelWoodAnimalCart;
...
public class RenderWoodAnimalCart extends Render<EntityWoodAnimalCart> {
  ...
  @Override
  public void doRender(EntityWoodAnimalCart entity, double x, double y, double z, float entityYaw, float partialTicks) {
