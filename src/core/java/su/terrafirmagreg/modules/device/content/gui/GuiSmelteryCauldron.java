...
import su.terrafirmagreg.modules.device.content.tile.TileSmelteryCauldron;
...
public class GuiSmelteryCauldron extends BaseGuiContainerTile<TileSmelteryCauldron> {
  ...
  private static final ResourceLocation ELEMENTS = ModUtils.resource("textures/gui/icons/elements.png");
  ...
  protected void renderHoveredToolTip(int mouseX, int mouseY) {
    ...
    if (tooltip != null) {
      ...
      if (tile.isSolidified()) {
        formatted += I18n.format(TFC + ".tooltip.solid");
      } else {
        formatted += I18n.format(TFC + ".tooltip.liquid");
      }
