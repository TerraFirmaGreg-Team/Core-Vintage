...
import static su.terrafirmagreg.modules.core.ConfigCore.FEATURE;
...
public class MCDate {
  ...
  public enum Week implements IStringSerializable {
    ...
    @NotNull
    public static MCDate.Week valueOf(int id) {
  ...
  public enum Month implements IStringSerializable {
    JANUARY(FEATURE.CALENDAR.MONTH.JANUARY.days, FEATURE.CALENDAR.MONTH.JANUARY.dayDuration, 66.5f),
    FEBRUARY(FEATURE.CALENDAR.MONTH.FEBRUARY.days, FEATURE.CALENDAR.MONTH.FEBRUARY.dayDuration, 65.5f),
    MARCH(FEATURE.CALENDAR.MONTH.MARCH.days, FEATURE.CALENDAR.MONTH.MARCH.dayDuration, 56f),
    APRIL(FEATURE.CALENDAR.MONTH.APRIL.days, FEATURE.CALENDAR.MONTH.APRIL.dayDuration, 47.5f),
    MAY(FEATURE.CALENDAR.MONTH.MAY.days, FEATURE.CALENDAR.MONTH.MAY.dayDuration, 38f),
    JUNE(FEATURE.CALENDAR.MONTH.JUNE.days, FEATURE.CALENDAR.MONTH.JUNE.dayDuration, 29.5f),
    JULY(FEATURE.CALENDAR.MONTH.JULY.days, FEATURE.CALENDAR.MONTH.JULY.dayDuration, 27f),
    AUGUST(FEATURE.CALENDAR.MONTH.AUGUST.days, FEATURE.CALENDAR.MONTH.AUGUST.dayDuration, 29.5f),
    SEPTEMBER(FEATURE.CALENDAR.MONTH.SEPTEMBER.days, FEATURE.CALENDAR.MONTH.SEPTEMBER.dayDuration, 38f),
    OCTOBER(FEATURE.CALENDAR.MONTH.OCTOBER.days, FEATURE.CALENDAR.MONTH.OCTOBER.dayDuration, 47.5f),
    NOVEMBER(FEATURE.CALENDAR.MONTH.NOVEMBER.days, FEATURE.CALENDAR.MONTH.NOVEMBER.dayDuration, 56f),
    DECEMBER(FEATURE.CALENDAR.MONTH.DECEMBER.days, FEATURE.CALENDAR.MONTH.DECEMBER.dayDuration, 65.5f);
